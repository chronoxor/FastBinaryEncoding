...
private:
    ...
    void GenerateFBEBaseBuffer(const std::string& package);
    void GenerateFBEWriteBuffer(const std::string& package);
    void GenerateFBEReadBuffer(const std::string& package);
