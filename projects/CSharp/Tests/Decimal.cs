...
namespace Tests
{
    ...
    public class Decimal
    {
        ...
        [TestCase(TestName = "Decimal tests")]
        public void DecimalTests()
        {
            Assert.That(VerifyDecimal(0x00000000, 0x00000000, 0x00000000, false, 0x00000000) == 0M);
            Assert.That(VerifyDecimal(0x00000001, 0x00000000, 0x00000000, false, 0x00000000) == 1M);
            Assert.That(VerifyDecimal(0x107A4000, 0x00005AF3, 0x00000000, false, 0x00000000) == 100000000000000M);
            Assert.That(VerifyDecimal(0x10000000, 0x3E250261, 0x204FCE5E, false, 0x00000000) == 10000000000000000000000000000M);
            Assert.That(VerifyDecimal(0x10000000, 0x3E250261, 0x204FCE5E, false, 0x000E0000 >> 16) == 100000000000000.00000000000000M);
            Assert.That(VerifyDecimal(0x10000000, 0x3E250261, 0x204FCE5E, false, 0x001C0000 >> 16) == 1.0000000000000000000000000000M);
            Assert.That(VerifyDecimal(0x075BCD15, 0x00000000, 0x00000000, false, 0x00000000) == 123456789M);
            Assert.That(VerifyDecimal(0x075BCD15, 0x00000000, 0x00000000, false, 0x00090000 >> 16) == 0.123456789M);
            Assert.That(VerifyDecimal(0x075BCD15, 0x00000000, 0x00000000, false, 0x00120000 >> 16) == 0.000000000123456789M);
