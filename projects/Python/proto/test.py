...
class StructSimple(object):
    ...
    def __from_json__(fields):
        ...
        return StructSimple(
            ...
            None if "f5" not in fields else fields["f5"],
            None if "f6" not in fields else fields["f6"],
            None if "f7" not in fields else fields["f7"],
            None if "f8" not in fields else fields["f8"],
...
class StructOptional(StructSimple):
    ...
    def __from_json__(fields):
        ...
        return StructOptional(
            ...
            None if "f106" not in fields else fields["f106"],
            None if "f107" not in fields else fields["f107"],
            None if "f108" not in fields else fields["f108"],
            None if "f109" not in fields else fields["f109"],
            None if "f110" not in fields else fields["f110"],
            None if "f111" not in fields else fields["f111"],
