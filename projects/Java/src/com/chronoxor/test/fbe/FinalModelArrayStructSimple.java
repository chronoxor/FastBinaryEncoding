...
public final class FinalModelArrayStructSimple extends com.chronoxor.fbe.FinalModel
{
    private final FinalModelStructSimple _model;
    private final long _size;

    public FinalModelArrayStructSimple(com.chronoxor.fbe.Buffer buffer, long offset, long size)
    {
        super(buffer, offset);
