...
public final class FinalModelOptionalprotoAccount extends com.chronoxor.fbe.FinalModel
{
    ...
    public long fbeAllocationSize(com.chronoxor.proto.Account optional) { return 1 + ((optional != null) ? value.fbeAllocationSize(optional) : 0); }
    ...
    public final com.chronoxor.proto.fbe.FinalModelAccount value;
    ...
    public com.chronoxor.proto.Account get(com.chronoxor.fbe.Size size)
    {
        ...
        _buffer.shift(fbeOffset() + 1);
        com.chronoxor.proto.Account optional = value.get(size);
        _buffer.unshift(fbeOffset() + 1);
        size.value += 1;
        return optional;
    }
    ...
    public long set(com.chronoxor.proto.Account optional)
    {
        assert ((_buffer.getOffset() + fbeOffset() + 1) <= _buffer.getSize()) : "Model is broken!";
        if ((_buffer.getOffset() + fbeOffset() + 1) > _buffer.getSize())
            return 0;
