...
public final class FinalModelMapInt32FlagsSimple extends com.chronoxor.fbe.FinalModel
{
    private final com.chronoxor.fbe.FinalModelInt32 _modelKey;
    private final FinalModelFlagsSimple _modelValue;

    public FinalModelMapInt32FlagsSimple(com.chronoxor.fbe.Buffer buffer, long offset)
    {
        super(buffer, offset);
