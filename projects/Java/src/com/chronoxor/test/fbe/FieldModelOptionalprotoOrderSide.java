...
public final class FieldModelOptionalprotoOrderSide extends com.chronoxor.fbe.FieldModel
{
    public FieldModelOptionalprotoOrderSide(com.chronoxor.fbe.Buffer buffer, long offset)
    {
        super(buffer, offset);
        value = new com.chronoxor.proto.fbe.FieldModelOrderSide(buffer, 0);
    }
    ...
    public final com.chronoxor.proto.fbe.FieldModelOrderSide value;
    ...
    public com.chronoxor.proto.OrderSide get() { return get(null); }
    public com.chronoxor.proto.OrderSide get(com.chronoxor.proto.OrderSide defaults)
    {
        ...
        com.chronoxor.proto.OrderSide optional = value.get();
        getEnd(fbeBegin);
        return optional;
    }
    ...
    public void set(com.chronoxor.proto.OrderSide optional)
    {
