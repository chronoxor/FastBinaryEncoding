...
public final class FieldModelOptionalprotoOrderType extends com.chronoxor.fbe.FieldModel
{
    public FieldModelOptionalprotoOrderType(com.chronoxor.fbe.Buffer buffer, long offset)
    {
        super(buffer, offset);
        value = new com.chronoxor.proto.fbe.FieldModelOrderType(buffer, 0);
    }
    ...
    public final com.chronoxor.proto.fbe.FieldModelOrderType value;
    ...
    public com.chronoxor.proto.OrderType get() { return get(null); }
    public com.chronoxor.proto.OrderType get(com.chronoxor.proto.OrderType defaults)
    {
        ...
        com.chronoxor.proto.OrderType optional = value.get();
        getEnd(fbeBegin);
        return optional;
    }
    ...
    public void set(com.chronoxor.proto.OrderType optional)
    {
