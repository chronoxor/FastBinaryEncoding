...
public final class FinalModelVectorEnumSimple extends com.chronoxor.fbe.FinalModel
{
    private final FinalModelEnumSimple _model;

    public FinalModelVectorEnumSimple(com.chronoxor.fbe.Buffer buffer, long offset)
    {
        super(buffer, offset);
        _model = new FinalModelEnumSimple(buffer, offset);
    }
    ...
    public long fbeAllocationSize(java.util.LinkedList<com.chronoxor.test.EnumSimple> values)
    {
        long size = 4;
        for (var value : values)
            size += _model.fbeAllocationSize(value);
    ...
    public long fbeAllocationSize(java.util.HashSet<com.chronoxor.test.EnumSimple> values)
    {
        long size = 4;
        for (var value : values)
            size += _model.fbeAllocationSize(value);
    ...
    public long get(java.util.LinkedList<com.chronoxor.test.EnumSimple> values)
    {
        assert (values != null) : "Invalid values parameter!";
        if (values == null)
            throw new IllegalArgumentException("Invalid values parameter!");
    ...
    public long get(java.util.HashSet<com.chronoxor.test.EnumSimple> values)
    {
        assert (values != null) : "Invalid values parameter!";
        if (values == null)
            throw new IllegalArgumentException("Invalid values parameter!");
    ...
    public long set(java.util.LinkedList<com.chronoxor.test.EnumSimple> values)
    {
        assert (values != null) : "Invalid values parameter!";
        if (values == null)
            throw new IllegalArgumentException("Invalid values parameter!");
    ...
    public long set(java.util.HashSet<com.chronoxor.test.EnumSimple> values)
    {
        assert (values != null) : "Invalid values parameter!";
        if (values == null)
            throw new IllegalArgumentException("Invalid values parameter!");
