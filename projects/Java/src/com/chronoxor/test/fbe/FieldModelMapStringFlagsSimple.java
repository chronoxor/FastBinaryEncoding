...
public final class FieldModelMapStringFlagsSimple extends com.chronoxor.fbe.FieldModel
{
    private final com.chronoxor.fbe.FieldModelString _modelKey;
    private final FieldModelFlagsSimple _modelValue;

    public FieldModelMapStringFlagsSimple(com.chronoxor.fbe.Buffer buffer, long offset)
    {
        super(buffer, offset);
        _modelKey = new com.chronoxor.fbe.FieldModelString(buffer, offset);
        _modelValue = new FieldModelFlagsSimple(buffer, offset);
    }
    ...
    // Map index operator
    public com.chronoxor.fbe.Pair<com.chronoxor.fbe.FieldModelString, FieldModelFlagsSimple> getItem(long index)
    {
    ...
    public com.chronoxor.fbe.Pair<com.chronoxor.fbe.FieldModelString, FieldModelFlagsSimple> resize(long size)
    {
