...
public final class FieldModelOptionalByte extends com.chronoxor.fbe.FieldModel
{
    public FieldModelOptionalByte(com.chronoxor.fbe.Buffer buffer, long offset)
    {
        super(buffer, offset);
        value = new com.chronoxor.fbe.FieldModelByte(buffer, 0);
    }
    ...
    public final com.chronoxor.fbe.FieldModelByte value;
