...
public final class FinalModelMapStringOptionalByte extends com.chronoxor.fbe.FinalModel
{
    private final com.chronoxor.fbe.FinalModelString _modelKey;
    private final FinalModelOptionalByte _modelValue;

    public FinalModelMapStringOptionalByte(com.chronoxor.fbe.Buffer buffer, long offset)
    {
        super(buffer, offset);
