...
public final class FinalModelMapStringBytes extends com.chronoxor.fbe.FinalModel
{
    private final com.chronoxor.fbe.FinalModelString _modelKey;
    private final com.chronoxor.fbe.FinalModelBytes _modelValue;

    public FinalModelMapStringBytes(com.chronoxor.fbe.Buffer buffer, long offset)
    {
        super(buffer, offset);
    ...
    public long fbeAllocationSize(java.util.TreeMap<String, java.nio.ByteBuffer> values)
    {
        long size = 4;
    ...
    public long fbeAllocationSize(java.util.HashMap<String, java.nio.ByteBuffer> values)
    {
        long size = 4;
        for (var value : values.entrySet())
        {
    ...
    public long get(java.util.TreeMap<String, java.nio.ByteBuffer> values)
    {
    ...
    public long get(java.util.HashMap<String, java.nio.ByteBuffer> values)
    {
        assert (values != null) : "Invalid values parameter!";
        if (values == null)
            throw new IllegalArgumentException("Invalid values parameter!");
    ...
    public long set(java.util.TreeMap<String, java.nio.ByteBuffer> values)
    {
        assert (values != null) : "Invalid values parameter!";
        if (values == null)
            throw new IllegalArgumentException("Invalid values parameter!");
    ...
    public long set(java.util.HashMap<String, java.nio.ByteBuffer> values)
    {
        assert (values != null) : "Invalid values parameter!";
        if (values == null)
            throw new IllegalArgumentException("Invalid values parameter!");
