...
public final class FinalModelVectorFlagsSimple extends com.chronoxor.fbe.FinalModel
{
    private final FinalModelFlagsSimple _model;

    public FinalModelVectorFlagsSimple(com.chronoxor.fbe.Buffer buffer, long offset)
    {
        super(buffer, offset);
