...
public final class FieldModelMapStructSimpleStructNested extends com.chronoxor.fbe.FieldModel
{
    private final FieldModelStructSimple _modelKey;
    private final FieldModelStructNested _modelValue;

    public FieldModelMapStructSimpleStructNested(com.chronoxor.fbe.Buffer buffer, long offset)
    {
        super(buffer, offset);
    ...
    // Map index operator
    public com.chronoxor.fbe.Pair<FieldModelStructSimple, FieldModelStructNested> getItem(long index)
    {
    ...
    public com.chronoxor.fbe.Pair<FieldModelStructSimple, FieldModelStructNested> resize(long size)
    {
