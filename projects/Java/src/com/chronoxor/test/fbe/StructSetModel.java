...
public final class StructSetModel extends com.chronoxor.fbe.Model
{
    public final FieldModelStructSet model;

    public StructSetModel() { model = new FieldModelStructSet(getBuffer(), 4); }
    public StructSetModel(com.chronoxor.fbe.Buffer buffer) { super(buffer); model = new FieldModelStructSet(getBuffer(), 4); }
    ...
    public long deserialize(com.chronoxor.test.StructSet value)
    {
        if ((getBuffer().getOffset() + model.fbeOffset() - 4) > getBuffer().getSize())
        {
            value = new com.chronoxor.test.StructSet();
            return 0;
        }
