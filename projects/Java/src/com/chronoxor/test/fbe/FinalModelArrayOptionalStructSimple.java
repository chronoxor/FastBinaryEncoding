...
public final class FinalModelArrayOptionalStructSimple extends com.chronoxor.fbe.FinalModel
{
    private final FinalModelOptionalStructSimple _model;
    private final long _size;

    public FinalModelArrayOptionalStructSimple(com.chronoxor.fbe.Buffer buffer, long offset, long size)
    {
        super(buffer, offset);
    ...
    // Get the array
    public long get(com.chronoxor.test.StructSimple[] values)
    {
    ...
    // Set the array
    public long set(com.chronoxor.test.StructSimple[] values)
    {
        assert (values != null) : "Invalid values parameter!";
        if (values == null)
            throw new IllegalArgumentException("Invalid values parameter!");
