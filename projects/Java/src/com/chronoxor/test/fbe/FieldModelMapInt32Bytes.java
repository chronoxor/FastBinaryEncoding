...
public final class FieldModelMapInt32Bytes extends com.chronoxor.fbe.FieldModel
{
    private final com.chronoxor.fbe.FieldModelInt32 _modelKey;
    private final com.chronoxor.fbe.FieldModelBytes _modelValue;

    public FieldModelMapInt32Bytes(com.chronoxor.fbe.Buffer buffer, long offset)
    {
        super(buffer, offset);
    ...
    // Map index operator
    public com.chronoxor.fbe.Pair<com.chronoxor.fbe.FieldModelInt32, com.chronoxor.fbe.FieldModelBytes> getItem(long index)
    {
    ...
    public com.chronoxor.fbe.Pair<com.chronoxor.fbe.FieldModelInt32, com.chronoxor.fbe.FieldModelBytes> resize(long size)
    {
