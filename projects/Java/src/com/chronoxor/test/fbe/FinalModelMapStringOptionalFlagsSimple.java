...
public final class FinalModelMapStringOptionalFlagsSimple extends com.chronoxor.fbe.FinalModel
{
    private final com.chronoxor.fbe.FinalModelString _modelKey;
    private final FinalModelOptionalFlagsSimple _modelValue;

    public FinalModelMapStringOptionalFlagsSimple(com.chronoxor.fbe.Buffer buffer, long offset)
    {
        super(buffer, offset);
