...
public final class FieldModelArrayOptionalStructSimple extends com.chronoxor.fbe.FieldModel
{
    private final FieldModelOptionalStructSimple _model;
    private final long _size;

    public FieldModelArrayOptionalStructSimple(com.chronoxor.fbe.Buffer buffer, long offset, long size)
    {
        super(buffer, offset);
