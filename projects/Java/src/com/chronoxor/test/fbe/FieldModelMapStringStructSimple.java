...
public final class FieldModelMapStringStructSimple extends com.chronoxor.fbe.FieldModel
{
    private final com.chronoxor.fbe.FieldModelString _modelKey;
    private final FieldModelStructSimple _modelValue;

    public FieldModelMapStringStructSimple(com.chronoxor.fbe.Buffer buffer, long offset)
    {
        super(buffer, offset);
        _modelKey = new com.chronoxor.fbe.FieldModelString(buffer, offset);
        _modelValue = new FieldModelStructSimple(buffer, offset);
    }
    ...
    // Map index operator
    public com.chronoxor.fbe.Pair<com.chronoxor.fbe.FieldModelString, FieldModelStructSimple> getItem(long index)
    {
    ...
    public com.chronoxor.fbe.Pair<com.chronoxor.fbe.FieldModelString, FieldModelStructSimple> resize(long size)
    {
    ...
    public void get(java.util.TreeMap<String, com.chronoxor.test.StructSimple> values)
    {
        ...
        for (long i = fbeMapSize; i-- > 0;)
        {
            ...
            com.chronoxor.test.StructSimple value = fbeModel.getValue().get();
    ...
    public void get(java.util.HashMap<String, com.chronoxor.test.StructSimple> values)
    {
        assert (values != null) : "Invalid values parameter!";
        if (values == null)
            throw new IllegalArgumentException("Invalid values parameter!");
    ...
    public void set(java.util.TreeMap<String, com.chronoxor.test.StructSimple> values)
    {
        assert (values != null) : "Invalid values parameter!";
        if (values == null)
            throw new IllegalArgumentException("Invalid values parameter!");
    ...
    public void set(java.util.HashMap<String, com.chronoxor.test.StructSimple> values)
    {
        assert (values != null) : "Invalid values parameter!";
        if (values == null)
            throw new IllegalArgumentException("Invalid values parameter!");
