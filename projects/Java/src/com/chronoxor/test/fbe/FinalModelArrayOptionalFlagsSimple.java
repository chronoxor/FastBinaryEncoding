...
public final class FinalModelArrayOptionalFlagsSimple extends com.chronoxor.fbe.FinalModel
{
    private final FinalModelOptionalFlagsSimple _model;
    private final long _size;

    public FinalModelArrayOptionalFlagsSimple(com.chronoxor.fbe.Buffer buffer, long offset, long size)
    {
        super(buffer, offset);
