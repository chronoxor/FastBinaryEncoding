...
public final class FinalModelMapStringOptionalEnumSimple extends com.chronoxor.fbe.FinalModel
{
    private final com.chronoxor.fbe.FinalModelString _modelKey;
    private final FinalModelOptionalEnumSimple _modelValue;

    public FinalModelMapStringOptionalEnumSimple(com.chronoxor.fbe.Buffer buffer, long offset)
    {
        super(buffer, offset);
