...
public final class FieldModelOptionalprotoAccount extends com.chronoxor.fbe.FieldModel
{
    public FieldModelOptionalprotoAccount(com.chronoxor.fbe.Buffer buffer, long offset)
    {
        super(buffer, offset);
        value = new com.chronoxor.proto.fbe.FieldModelAccount(buffer, 0);
    }
    ...
    public final com.chronoxor.proto.fbe.FieldModelAccount value;
    ...
    public com.chronoxor.proto.Account get() { return get(null); }
    public com.chronoxor.proto.Account get(com.chronoxor.proto.Account defaults)
    {
        long fbeBegin = getBegin();
        if (fbeBegin == 0)
            return defaults;

        com.chronoxor.proto.Account optional = value.get();
        getEnd(fbeBegin);
        return optional;
    }
    ...
    public void set(com.chronoxor.proto.Account optional)
    {
