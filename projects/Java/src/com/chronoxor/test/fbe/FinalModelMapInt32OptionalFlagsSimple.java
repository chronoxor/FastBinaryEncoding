...
public final class FinalModelMapInt32OptionalFlagsSimple extends com.chronoxor.fbe.FinalModel
{
    private final com.chronoxor.fbe.FinalModelInt32 _modelKey;
    private final FinalModelOptionalFlagsSimple _modelValue;

    public FinalModelMapInt32OptionalFlagsSimple(com.chronoxor.fbe.Buffer buffer, long offset)
    {
        super(buffer, offset);
        _modelKey = new com.chronoxor.fbe.FinalModelInt32(buffer, offset);
        _modelValue = new FinalModelOptionalFlagsSimple(buffer, offset);
    }

    // Get the allocation size
    public long fbeAllocationSize(java.util.TreeMap<Integer, com.chronoxor.test.FlagsSimple> values)
    {
        long size = 4;
    ...
    public long fbeAllocationSize(java.util.HashMap<Integer, com.chronoxor.test.FlagsSimple> values)
    {
        long size = 4;
        for (var value : values.entrySet())
        {
    ...
    public long get(java.util.TreeMap<Integer, com.chronoxor.test.FlagsSimple> values)
    {
    ...
    public long get(java.util.HashMap<Integer, com.chronoxor.test.FlagsSimple> values)
    {
        assert (values != null) : "Invalid values parameter!";
        if (values == null)
            throw new IllegalArgumentException("Invalid values parameter!");
    ...
    public long set(java.util.TreeMap<Integer, com.chronoxor.test.FlagsSimple> values)
    {
        assert (values != null) : "Invalid values parameter!";
        if (values == null)
            throw new IllegalArgumentException("Invalid values parameter!");
    ...
    public long set(java.util.HashMap<Integer, com.chronoxor.test.FlagsSimple> values)
    {
        assert (values != null) : "Invalid values parameter!";
        if (values == null)
            throw new IllegalArgumentException("Invalid values parameter!");
