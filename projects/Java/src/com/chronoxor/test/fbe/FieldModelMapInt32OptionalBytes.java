...
public final class FieldModelMapInt32OptionalBytes extends com.chronoxor.fbe.FieldModel
{
    private final com.chronoxor.fbe.FieldModelInt32 _modelKey;
    private final FieldModelOptionalBytes _modelValue;

    public FieldModelMapInt32OptionalBytes(com.chronoxor.fbe.Buffer buffer, long offset)
    {
        super(buffer, offset);
        _modelKey = new com.chronoxor.fbe.FieldModelInt32(buffer, offset);
        _modelValue = new FieldModelOptionalBytes(buffer, offset);
    }
    ...
    // Map index operator
    public com.chronoxor.fbe.Pair<com.chronoxor.fbe.FieldModelInt32, FieldModelOptionalBytes> getItem(long index)
    {
    ...
    public com.chronoxor.fbe.Pair<com.chronoxor.fbe.FieldModelInt32, FieldModelOptionalBytes> resize(long size)
    {
    ...
    public void get(java.util.TreeMap<Integer, java.nio.ByteBuffer> values)
    {
    ...
    public void get(java.util.HashMap<Integer, java.nio.ByteBuffer> values)
    {
        assert (values != null) : "Invalid values parameter!";
        if (values == null)
            throw new IllegalArgumentException("Invalid values parameter!");
    ...
    public void set(java.util.TreeMap<Integer, java.nio.ByteBuffer> values)
    {
        assert (values != null) : "Invalid values parameter!";
        if (values == null)
            throw new IllegalArgumentException("Invalid values parameter!");
    ...
    public void set(java.util.HashMap<Integer, java.nio.ByteBuffer> values)
    {
        assert (values != null) : "Invalid values parameter!";
        if (values == null)
            throw new IllegalArgumentException("Invalid values parameter!");
