...
public final class FieldModelOptionalUUID extends com.chronoxor.fbe.FieldModel
{
    public FieldModelOptionalUUID(com.chronoxor.fbe.Buffer buffer, long offset)
    {
        super(buffer, offset);
        value = new com.chronoxor.fbe.FieldModelUUID(buffer, 0);
    }
    ...
    public final com.chronoxor.fbe.FieldModelUUID value;
    ...
    public java.util.UUID get() { return get(null); }
    public java.util.UUID get(java.util.UUID defaults)
    {
        ...
        java.util.UUID optional = value.get();
        getEnd(fbeBegin);
        return optional;
    }
    ...
    public void set(java.util.UUID optional)
    {
