...
public final class FieldModelVectorOptionalBytes extends com.chronoxor.fbe.FieldModel
{
    private final FieldModelOptionalBytes _model;

    public FieldModelVectorOptionalBytes(com.chronoxor.fbe.Buffer buffer, long offset)
    {
        super(buffer, offset);
    ...
    public FieldModelOptionalBytes resize(long size)
    {
