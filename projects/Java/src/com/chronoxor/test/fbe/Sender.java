...
public class Sender extends com.chronoxor.fbe.Sender
{
    ...
    public long send(Object obj)
    {
        if (obj instanceof com.chronoxor.test.StructSimple)
        {
            ...
            if (value.fbeType() == StructSimpleModel.fbeType())
                return send(value);
        }
        if (obj instanceof com.chronoxor.test.StructOptional)
        {
            ...
            if (value.fbeType() == StructOptionalModel.fbeType())
                return send(value);
        }
