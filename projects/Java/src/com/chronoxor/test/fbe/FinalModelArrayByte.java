...
public final class FinalModelArrayByte extends com.chronoxor.fbe.FinalModel
{
    private final com.chronoxor.fbe.FinalModelByte _model;
    private final long _size;

    public FinalModelArrayByte(com.chronoxor.fbe.Buffer buffer, long offset, long size)
    {
        super(buffer, offset);
