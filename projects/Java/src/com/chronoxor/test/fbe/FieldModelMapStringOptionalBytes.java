...
public final class FieldModelMapStringOptionalBytes extends com.chronoxor.fbe.FieldModel
{
    private final com.chronoxor.fbe.FieldModelString _modelKey;
    private final FieldModelOptionalBytes _modelValue;

    public FieldModelMapStringOptionalBytes(com.chronoxor.fbe.Buffer buffer, long offset)
    {
        super(buffer, offset);
    ...
    // Map index operator
    public com.chronoxor.fbe.Pair<com.chronoxor.fbe.FieldModelString, FieldModelOptionalBytes> getItem(long index)
    {
    ...
    public com.chronoxor.fbe.Pair<com.chronoxor.fbe.FieldModelString, FieldModelOptionalBytes> resize(long size)
    {
