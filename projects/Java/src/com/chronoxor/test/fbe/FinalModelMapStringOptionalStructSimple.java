...
public final class FinalModelMapStringOptionalStructSimple extends com.chronoxor.fbe.FinalModel
{
    private final com.chronoxor.fbe.FinalModelString _modelKey;
    private final FinalModelOptionalStructSimple _modelValue;

    public FinalModelMapStringOptionalStructSimple(com.chronoxor.fbe.Buffer buffer, long offset)
    {
        super(buffer, offset);
