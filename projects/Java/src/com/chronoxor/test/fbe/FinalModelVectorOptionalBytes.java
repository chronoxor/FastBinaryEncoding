...
public final class FinalModelVectorOptionalBytes extends com.chronoxor.fbe.FinalModel
{
    private final FinalModelOptionalBytes _model;

    public FinalModelVectorOptionalBytes(com.chronoxor.fbe.Buffer buffer, long offset)
    {
        super(buffer, offset);
