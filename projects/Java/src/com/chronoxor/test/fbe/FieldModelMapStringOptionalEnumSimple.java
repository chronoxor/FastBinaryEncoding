...
public final class FieldModelMapStringOptionalEnumSimple extends com.chronoxor.fbe.FieldModel
{
    private final com.chronoxor.fbe.FieldModelString _modelKey;
    private final FieldModelOptionalEnumSimple _modelValue;

    public FieldModelMapStringOptionalEnumSimple(com.chronoxor.fbe.Buffer buffer, long offset)
    {
        super(buffer, offset);
        _modelKey = new com.chronoxor.fbe.FieldModelString(buffer, offset);
        _modelValue = new FieldModelOptionalEnumSimple(buffer, offset);
    }
    ...
    // Map index operator
    public com.chronoxor.fbe.Pair<com.chronoxor.fbe.FieldModelString, FieldModelOptionalEnumSimple> getItem(long index)
    {
    ...
    public com.chronoxor.fbe.Pair<com.chronoxor.fbe.FieldModelString, FieldModelOptionalEnumSimple> resize(long size)
    {
    ...
    public void get(java.util.TreeMap<String, com.chronoxor.test.EnumSimple> values)
    {
    ...
    public void get(java.util.HashMap<String, com.chronoxor.test.EnumSimple> values)
    {
        assert (values != null) : "Invalid values parameter!";
        if (values == null)
            throw new IllegalArgumentException("Invalid values parameter!");
    ...
    public void set(java.util.TreeMap<String, com.chronoxor.test.EnumSimple> values)
    {
        assert (values != null) : "Invalid values parameter!";
        if (values == null)
            throw new IllegalArgumentException("Invalid values parameter!");
    ...
    public void set(java.util.HashMap<String, com.chronoxor.test.EnumSimple> values)
    {
        assert (values != null) : "Invalid values parameter!";
        if (values == null)
            throw new IllegalArgumentException("Invalid values parameter!");
