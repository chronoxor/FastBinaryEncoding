...
public final class FinalModelOptionalChar extends com.chronoxor.fbe.FinalModel
{
    public FinalModelOptionalChar(com.chronoxor.fbe.Buffer buffer, long offset)
    {
        super(buffer, offset);
        value = new com.chronoxor.fbe.FinalModelChar(buffer, 0);
    }
    ...
    public final com.chronoxor.fbe.FinalModelChar value;
