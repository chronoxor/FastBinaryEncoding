...
public final class FieldModelVectorStructSimple extends com.chronoxor.fbe.FieldModel
{
    private final FieldModelStructSimple _model;

    public FieldModelVectorStructSimple(com.chronoxor.fbe.Buffer buffer, long offset)
    {
        super(buffer, offset);
