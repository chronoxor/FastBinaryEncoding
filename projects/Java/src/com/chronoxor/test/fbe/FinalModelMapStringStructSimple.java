...
public final class FinalModelMapStringStructSimple extends com.chronoxor.fbe.FinalModel
{
    private final com.chronoxor.fbe.FinalModelString _modelKey;
    private final FinalModelStructSimple _modelValue;

    public FinalModelMapStringStructSimple(com.chronoxor.fbe.Buffer buffer, long offset)
    {
        super(buffer, offset);
    ...
    public long fbeAllocationSize(java.util.TreeMap<String, com.chronoxor.test.StructSimple> values)
    {
        long size = 4;
    ...
    public long fbeAllocationSize(java.util.HashMap<String, com.chronoxor.test.StructSimple> values)
    {
        long size = 4;
        for (var value : values.entrySet())
        {
    ...
    public long get(java.util.TreeMap<String, com.chronoxor.test.StructSimple> values)
    {
    ...
    public long get(java.util.HashMap<String, com.chronoxor.test.StructSimple> values)
    {
        assert (values != null) : "Invalid values parameter!";
        if (values == null)
            throw new IllegalArgumentException("Invalid values parameter!");
    ...
    public long set(java.util.TreeMap<String, com.chronoxor.test.StructSimple> values)
    {
        assert (values != null) : "Invalid values parameter!";
        if (values == null)
            throw new IllegalArgumentException("Invalid values parameter!");
    ...
    public long set(java.util.HashMap<String, com.chronoxor.test.StructSimple> values)
    {
        assert (values != null) : "Invalid values parameter!";
        if (values == null)
            throw new IllegalArgumentException("Invalid values parameter!");
