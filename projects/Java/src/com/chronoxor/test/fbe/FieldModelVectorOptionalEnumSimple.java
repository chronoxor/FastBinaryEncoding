...
public final class FieldModelVectorOptionalEnumSimple extends com.chronoxor.fbe.FieldModel
{
    private final FieldModelOptionalEnumSimple _model;

    public FieldModelVectorOptionalEnumSimple(com.chronoxor.fbe.Buffer buffer, long offset)
    {
        super(buffer, offset);
