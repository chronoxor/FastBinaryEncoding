...
public final class FinalModelOptionalprotoState extends com.chronoxor.fbe.FinalModel
{
    public FinalModelOptionalprotoState(com.chronoxor.fbe.Buffer buffer, long offset)
    {
        super(buffer, offset);
