...
public final class FinalModelArrayEnumSimple extends com.chronoxor.fbe.FinalModel
{
    private final FinalModelEnumSimple _model;
    private final long _size;

    public FinalModelArrayEnumSimple(com.chronoxor.fbe.Buffer buffer, long offset, long size)
    {
        super(buffer, offset);
