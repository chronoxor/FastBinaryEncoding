...
public final class FieldModelMapInt32OptionalEnumSimple extends com.chronoxor.fbe.FieldModel
{
    private final com.chronoxor.fbe.FieldModelInt32 _modelKey;
    private final FieldModelOptionalEnumSimple _modelValue;

    public FieldModelMapInt32OptionalEnumSimple(com.chronoxor.fbe.Buffer buffer, long offset)
    {
        super(buffer, offset);
    ...
    // Map index operator
    public com.chronoxor.fbe.Pair<com.chronoxor.fbe.FieldModelInt32, FieldModelOptionalEnumSimple> getItem(long index)
    {
    ...
    public com.chronoxor.fbe.Pair<com.chronoxor.fbe.FieldModelInt32, FieldModelOptionalEnumSimple> resize(long size)
    {
