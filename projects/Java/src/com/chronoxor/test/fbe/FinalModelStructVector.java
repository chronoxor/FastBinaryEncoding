...
public final class FinalModelStructVector extends com.chronoxor.fbe.FinalModel
{
    ...
    public FinalModelStructVector(com.chronoxor.fbe.Buffer buffer, long offset)
    {
        super(buffer, offset);
    ...
    public long fbeAllocationSize(com.chronoxor.test.StructVector fbeValue)
    {
        long fbeResult = 0
    ...
    public com.chronoxor.test.StructVector get(com.chronoxor.fbe.Size fbeSize) { return get(fbeSize, new com.chronoxor.test.StructVector()); }
    public com.chronoxor.test.StructVector get(com.chronoxor.fbe.Size fbeSize, com.chronoxor.test.StructVector fbeValue)
    {
        _buffer.shift(fbeOffset());
    ...
    public long getFields(com.chronoxor.test.StructVector fbeValue)
    {
        long fbeCurrentOffset = 0;
    ...
    public long set(com.chronoxor.test.StructVector fbeValue)
    {
        _buffer.shift(fbeOffset());
    ...
    public long setFields(com.chronoxor.test.StructVector fbeValue)
    {
        long fbeCurrentOffset = 0;
        long fbeCurrentSize = 0;
