...
public final class FinalModelMapStringOptionalBytes extends com.chronoxor.fbe.FinalModel
{
    private final com.chronoxor.fbe.FinalModelString _modelKey;
    private final FinalModelOptionalBytes _modelValue;

    public FinalModelMapStringOptionalBytes(com.chronoxor.fbe.Buffer buffer, long offset)
    {
        super(buffer, offset);
