...
public final class FieldModelOptionalInt32 extends com.chronoxor.fbe.FieldModel
{
    public FieldModelOptionalInt32(com.chronoxor.fbe.Buffer buffer, long offset)
    {
        super(buffer, offset);
        value = new com.chronoxor.fbe.FieldModelInt32(buffer, 0);
    }
    ...
    public final com.chronoxor.fbe.FieldModelInt32 value;
    ...
    public Integer get() { return get(null); }
    public Integer get(Integer defaults)
    {
    ...
    public void set(Integer optional)
    {
