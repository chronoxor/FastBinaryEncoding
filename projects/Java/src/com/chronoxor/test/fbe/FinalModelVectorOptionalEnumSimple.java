...
public final class FinalModelVectorOptionalEnumSimple extends com.chronoxor.fbe.FinalModel
{
    private final FinalModelOptionalEnumSimple _model;

    public FinalModelVectorOptionalEnumSimple(com.chronoxor.fbe.Buffer buffer, long offset)
    {
        super(buffer, offset);
