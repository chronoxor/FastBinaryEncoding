...
public final class FieldModelVectorOrder extends com.chronoxor.fbe.FieldModel
{
    ...
    public void get(java.util.ArrayList<com.chronoxor.proto.Order> values)
    {
        ...
        {
            com.chronoxor.proto.Order value = fbeModel.get();
            values.add(value);
    ...
    public void get(java.util.LinkedList<com.chronoxor.proto.Order> values)
    {
        assert (values != null) : "Invalid values parameter!";
        if (values == null)
            throw new IllegalArgumentException("Invalid values parameter!");
    ...
    public void get(java.util.HashSet<com.chronoxor.proto.Order> values)
    {
        assert (values != null) : "Invalid values parameter!";
        if (values == null)
            throw new IllegalArgumentException("Invalid values parameter!");
    ...
    public void set(java.util.ArrayList<com.chronoxor.proto.Order> values)
    {
        assert (values != null) : "Invalid values parameter!";
        if (values == null)
            throw new IllegalArgumentException("Invalid values parameter!");
    ...
    public void set(java.util.LinkedList<com.chronoxor.proto.Order> values)
    {
        assert (values != null) : "Invalid values parameter!";
        if (values == null)
            throw new IllegalArgumentException("Invalid values parameter!");
    ...
    public void set(java.util.HashSet<com.chronoxor.proto.Order> values)
    {
        assert (values != null) : "Invalid values parameter!";
        if (values == null)
            throw new IllegalArgumentException("Invalid values parameter!");
