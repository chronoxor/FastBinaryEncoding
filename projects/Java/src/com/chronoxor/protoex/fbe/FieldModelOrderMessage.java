...
public final class FieldModelOrderMessage extends com.chronoxor.fbe.FieldModel
{
    public final FieldModelOrder body;

    public FieldModelOrderMessage(com.chronoxor.fbe.Buffer buffer, long offset)
    {
        super(buffer, offset);
    ...
    public com.chronoxor.protoex.OrderMessage get() { return get(new com.chronoxor.protoex.OrderMessage()); }
    public com.chronoxor.protoex.OrderMessage get(com.chronoxor.protoex.OrderMessage fbeValue)
    {
    ...
    public void getFields(com.chronoxor.protoex.OrderMessage fbeValue, long fbeStructSize)
    {
        long fbeCurrentSize = 4 + 4;
        ...
        if ((fbeCurrentSize + body.fbeSize()) <= fbeStructSize)
            ...
            fbeValue.body = new com.chronoxor.protoex.Order();
        fbeCurrentSize += body.fbeSize();
    }
    ...
    public void set(com.chronoxor.protoex.OrderMessage fbeValue)
    {
    ...
    public void setFields(com.chronoxor.protoex.OrderMessage fbeValue)
    {
