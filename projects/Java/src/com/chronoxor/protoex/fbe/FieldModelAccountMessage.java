...
public final class FieldModelAccountMessage extends com.chronoxor.fbe.FieldModel
{
    public final FieldModelAccount body;

    public FieldModelAccountMessage(com.chronoxor.fbe.Buffer buffer, long offset)
    {
        super(buffer, offset);
    ...
    public com.chronoxor.protoex.AccountMessage get() { return get(new com.chronoxor.protoex.AccountMessage()); }
    public com.chronoxor.protoex.AccountMessage get(com.chronoxor.protoex.AccountMessage fbeValue)
    {
    ...
    public void getFields(com.chronoxor.protoex.AccountMessage fbeValue, long fbeStructSize)
    {
        long fbeCurrentSize = 4 + 4;
        ...
        if ((fbeCurrentSize + body.fbeSize()) <= fbeStructSize)
            ...
            fbeValue.body = new com.chronoxor.protoex.Account();
        fbeCurrentSize += body.fbeSize();
    }
    ...
    public void set(com.chronoxor.protoex.AccountMessage fbeValue)
    {
    ...
    public void setFields(com.chronoxor.protoex.AccountMessage fbeValue)
    {
