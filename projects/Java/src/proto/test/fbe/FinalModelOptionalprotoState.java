...
public final class FinalModelOptionalprotoState extends FinalModel
{
    ...
    {
        super(buffer, offset);
        value = new proto.fbe.FinalModelState(buffer, 0);
    }

    // Get the allocation size
    public long FBEAllocationSize(proto.State optional) { return 1 + ((optional != null) ? value.FBEAllocationSize(optional) : 0); }
    ...
    public final proto.fbe.FinalModelState value;
    ...
    public proto.State get(Size size)
    {
        ...
        _buffer.shift(FBEOffset() + 1);
        proto.State optional = value.get(size);
        _buffer.unshift(FBEOffset() + 1);
        size.value += 1;
        return optional;
    }
    ...
    public long set(proto.State optional)
    {
        assert ((_buffer.getOffset() + FBEOffset() + 1) <= _buffer.getSize()) : "Model is broken!";
        if ((_buffer.getOffset() + FBEOffset() + 1) > _buffer.getSize())
            return 0;
