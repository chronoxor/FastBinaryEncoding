...
public final class FinalModelMapInt32OptionalEnumSimple extends FinalModel
{
    private final FinalModelInt32 _modelKey;
    private final FinalModelOptionalEnumSimple _modelValue;

    public FinalModelMapInt32OptionalEnumSimple(Buffer buffer, long offset)
    {
        super(buffer, offset);
    ...
    public long fbeAllocationSize(TreeMap<Integer, EnumSimple> values)
    {
        long size = 4;
    ...
    public long fbeAllocationSize(HashMap<Integer, EnumSimple> values)
    {
        long size = 4;
        for (var value : values.entrySet())
        {
    ...
    public long get(TreeMap<Integer, EnumSimple> values)
    {
        ...
        for (long i = fbeMapSize; i-- > 0;)
        {
            ...
            size += offset.value;
            offset.value = 0;
            EnumSimple value = _modelValue.get(offset);
            _modelKey.fbeShift(offset.value);
            _modelValue.fbeShift(offset.value);
            size += offset.value;
    ...
    public long get(HashMap<Integer, EnumSimple> values)
    {
        assert (values != null) : "Invalid values parameter!";
        if (values == null)
            throw new IllegalArgumentException("Invalid values parameter!");
    ...
    public long set(TreeMap<Integer, EnumSimple> values)
    {
        assert (values != null) : "Invalid values parameter!";
        if (values == null)
            throw new IllegalArgumentException("Invalid values parameter!");
    ...
    public long set(HashMap<Integer, EnumSimple> values)
    {
        assert (values != null) : "Invalid values parameter!";
        if (values == null)
            throw new IllegalArgumentException("Invalid values parameter!");
