...
public final class FieldModelVectorEnumSimple extends FieldModel
{
    private final FieldModelEnumSimple _model;

    public FieldModelVectorEnumSimple(Buffer buffer, long offset)
    {
        super(buffer, offset);
    ...
    // Get the vector
    public void get(EnumSimple[] values)
    {
    ...
    // Set the vector
    public void set(EnumSimple[] values)
    {
        assert (values != null) : "Invalid values parameter!";
        if (values == null)
            throw new IllegalArgumentException("Invalid values parameter!");
