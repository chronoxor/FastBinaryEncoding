...
public final class FieldModelVectorStructSimple extends FieldModel
{
    private final FieldModelStructSimple _model;

    public FieldModelVectorStructSimple(Buffer buffer, long offset)
    {
        super(buffer, offset);
    ...
    public FieldModelStructSimple getItem(long index)
    {
    ...
    public FieldModelStructSimple resize(long size)
    {
