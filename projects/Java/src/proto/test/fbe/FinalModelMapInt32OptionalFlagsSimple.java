...
// Fast Binary Encoding Int32->OptionalFlagsSimple map final model class
public final class FinalModelMapInt32OptionalFlagsSimple extends FinalModel
{
    private final FinalModelInt32 _modelKey;
    private final FinalModelOptionalFlagsSimple _modelValue;

    public FinalModelMapInt32OptionalFlagsSimple(Buffer buffer, long offset)
    {
        super(buffer, offset);
    ...
    public long FBEAllocationSize(TreeMap<Integer, FlagsSimple> values)
    {
        long size = 4;
    ...
    public long FBEAllocationSize(HashMap<Integer, FlagsSimple> values)
    {
        long size = 4;
        for (var value : values.entrySet())
        {
    ...
    public long get(TreeMap<Integer, FlagsSimple> values)
    {
    ...
    public long get(HashMap<Integer, FlagsSimple> values)
    {
        assert (values != null) : "Invalid values parameter!";
        if (values == null)
            throw new IllegalArgumentException("Invalid values parameter!");
    ...
    public long set(TreeMap<Integer, FlagsSimple> values)
    {
        assert (values != null) : "Invalid values parameter!";
        if (values == null)
            throw new IllegalArgumentException("Invalid values parameter!");
