...
// Fast Binary Encoding Int32->FlagsSimple map field model class
public final class FieldModelMapInt32FlagsSimple extends FieldModel
{
    private final FieldModelInt32 _modelKey;
    private final FieldModelFlagsSimple _modelValue;

    public FieldModelMapInt32FlagsSimple(Buffer buffer, long offset)
    {
        super(buffer, offset);
    ...
    public Pair<FieldModelInt32, FieldModelFlagsSimple> getItem(long index)
    {
        ...
        return new Pair<FieldModelInt32, FieldModelFlagsSimple>(_modelKey, _modelValue);
    }
