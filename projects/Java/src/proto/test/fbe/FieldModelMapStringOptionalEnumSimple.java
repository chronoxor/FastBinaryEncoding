...
// Fast Binary Encoding String->OptionalEnumSimple map field model class
public final class FieldModelMapStringOptionalEnumSimple extends FieldModel
{
    private final FieldModelString _modelKey;
    private final FieldModelOptionalEnumSimple _modelValue;

    public FieldModelMapStringOptionalEnumSimple(Buffer buffer, long offset)
    {
        super(buffer, offset);
    ...
    // Map index operator
    public Pair<FieldModelString, FieldModelOptionalEnumSimple> getItem(long index)
    {
        ...
        return new Pair<FieldModelString, FieldModelOptionalEnumSimple>(_modelKey, _modelValue);
    }

    // Resize the map and get its first model
    public Pair<FieldModelString, FieldModelOptionalEnumSimple> resize(long size)
    {
