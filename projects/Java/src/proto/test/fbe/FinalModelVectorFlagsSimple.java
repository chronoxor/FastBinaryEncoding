...
public final class FinalModelVectorFlagsSimple extends FinalModel
{
    private final FinalModelFlagsSimple _model;

    public FinalModelVectorFlagsSimple(Buffer buffer, long offset)
    {
        super(buffer, offset);
        _model = new FinalModelFlagsSimple(buffer, offset);
    }
