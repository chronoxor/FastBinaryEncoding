...
public final class FieldModelMapStringStructSimple extends FieldModel
{
    ...
    public FieldModelMapStringStructSimple(Buffer buffer, long offset)
    {
        super(buffer, offset);
    ...
    // Map index operator
    public Pair<FieldModelString, FieldModelStructSimple> getItem(long index)
    {
        ...
        return new Pair<FieldModelString, FieldModelStructSimple>(_modelKey, _modelValue);
    }

    // Resize the map and get its first model
    public Pair<FieldModelString, FieldModelStructSimple> resize(long size)
    {
