...
// Fast Binary Encoding String->EnumSimple map final model class
public final class FinalModelMapStringEnumSimple extends FinalModel
{
    private final FinalModelString _modelKey;
    private final FinalModelEnumSimple _modelValue;

    public FinalModelMapStringEnumSimple(Buffer buffer, long offset)
    {
        super(buffer, offset);
