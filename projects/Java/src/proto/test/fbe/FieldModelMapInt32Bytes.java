...
public final class FieldModelMapInt32Bytes extends FieldModel
{
    private final FieldModelInt32 _modelKey;
    private final FieldModelBytes _modelValue;

    public FieldModelMapInt32Bytes(Buffer buffer, long offset)
    {
        super(buffer, offset);
    ...
    // Map index operator
    public Pair<FieldModelInt32, FieldModelBytes> getItem(long index)
    {
    ...
    public Pair<FieldModelInt32, FieldModelBytes> resize(long size)
    {
