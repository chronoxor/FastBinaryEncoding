...
// Fast Binary Encoding optional protoState field model class
public final class FieldModelOptionalprotoState extends FieldModel
{
    ...
    {
        super(buffer, offset);
        value = new proto.fbe.FieldModelState(buffer, 0);
    }
    ...
    public final proto.fbe.FieldModelState value;
    ...
    public proto.State get() { return get(null); }
    public proto.State get(proto.State defaults)
    {
        long fbeBegin = getBegin();
        if (fbeBegin == 0)
            return defaults;

        proto.State optional = value.get();
    ...
    public void set(proto.State optional)
    {
