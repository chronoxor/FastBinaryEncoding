...
// Fast Binary Encoding Int32->OptionalStructSimple map field model class
public final class FieldModelMapInt32OptionalStructSimple extends FieldModel
{
    private final FieldModelInt32 _modelKey;
    private final FieldModelOptionalStructSimple _modelValue;

    public FieldModelMapInt32OptionalStructSimple(Buffer buffer, long offset)
    {
        super(buffer, offset);
    ...
    // Map index operator
    public Pair<FieldModelInt32, FieldModelOptionalStructSimple> getItem(long index)
    {
        ...
        return new Pair<FieldModelInt32, FieldModelOptionalStructSimple>(_modelKey, _modelValue);
    }

    // Resize the map and get its first model
    public Pair<FieldModelInt32, FieldModelOptionalStructSimple> resize(long size)
    {
    ...
    public void get(TreeMap<Integer, StructSimple> values)
    {
    ...
    public void get(HashMap<Integer, StructSimple> values)
    {
        assert (values != null) : "Invalid values parameter!";
        if (values == null)
            throw new IllegalArgumentException("Invalid values parameter!");
    ...
    public void set(TreeMap<Integer, StructSimple> values)
    {
        assert (values != null) : "Invalid values parameter!";
        if (values == null)
            throw new IllegalArgumentException("Invalid values parameter!");
    ...
    public void set(HashMap<Integer, StructSimple> values)
    {
        assert (values != null) : "Invalid values parameter!";
        if (values == null)
            throw new IllegalArgumentException("Invalid values parameter!");
