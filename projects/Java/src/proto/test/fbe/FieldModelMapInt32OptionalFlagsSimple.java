...
public final class FieldModelMapInt32OptionalFlagsSimple extends FieldModel
{
    private final FieldModelInt32 _modelKey;
    private final FieldModelOptionalFlagsSimple _modelValue;

    public FieldModelMapInt32OptionalFlagsSimple(Buffer buffer, long offset)
    {
        super(buffer, offset);
    ...
    // Map index operator
    public Pair<FieldModelInt32, FieldModelOptionalFlagsSimple> getItem(long index)
    {
        ...
        return new Pair<FieldModelInt32, FieldModelOptionalFlagsSimple>(_modelKey, _modelValue);
    }

    // Resize the map and get its first model
    public Pair<FieldModelInt32, FieldModelOptionalFlagsSimple> resize(long size)
    {
    ...
    public void get(TreeMap<Integer, FlagsSimple> values)
    {
    ...
    public void get(HashMap<Integer, FlagsSimple> values)
    {
        assert (values != null) : "Invalid values parameter!";
        if (values == null)
            throw new IllegalArgumentException("Invalid values parameter!");
    ...
    public void set(TreeMap<Integer, FlagsSimple> values)
    {
        assert (values != null) : "Invalid values parameter!";
        if (values == null)
            throw new IllegalArgumentException("Invalid values parameter!");
    ...
    public void set(HashMap<Integer, FlagsSimple> values)
    {
        assert (values != null) : "Invalid values parameter!";
        if (values == null)
            throw new IllegalArgumentException("Invalid values parameter!");
