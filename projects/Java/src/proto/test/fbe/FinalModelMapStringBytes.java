...
// Fast Binary Encoding String->Bytes map final model class
public final class FinalModelMapStringBytes extends FinalModel
{
    private final FinalModelString _modelKey;
    private final FinalModelBytes _modelValue;

    public FinalModelMapStringBytes(Buffer buffer, long offset)
    {
        super(buffer, offset);
