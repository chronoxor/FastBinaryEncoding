...
public final class FinalModelOptionalprotoBalance extends FinalModel
{
    ...
    {
        super(buffer, offset);
        value = new proto.fbe.FinalModelBalance(buffer, 0);
    }

    // Get the allocation size
    public long fbeAllocationSize(proto.Balance optional) { return 1 + ((optional != null) ? value.fbeAllocationSize(optional) : 0); }
    ...
    public final proto.fbe.FinalModelBalance value;
    ...
    public proto.Balance get(Size size)
    {
        ...
        _buffer.shift(fbeOffset() + 1);
        proto.Balance optional = value.get(size);
        _buffer.unshift(fbeOffset() + 1);
        size.value += 1;
        return optional;
    }
    ...
    public long set(proto.Balance optional)
    {
        assert ((_buffer.getOffset() + fbeOffset() + 1) <= _buffer.getSize()) : "Model is broken!";
        if ((_buffer.getOffset() + fbeOffset() + 1) > _buffer.getSize())
            return 0;
