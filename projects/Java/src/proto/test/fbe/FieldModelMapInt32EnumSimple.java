...
// Fast Binary Encoding Int32->EnumSimple map field model class
public final class FieldModelMapInt32EnumSimple extends FieldModel
{
    private final FieldModelInt32 _modelKey;
    private final FieldModelEnumSimple _modelValue;

    public FieldModelMapInt32EnumSimple(Buffer buffer, long offset)
    {
        super(buffer, offset);
    ...
    // Map index operator
    public Pair<FieldModelInt32, FieldModelEnumSimple> getItem(long index)
    {
        ...
        return new Pair<FieldModelInt32, FieldModelEnumSimple>(_modelKey, _modelValue);
    }

    // Resize the map and get its first model
    public Pair<FieldModelInt32, FieldModelEnumSimple> resize(long size)
    {
