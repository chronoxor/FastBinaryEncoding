...
// Fast Binary Encoding optional protoOrderSide field model class
public final class FieldModelOptionalprotoOrderSide extends FieldModel
{
    public FieldModelOptionalprotoOrderSide(Buffer buffer, long offset)
    {
        super(buffer, offset);
        value = new proto.fbe.FieldModelOrderSide(buffer, 0);
    }
    ...
    public final proto.fbe.FieldModelOrderSide value;
    ...
    public proto.OrderSide get() { return get(null); }
    public proto.OrderSide get(proto.OrderSide defaults)
    {
        long fbeBegin = getBegin();
        if (fbeBegin == 0)
            return defaults;

        proto.OrderSide optional = value.get();
    ...
    public void set(proto.OrderSide optional)
    {
