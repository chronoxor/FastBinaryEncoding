...
// Fast Binary Encoding Int32->OptionalEnumSimple map field model class
public final class FieldModelMapInt32OptionalEnumSimple extends FieldModel
{
    private final FieldModelInt32 _modelKey;
    private final FieldModelOptionalEnumSimple _modelValue;

    public FieldModelMapInt32OptionalEnumSimple(Buffer buffer, long offset)
    {
        super(buffer, offset);
    ...
    // Map index operator
    public Pair<FieldModelInt32, FieldModelOptionalEnumSimple> getItem(long index)
    {
        ...
        return new Pair<FieldModelInt32, FieldModelOptionalEnumSimple>(_modelKey, _modelValue);
    }

    // Resize the map and get its first model
    public Pair<FieldModelInt32, FieldModelOptionalEnumSimple> resize(long size)
    {
    ...
    public void get(TreeMap<Integer, EnumSimple> values)
    {
    ...
    public void get(HashMap<Integer, EnumSimple> values)
    {
        assert (values != null) : "Invalid values parameter!";
        if (values == null)
            throw new IllegalArgumentException("Invalid values parameter!");
    ...
    public void set(TreeMap<Integer, EnumSimple> values)
    {
        assert (values != null) : "Invalid values parameter!";
        if (values == null)
            throw new IllegalArgumentException("Invalid values parameter!");
    ...
    public void set(HashMap<Integer, EnumSimple> values)
    {
        assert (values != null) : "Invalid values parameter!";
        if (values == null)
            throw new IllegalArgumentException("Invalid values parameter!");
