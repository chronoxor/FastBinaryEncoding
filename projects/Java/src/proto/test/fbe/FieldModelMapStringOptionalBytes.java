...
public final class FieldModelMapStringOptionalBytes extends FieldModel
{
    private final FieldModelString _modelKey;
    private final FieldModelOptionalBytes _modelValue;

    public FieldModelMapStringOptionalBytes(Buffer buffer, long offset)
    {
        super(buffer, offset);
    ...
    // Map index operator
    public Pair<FieldModelString, FieldModelOptionalBytes> getItem(long index)
    {
        ...
        return new Pair<FieldModelString, FieldModelOptionalBytes>(_modelKey, _modelValue);
    }

    // Resize the map and get its first model
    public Pair<FieldModelString, FieldModelOptionalBytes> resize(long size)
    {
