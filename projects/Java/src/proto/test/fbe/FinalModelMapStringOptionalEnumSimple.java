...
public final class FinalModelMapStringOptionalEnumSimple extends FinalModel
{
    private final FinalModelString _modelKey;
    private final FinalModelOptionalEnumSimple _modelValue;

    public FinalModelMapStringOptionalEnumSimple(Buffer buffer, long offset)
    {
        super(buffer, offset);
    ...
    public long fbeAllocationSize(TreeMap<String, EnumSimple> values)
    {
        long size = 4;
    ...
    public long fbeAllocationSize(HashMap<String, EnumSimple> values)
    {
        long size = 4;
        for (var value : values.entrySet())
        {
    ...
    public long get(TreeMap<String, EnumSimple> values)
    {
    ...
    public long get(HashMap<String, EnumSimple> values)
    {
        assert (values != null) : "Invalid values parameter!";
        if (values == null)
            throw new IllegalArgumentException("Invalid values parameter!");
    ...
    public long set(TreeMap<String, EnumSimple> values)
    {
        assert (values != null) : "Invalid values parameter!";
        if (values == null)
            throw new IllegalArgumentException("Invalid values parameter!");
    ...
    public long set(HashMap<String, EnumSimple> values)
    {
        assert (values != null) : "Invalid values parameter!";
        if (values == null)
            throw new IllegalArgumentException("Invalid values parameter!");
