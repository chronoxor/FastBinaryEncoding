...
// Fast Binary Encoding optional protoAccount field model class
public final class FieldModelOptionalprotoAccount extends FieldModel
{
    ...
    {
        super(buffer, offset);
        value = new proto.fbe.FieldModelAccount(buffer, 0);
    }
    ...
    public final proto.fbe.FieldModelAccount value;
    ...
    public proto.Account get() { return get(null); }
    public proto.Account get(proto.Account defaults)
    {
        long fbeBegin = getBegin();
        if (fbeBegin == 0)
            return defaults;

        proto.Account optional = value.get();
    ...
    public void set(proto.Account optional)
    {
