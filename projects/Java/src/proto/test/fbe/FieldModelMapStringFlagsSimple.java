...
// Fast Binary Encoding String->FlagsSimple map field model class
public final class FieldModelMapStringFlagsSimple extends FieldModel
{
    private final FieldModelString _modelKey;
    private final FieldModelFlagsSimple _modelValue;

    public FieldModelMapStringFlagsSimple(Buffer buffer, long offset)
    {
        super(buffer, offset);
    ...
    // Map index operator
    public Pair<FieldModelString, FieldModelFlagsSimple> getItem(long index)
    {
        ...
        return new Pair<FieldModelString, FieldModelFlagsSimple>(_modelKey, _modelValue);
    }

    // Resize the map and get its first model
    public Pair<FieldModelString, FieldModelFlagsSimple> resize(long size)
    {
