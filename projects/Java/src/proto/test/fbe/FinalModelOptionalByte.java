...
public final class FinalModelOptionalByte extends FinalModel
{
    public FinalModelOptionalByte(Buffer buffer, long offset)
    {
        super(buffer, offset);
        value = new FinalModelByte(buffer, 0);
    }
    ...
    public final FinalModelByte value;
