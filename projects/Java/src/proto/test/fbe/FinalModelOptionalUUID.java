...
public final class FinalModelOptionalUUID extends FinalModel
{
    ...
    {
        super(buffer, offset);
        value = new FinalModelUUID(buffer, 0);
    }

    // Get the allocation size
    public long fbeAllocationSize(UUID optional) { return 1 + ((optional != null) ? value.fbeAllocationSize(optional) : 0); }
    ...
    public final FinalModelUUID value;
