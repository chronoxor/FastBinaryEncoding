...
public final class FieldModelOptionalByte extends FieldModel
{
    public FieldModelOptionalByte(Buffer buffer, long offset)
    {
        super(buffer, offset);
        value = new FieldModelByte(buffer, 0);
    }
    ...
    public final FieldModelByte value;
