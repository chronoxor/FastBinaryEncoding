...
public final class FieldModelOptionalprotoBalance extends FieldModel
{
    ...
    {
        super(buffer, offset);
        value = new proto.fbe.FieldModelBalance(buffer, 0);
    }
    ...
    public final proto.fbe.FieldModelBalance value;
    ...
    public proto.Balance get() { return get(null); }
    public proto.Balance get(proto.Balance defaults)
    {
        long fbeBegin = getBegin();
        if (fbeBegin == 0)
            return defaults;

        proto.Balance optional = value.get();
    ...
    public void set(proto.Balance optional)
    {
