...
public final class FieldModelOptionalprotoOrderType extends FieldModel
{
    ...
    {
        super(buffer, offset);
        value = new proto.fbe.FieldModelOrderType(buffer, 0);
    }
    ...
    public final proto.fbe.FieldModelOrderType value;
    ...
    public proto.OrderType get() { return get(null); }
    public proto.OrderType get(proto.OrderType defaults)
    {
        long fbeBegin = getBegin();
        if (fbeBegin == 0)
            return defaults;

        proto.OrderType optional = value.get();
    ...
    public void set(proto.OrderType optional)
    {
