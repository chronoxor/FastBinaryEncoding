...
public final class FinalModelStructHash extends FinalModel
{
    ...
    public FinalModelStructHash(Buffer buffer, long offset)
    {
        super(buffer, offset);
    ...
    public long FBEAllocationSize(StructHash fbeValue)
    {
        long fbeResult = 0
    ...
    // Get the field type
    public long FBEType() { return 141; }
    ...
    public StructHash get(Size fbeSize) { return get(fbeSize, new StructHash()); }
    public StructHash get(Size fbeSize, StructHash fbeValue)
    {
        _buffer.shift(FBEOffset());
    ...
    public long getFields(StructHash fbeValue)
    {
        long fbeCurrentOffset = 0;
    ...
    public long set(StructHash fbeValue)
    {
        _buffer.shift(FBEOffset());
