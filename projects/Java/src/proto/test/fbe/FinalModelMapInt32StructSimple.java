...
// Fast Binary Encoding Int32->StructSimple map final model class
public final class FinalModelMapInt32StructSimple extends FinalModel
{
    private final FinalModelInt32 _modelKey;
    private final FinalModelStructSimple _modelValue;

    public FinalModelMapInt32StructSimple(Buffer buffer, long offset)
    {
        super(buffer, offset);
    ...
    public long FBEAllocationSize(TreeMap<Integer, StructSimple> values)
    {
        long size = 4;
    ...
    public long FBEAllocationSize(HashMap<Integer, StructSimple> values)
    {
        long size = 4;
        for (var value : values.entrySet())
        {
    ...
    public long get(TreeMap<Integer, StructSimple> values)
    {
    ...
    public long get(HashMap<Integer, StructSimple> values)
    {
        assert (values != null) : "Invalid values parameter!";
        if (values == null)
            throw new IllegalArgumentException("Invalid values parameter!");
    ...
    public long set(TreeMap<Integer, StructSimple> values)
    {
        assert (values != null) : "Invalid values parameter!";
        if (values == null)
            throw new IllegalArgumentException("Invalid values parameter!");
    ...
    public long set(HashMap<Integer, StructSimple> values)
    {
        assert (values != null) : "Invalid values parameter!";
        if (values == null)
            throw new IllegalArgumentException("Invalid values parameter!");
