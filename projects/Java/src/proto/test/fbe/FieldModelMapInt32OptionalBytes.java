...
// Fast Binary Encoding Int32->OptionalBytes map field model class
public final class FieldModelMapInt32OptionalBytes extends FieldModel
{
    private final FieldModelInt32 _modelKey;
    private final FieldModelOptionalBytes _modelValue;

    public FieldModelMapInt32OptionalBytes(Buffer buffer, long offset)
    {
        super(buffer, offset);
    ...
    // Map index operator
    public Pair<FieldModelInt32, FieldModelOptionalBytes> getItem(long index)
    {
    ...
    public void get(TreeMap<Integer, ByteBuffer> values)
    {
    ...
    public void get(HashMap<Integer, ByteBuffer> values)
    {
        assert (values != null) : "Invalid values parameter!";
        if (values == null)
            throw new IllegalArgumentException("Invalid values parameter!");
    ...
    public void set(TreeMap<Integer, ByteBuffer> values)
    {
        assert (values != null) : "Invalid values parameter!";
        if (values == null)
            throw new IllegalArgumentException("Invalid values parameter!");
