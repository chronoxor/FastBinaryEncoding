...
public class BenchmarkSerialization
{
    ...
    private final com.chronoxor.proto.fbe.AccountModel _writer;
    private final com.chronoxor.proto.fbe.AccountModel _reader;
    ...
    public BenchmarkSerialization()
    {
        ...
        _writer = new com.chronoxor.proto.fbe.AccountModel();
        _writer.serialize(_account);
        assert _writer.verify();

        // Deserialize the account from the FBE stream
        _reader = new com.chronoxor.proto.fbe.AccountModel();
