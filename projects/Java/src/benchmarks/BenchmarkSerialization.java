...
public class BenchmarkSerialization
{
    ...
    private final proto.fbe.AccountModel _writer;
    private final proto.fbe.AccountModel _reader;
    ...
    public BenchmarkSerialization()
    {
        ...
        _writer = new proto.fbe.AccountModel();
        _writer.serialize(_account);
        assert _writer.verify();

        // Deserialize the account from the FBE stream
        _reader = new proto.fbe.AccountModel();
