...
public class OrderMessageFinalModel: Model {
    private let _model: FinalModelOrderMessage

    public override init(buffer: Buffer = Buffer()) {
        _model = FinalModelOrderMessage(buffer: buffer, offset: 8)
    ...
    static let fbeTypeConst: Int = FinalModelOrderMessage.fbeTypeConst
