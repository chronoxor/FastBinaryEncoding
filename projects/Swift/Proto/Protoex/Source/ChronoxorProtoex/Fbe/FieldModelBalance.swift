...
public class FieldModelBalance: FieldModel {
    ...
    let parent: ChronoxorProto.FieldModelBalance

    let locked: ChronoxorFbe.FieldModelDouble
    ...
    public required init() {
        ...
        parent = ChronoxorProto.FieldModelBalance(buffer: buffer, offset: 4 + 4)
    ...
    public static let fbeTypeConst: Int = ChronoxorProto.FieldModelBalance.fbeTypeConst
