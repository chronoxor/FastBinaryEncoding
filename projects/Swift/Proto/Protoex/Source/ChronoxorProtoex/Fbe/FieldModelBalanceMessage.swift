...
public class FieldModelBalanceMessage: FieldModel {

    public var _buffer: Buffer
    public var _offset: Int

    let body: FieldModelBalance
    ...
    public required init() {
        ...
        body = FieldModelBalance(buffer: buffer, offset: 4 + 4)
    ...
    public static let fbeTypeConst: Int = 12
    ...
    public func get() -> BalanceMessage {
        var fbeValue = BalanceMessage()
        return get(fbeValue: &fbeValue)
    }

    public func get(fbeValue: inout BalanceMessage) -> BalanceMessage {
    ...
    public func getFields(fbeValue: inout BalanceMessage, fbeStructSize: Int) {
        var fbeCurrentSize = 4 + 4

        if fbeCurrentSize + body.fbeSize <= fbeStructSize {
            fbeValue.body = body.get()
        } else {
            fbeValue.body = ChronoxorProtoex.Balance()
        }
        fbeCurrentSize += body.fbeSize
    }
    ...
    public func set(value fbeValue: BalanceMessage) throws {
    ...
    public func setFields(fbeValue: BalanceMessage) throws {
