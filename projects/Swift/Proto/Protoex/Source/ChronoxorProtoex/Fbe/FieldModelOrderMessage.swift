...
public class FieldModelOrderMessage: FieldModel {

    public var _buffer: Buffer
    public var _offset: Int

    let body: FieldModelOrder
    ...
    public required init() {
        ...
        body = FieldModelOrder(buffer: buffer, offset: 4 + 4)
    ...
    public func get() -> OrderMessage {
        var fbeValue = OrderMessage()
        return get(fbeValue: &fbeValue)
    }

    public func get(fbeValue: inout OrderMessage) -> OrderMessage {
    ...
    public func getFields(fbeValue: inout OrderMessage, fbeStructSize: Int) {
        var fbeCurrentSize = 4 + 4

        if fbeCurrentSize + body.fbeSize <= fbeStructSize {
            fbeValue.body = body.get()
        } else {
            fbeValue.body = ChronoxorProtoex.Order()
        }
        fbeCurrentSize += body.fbeSize
    }
    ...
    public func set(value fbeValue: OrderMessage) throws {
    ...
    public func setFields(fbeValue: OrderMessage) throws {
