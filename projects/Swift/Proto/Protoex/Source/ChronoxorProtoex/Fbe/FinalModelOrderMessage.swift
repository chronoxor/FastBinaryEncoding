...
public class FinalModelOrderMessage: FinalModel {
    public var _buffer: Buffer
    public var _offset: Int

    let body: FinalModelOrder

    // Field type
    public var fbeType: Int = fbeTypeConst

    public static let fbeTypeConst: Int = 11

    public required init(buffer: Buffer, offset: Int) {
        _buffer = buffer
        _offset = offset

        body = FinalModelOrder(buffer: buffer, offset: 0)
    }

    // Get the allocation size
    public func fbeAllocationSize(value fbeValue: OrderMessage) -> Int {
        return 0
    ...
    public func get(size: inout Size) -> OrderMessage {
        var fbeValue = OrderMessage()
        return get(size: &size, fbeValue: &fbeValue)
    }

    // Get the struct value
    public func get(size: inout Size, fbeValue: inout OrderMessage) -> OrderMessage {
        _buffer.shift(offset: fbeOffset)
    ...
    public func getFields(fbeValue: inout OrderMessage) -> Int {
        var fbeCurrentOffset: Int = 0
    ...
    public func set(value fbeValue: OrderMessage) throws -> Int {
        _buffer.shift(offset: fbeOffset)
    ...
    public func setFields(fbeValue: OrderMessage) throws -> Int {
        var fbeCurrentOffset: Int = 0
        var fbeCurrentSize: Int = 0
