...
public class BalanceFinalModel: Model {
    private let _model: FinalModelBalance
    ...
    public func serialize(value: Balance) throws -> Int {
    ...
    public func deserialize() -> Balance { var value = Balance(); _ = deserialize(value: &value); return value }

    public func deserialize(value: inout Balance) -> Int {
        if (buffer.offset + _model.fbeOffset) > buffer.size {
            assertionFailure("Model is broken!")
            return 0
        }
