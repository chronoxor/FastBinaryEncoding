...
public class EnumUInt8: Comparable, Hashable, Codable {
    ...
    var value: EnumUInt8Enum? = EnumUInt8Enum.values().first
    ...
    public func setEnum(value: UInt8) { self.value = EnumUInt8Enum.mapValue(value: value) }
    public func setEnum(value: EnumUInt8Enum) { self.value = value }
    public func setEnum(value: EnumUInt8) { self.value = value.value }
    ...
    public class func fromJson(_ json: String) throws -> EnumUInt8 {
