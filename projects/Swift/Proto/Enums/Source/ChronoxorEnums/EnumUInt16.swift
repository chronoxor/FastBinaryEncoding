...
public class EnumUInt16: Comparable, Hashable, Codable {
    ...
    var value: EnumUInt16Enum? = EnumUInt16Enum.values().first
    ...
    public func setDefault() { setEnum(value: NSNumber(value: 0).uint16Value) }

    public func setEnum(value: UInt16) { self.value = EnumUInt16Enum.mapValue(value: value) }
    public func setEnum(value: EnumUInt16Enum) { self.value = value }
    public func setEnum(value: EnumUInt16) { self.value = value.value }
    ...
    public class func fromJson(_ json: String) throws -> EnumUInt16 {
