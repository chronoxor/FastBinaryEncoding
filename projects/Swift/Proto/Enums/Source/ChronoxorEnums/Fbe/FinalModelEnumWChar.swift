...
public class FinalModelEnumWChar: FinalModel {
    ...
    public func fbeAllocationSize(value: EnumWChar) -> Int { fbeSize }
    ...
    // Get the value
    public func get(size: inout Size) -> EnumWChar {
        if _buffer.offset + fbeOffset + fbeSize > _buffer.size {
            return EnumWChar()
        }
    ...
    // Set the value
    public func set(value: EnumWChar) throws -> Int {
        if _buffer.offset + fbeOffset + fbeSize > _buffer.size {
