...
public class FinalModelEnumUInt8: FinalModel {
    ...
    public func fbeAllocationSize(value: EnumUInt8) -> Int { fbeSize }
    ...
    // Get the value
    public func get(size: inout Size) -> EnumUInt8 {
        if _buffer.offset + fbeOffset + fbeSize > _buffer.size {
            return EnumUInt8()
        }
    ...
    // Set the value
    public func set(value: EnumUInt8) throws -> Int {
        if _buffer.offset + fbeOffset + fbeSize > _buffer.size {
