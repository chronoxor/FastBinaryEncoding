...
public class FinalModelEnumUInt64: FinalModel {
    ...
    public func fbeAllocationSize(value: EnumUInt64) -> Int { fbeSize }
    ...
    // Get the value
    public func get(size: inout Size) -> EnumUInt64 {
        if _buffer.offset + fbeOffset + fbeSize > _buffer.size {
            return EnumUInt64()
        }
    ...
    // Set the value
    public func set(value: EnumUInt64) throws -> Int {
        if _buffer.offset + fbeOffset + fbeSize > _buffer.size {
