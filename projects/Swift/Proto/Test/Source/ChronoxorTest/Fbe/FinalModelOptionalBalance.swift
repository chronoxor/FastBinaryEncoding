...
class FinalModelOptionalBalance: FinalModel {
    ...
    let value: ChronoxorProto.FinalModelBalance
    ...
    required init() {
        ...
        value = ChronoxorProto.FinalModelBalance(buffer: buffer, offset: offset)
    }
    ...
    func fbeAllocationSize(value optional: ChronoxorProto.Balance?) -> Int {
    ...
    public func get(size: inout Size) -> ChronoxorProto.Balance? {
        if _buffer.offset + fbeOffset + 1 > _buffer.size {
    ...
    public func set(value optional: ChronoxorProto.Balance?) throws -> Int {
        if _buffer.offset + fbeOffset + 1 > _buffer.size {
            assertionFailure("Model is broken!")
            return 0
        }
