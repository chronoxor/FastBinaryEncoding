...
class FieldModelMapStringOptionalData: FieldModel {
    ...
    public func getItem(index: Int) -> (ChronoxorFbe.FieldModelString, FieldModelOptionalData) {
    ...
    func resize(size: Int) throws -> (ChronoxorFbe.FieldModelString, FieldModelOptionalData) {
