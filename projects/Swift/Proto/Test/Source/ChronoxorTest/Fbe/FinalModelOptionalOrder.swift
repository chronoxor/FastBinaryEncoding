...
class FinalModelOptionalOrder: FinalModel {
    ...
    let value: ChronoxorProto.FinalModelOrder
    ...
    required init() {
        ...
        value = ChronoxorProto.FinalModelOrder(buffer: buffer, offset: offset)
    }
    ...
    func fbeAllocationSize(value optional: ChronoxorProto.Order?) -> Int {
    ...
    public func get(size: inout Size) -> ChronoxorProto.Order? {
        if _buffer.offset + fbeOffset + 1 > _buffer.size {
    ...
    public func set(value optional: ChronoxorProto.Order?) throws -> Int {
        if _buffer.offset + fbeOffset + 1 > _buffer.size {
            assertionFailure("Model is broken!")
            return 0
        }
