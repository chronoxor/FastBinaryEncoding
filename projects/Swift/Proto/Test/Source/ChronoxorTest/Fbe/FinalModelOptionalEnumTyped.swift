...
class FinalModelOptionalEnumTyped: FinalModel {

    var _buffer: Buffer
    var _offset: Int

    // Base field model value
    let value: FinalModelEnumTyped
    ...
    required init() {
        ...
        value = FinalModelEnumTyped(buffer: buffer, offset: offset)
    }
    ...
    func fbeAllocationSize(value optional: EnumTyped?) -> Int {
    ...
    public func set(value optional: EnumTyped?) throws -> Int {
        if _buffer.offset + fbeOffset + 1 > _buffer.size {
            assertionFailure("Model is broken!")
            return 0
        }
