...
class FieldModelMapInt32EnumSimple: FieldModel {
    ...
    public func getItem(index: Int) -> (ChronoxorFbe.FieldModelInt32, FieldModelEnumSimple) {
    ...
    func resize(size: Int) throws -> (ChronoxorFbe.FieldModelInt32, FieldModelEnumSimple) {
