...
public class FieldModelOptionalOrderSide: FieldModel {
    ...
    public let value: ChronoxorProto.FieldModelOrderSide
    ...
    public required init() {
        ...
        value = ChronoxorProto.FieldModelOrderSide(buffer: buffer, offset: 0)
    }
    ...
    public func get(defaults: ChronoxorProto.OrderSide? = nil) -> ChronoxorProto.OrderSide? {
    ...
    // Set the optional value (end phase)
      ...
      public func set(value optional: ChronoxorProto.OrderSide?) throws {
