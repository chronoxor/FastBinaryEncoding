...
public class StructHashExModel: Model {
    public let model: FieldModelStructHashEx

    public override init(buffer: Buffer = Buffer()) {
        model = FieldModelStructHashEx(buffer: buffer, offset: 4)
    ...
    static let fbeTypeConst: Int = FieldModelStructHashEx.fbeTypeConst
