...
class FieldModelMapStringOptionalUInt8: FieldModel {
    ...
    public func getItem(index: Int) -> (ChronoxorFbe.FieldModelString, FieldModelOptionalUInt8) {
    ...
    func resize(size: Int) throws -> (ChronoxorFbe.FieldModelString, FieldModelOptionalUInt8) {
