...
class FieldModelMapStringFlagsSimple: FieldModel {
    ...
    public func getItem(index: Int) -> (ChronoxorFbe.FieldModelString, FieldModelFlagsSimple) {
    ...
    func resize(size: Int) throws -> (ChronoxorFbe.FieldModelString, FieldModelFlagsSimple) {
