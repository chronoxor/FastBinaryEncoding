...
class FieldModelMapInt32UInt8: FieldModel {
    ...
    public func getItem(index: Int) -> (ChronoxorFbe.FieldModelInt32, ChronoxorFbe.FieldModelUInt8) {
    ...
    func resize(size: Int) throws -> (ChronoxorFbe.FieldModelInt32, ChronoxorFbe.FieldModelUInt8) {
