...
class FinalModelOptionalAccount: FinalModel {
    ...
    let value: ChronoxorProto.FinalModelAccount
    ...
    required init() {
        ...
        value = ChronoxorProto.FinalModelAccount(buffer: buffer, offset: offset)
    }
    ...
    func fbeAllocationSize(value optional: ChronoxorProto.Account?) -> Int {
    ...
    public func get(size: inout Size) -> ChronoxorProto.Account? {
        if _buffer.offset + fbeOffset + 1 > _buffer.size {
    ...
    public func set(value optional: ChronoxorProto.Account?) throws -> Int {
        if _buffer.offset + fbeOffset + 1 > _buffer.size {
            assertionFailure("Model is broken!")
            return 0
        }
