...
public class FieldModelStructVector: FieldModel {
    ...
    public func get() -> StructVector {
        var fbeValue = StructVector()
        return get(fbeValue: &fbeValue)
    }

    public func get(fbeValue: inout StructVector) -> StructVector {
    ...
    public func getFields(fbeValue: inout StructVector, fbeStructSize: Int) {
        var fbeCurrentSize = 4 + 4
    ...
    public func set(value fbeValue: StructVector) throws {
    ...
    public func setFields(fbeValue: StructVector) throws {
