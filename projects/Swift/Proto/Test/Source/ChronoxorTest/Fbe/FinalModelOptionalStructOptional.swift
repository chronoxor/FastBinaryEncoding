...
class FinalModelOptionalStructOptional: FinalModel {

    var _buffer: Buffer
    var _offset: Int

    // Base field model value
    let value: FinalModelStructOptional
    ...
    required init() {
        ...
        value = FinalModelStructOptional(buffer: buffer, offset: offset)
    }
    ...
    func fbeAllocationSize(value optional: StructOptional?) -> Int {
    ...
    public func set(value optional: StructOptional?) throws -> Int {
        if _buffer.offset + fbeOffset + 1 > _buffer.size {
            assertionFailure("Model is broken!")
            return 0
        }
