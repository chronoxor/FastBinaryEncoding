...
class FieldModelMapStringEnumSimple: FieldModel {
    ...
    public func getItem(index: Int) -> (ChronoxorFbe.FieldModelString, FieldModelEnumSimple) {
    ...
    func resize(size: Int) throws -> (ChronoxorFbe.FieldModelString, FieldModelEnumSimple) {
