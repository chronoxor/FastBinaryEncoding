...
class FieldModelMapInt32OptionalFlagsSimple: FieldModel {
    ...
    public func getItem(index: Int) -> (ChronoxorFbe.FieldModelInt32, FieldModelOptionalFlagsSimple) {
    ...
    func resize(size: Int) throws -> (ChronoxorFbe.FieldModelInt32, FieldModelOptionalFlagsSimple) {
    ...
    public func get(values: inout Dictionary<Int32, ChronoxorTest.FlagsSimple?>) {
        values.removeAll()
    ...
    public func set(value values: Dictionary<Int32, ChronoxorTest.FlagsSimple?>) throws {
        if _buffer.offset + fbeOffset + fbeSize > _buffer.size {
