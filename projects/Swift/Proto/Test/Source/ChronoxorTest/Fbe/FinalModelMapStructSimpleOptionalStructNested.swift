...
class FinalModelMapStructSimpleOptionalStructNested: FinalModel {
    ...
    func fbeAllocationSize(value values: Dictionary<ChronoxorTest.StructSimple, ChronoxorTest.StructNested?>) -> Int {
        var size: Int = 4
    ...
    public func get(values: inout Dictionary<ChronoxorTest.StructSimple, ChronoxorTest.StructNested?>) -> Int {
        values.removeAll()
    ...
    public func set(value values: Dictionary<ChronoxorTest.StructSimple, ChronoxorTest.StructNested?>) throws -> Int {
        if _buffer.offset + fbeOffset + 4 > _buffer.size {
            assertionFailure("Model is broken!")
            return 0
        }
