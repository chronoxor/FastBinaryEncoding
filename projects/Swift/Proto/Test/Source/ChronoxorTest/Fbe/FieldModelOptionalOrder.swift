...
public class FieldModelOptionalOrder: FieldModel {
    ...
    public let value: ChronoxorProto.FieldModelOrder
    ...
    public required init() {
        ...
        value = ChronoxorProto.FieldModelOrder(buffer: buffer, offset: 0)
    }
    ...
    public func get(defaults: ChronoxorProto.Order? = nil) -> ChronoxorProto.Order? {
    ...
    // Set the optional value (end phase)
      ...
      public func set(value optional: ChronoxorProto.Order?) throws {
