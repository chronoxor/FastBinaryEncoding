...
public class FieldModelOptionalAccount: FieldModel {
    ...
    public let value: ChronoxorProto.FieldModelAccount
    ...
    public required init() {
        ...
        value = ChronoxorProto.FieldModelAccount(buffer: buffer, offset: 0)
    }
    ...
    public func get(defaults: ChronoxorProto.Account? = nil) -> ChronoxorProto.Account? {
    ...
    // Set the optional value (end phase)
      ...
      public func set(value optional: ChronoxorProto.Account?) throws {
