...
// Fast Binary Encoding OptionalUInt8 vector final model
class FinalModelVectorOptionalUInt8: FinalModel {
    var _buffer: Buffer = Buffer()
    var _offset: Int = 0

    private var _model: FinalModelOptionalUInt8

    init(buffer: Buffer, offset: Int) {
        _buffer = buffer
        _offset = offset

        _model = FinalModelOptionalUInt8(buffer: buffer, offset: offset)
    }
