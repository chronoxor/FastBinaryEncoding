...
public class StructNestedFinalModel: Model {
    private let _model: FinalModelStructNested

    public override init(buffer: Buffer = Buffer()) {
        _model = FinalModelStructNested(buffer: buffer, offset: 8)
    ...
    static let fbeTypeConst: Int = FinalModelStructNested.fbeTypeConst
