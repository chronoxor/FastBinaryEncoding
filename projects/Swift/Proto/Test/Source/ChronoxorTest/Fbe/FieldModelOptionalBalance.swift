...
public class FieldModelOptionalBalance: FieldModel {
    ...
    public let value: ChronoxorProto.FieldModelBalance
    ...
    public required init() {
        ...
        value = ChronoxorProto.FieldModelBalance(buffer: buffer, offset: 0)
    }
    ...
    public func get(defaults: ChronoxorProto.Balance? = nil) -> ChronoxorProto.Balance? {
    ...
    // Set the optional value (end phase)
      ...
      public func set(value optional: ChronoxorProto.Balance?) throws {
