...
public class StructBytesFinalModel: Model {
    private let _model: FinalModelStructBytes

    public override init(buffer: Buffer = Buffer()) {
        _model = FinalModelStructBytes(buffer: buffer, offset: 8)
    ...
    static let fbeTypeConst: Int = FinalModelStructBytes.fbeTypeConst
