...
class FieldModelMapInt32FlagsSimple: FieldModel {
    ...
    public func getItem(index: Int) -> (ChronoxorFbe.FieldModelInt32, FieldModelFlagsSimple) {
    ...
    func resize(size: Int) throws -> (ChronoxorFbe.FieldModelInt32, FieldModelFlagsSimple) {
