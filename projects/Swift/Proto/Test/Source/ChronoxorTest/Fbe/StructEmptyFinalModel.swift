...
public class StructEmptyFinalModel: Model {
    private let _model: FinalModelStructEmpty

    public override init(buffer: Buffer = Buffer()) {
        _model = FinalModelStructEmpty(buffer: buffer, offset: 8)
    ...
    static let fbeTypeConst: Int = FinalModelStructEmpty.fbeTypeConst
    ...
    public func serialize(value: StructEmpty) throws -> Int {
