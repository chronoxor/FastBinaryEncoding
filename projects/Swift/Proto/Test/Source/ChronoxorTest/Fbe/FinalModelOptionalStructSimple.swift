...
class FinalModelOptionalStructSimple: FinalModel {

    var _buffer: Buffer
    var _offset: Int

    // Base field model value
    let value: FinalModelStructSimple
    ...
    required init() {
        ...
        value = FinalModelStructSimple(buffer: buffer, offset: offset)
    }
    ...
    func fbeAllocationSize(value optional: StructSimple?) -> Int {
    ...
    public func set(value optional: StructSimple?) throws -> Int {
        if _buffer.offset + fbeOffset + 1 > _buffer.size {
            assertionFailure("Model is broken!")
            return 0
        }
