...
class FieldModelMapStructSimpleOptionalStructNested: FieldModel {
    ...
    public func get(values: inout Dictionary<ChronoxorTest.StructSimple, ChronoxorTest.StructNested?>) {
        values.removeAll()
    ...
    public func set(value values: Dictionary<ChronoxorTest.StructSimple, ChronoxorTest.StructNested?>) throws {
        if _buffer.offset + fbeOffset + fbeSize > _buffer.size {
