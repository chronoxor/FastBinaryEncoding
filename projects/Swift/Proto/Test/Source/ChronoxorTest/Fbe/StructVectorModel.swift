...
public class StructVectorModel: Model {
    public let model: FieldModelStructVector

    public override init(buffer: Buffer = Buffer()) {
        model = FieldModelStructVector(buffer: buffer, offset: 4)
    ...
    static let fbeTypeConst: Int = FieldModelStructVector.fbeTypeConst
