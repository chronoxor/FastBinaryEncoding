...
// Fast Binary Encoding OptionalUInt8 vector field model
class FieldModelVectorOptionalUInt8: FieldModel {
    private let _model: FieldModelOptionalUInt8
    ...
    required init() {
        ...
        _model = FieldModelOptionalUInt8(buffer: buffer, offset: offset)
    }
    ...
    public func getItem(index: Int) -> FieldModelOptionalUInt8 {
    ...
    func resize(size: Int) throws -> FieldModelOptionalUInt8 {
