...
class FinalModelVectorOptionalFlagsSimple: FinalModel {
    ...
    func fbeAllocationSize(value values: Array<ChronoxorTest.FlagsSimple?>) -> Int {
        var size: Int = 4
    ...
    public func get(values: inout Array<ChronoxorTest.FlagsSimple?>) -> Int {
        values.removeAll()
    ...
    public func set(value values: Array<ChronoxorTest.FlagsSimple?>) throws -> Int {
        if _buffer.offset + fbeOffset + 4 > _buffer.size {
            assertionFailure("Model is broken!")
            return 0
        }
