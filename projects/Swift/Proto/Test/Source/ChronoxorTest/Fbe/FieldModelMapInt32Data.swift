...
class FieldModelMapInt32Data: FieldModel {
    ...
    public func getItem(index: Int) -> (ChronoxorFbe.FieldModelInt32, ChronoxorFbe.FieldModelData) {
    ...
    func resize(size: Int) throws -> (ChronoxorFbe.FieldModelInt32, ChronoxorFbe.FieldModelData) {
