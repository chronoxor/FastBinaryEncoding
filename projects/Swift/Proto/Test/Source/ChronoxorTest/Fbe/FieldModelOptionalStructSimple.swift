...
public class FieldModelOptionalStructSimple: FieldModel {
    ...
    public let value: FieldModelStructSimple
    ...
    public required init() {
        ...
        value = FieldModelStructSimple(buffer: buffer, offset: 0)
    }
    ...
    public func get(defaults: StructSimple? = nil) -> StructSimple? {
    ...
    // Set the optional value (end phase)
      ...
      public func set(value optional: StructSimple?) throws {
