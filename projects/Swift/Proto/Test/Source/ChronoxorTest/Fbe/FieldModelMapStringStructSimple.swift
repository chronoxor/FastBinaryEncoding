...
class FieldModelMapStringStructSimple: FieldModel {
    ...
    public func getItem(index: Int) -> (ChronoxorFbe.FieldModelString, FieldModelStructSimple) {
    ...
    func resize(size: Int) throws -> (ChronoxorFbe.FieldModelString, FieldModelStructSimple) {
    ...
    public func get(values: inout Dictionary<String, ChronoxorTest.StructSimple>) {
        values.removeAll()
    ...
    public func set(value values: Dictionary<String, ChronoxorTest.StructSimple>) throws {
        if _buffer.offset + fbeOffset + fbeSize > _buffer.size {
