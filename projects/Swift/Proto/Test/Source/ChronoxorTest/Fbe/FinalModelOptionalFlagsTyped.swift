...
class FinalModelOptionalFlagsTyped: FinalModel {

    var _buffer: Buffer
    var _offset: Int

    // Base field model value
    let value: FinalModelFlagsTyped
    ...
    required init() {
        ...
        value = FinalModelFlagsTyped(buffer: buffer, offset: offset)
    }
    ...
    func fbeAllocationSize(value optional: FlagsTyped?) -> Int {
    ...
    public func set(value optional: FlagsTyped?) throws -> Int {
        if _buffer.offset + fbeOffset + 1 > _buffer.size {
            assertionFailure("Model is broken!")
            return 0
        }
