...
public class FieldModelOptionalEnumTyped: FieldModel {
    ...
    public let value: FieldModelEnumTyped
    ...
    public required init() {
        ...
        value = FieldModelEnumTyped(buffer: buffer, offset: 0)
    }
    ...
    public func get(defaults: EnumTyped? = nil) -> EnumTyped? {
    ...
    // Set the optional value (end phase)
      ...
      public func set(value optional: EnumTyped?) throws {
