...
public class StructArrayFinalModel: Model {
    private let _model: FinalModelStructArray

    public override init(buffer: Buffer = Buffer()) {
        _model = FinalModelStructArray(buffer: buffer, offset: 8)
    ...
    static let fbeTypeConst: Int = FinalModelStructArray.fbeTypeConst
