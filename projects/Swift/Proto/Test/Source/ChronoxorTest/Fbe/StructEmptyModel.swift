...
public class StructEmptyModel: Model {
    public let model: FieldModelStructEmpty

    public override init(buffer: Buffer = Buffer()) {
        model = FieldModelStructEmpty(buffer: buffer, offset: 4)
    ...
    static let fbeTypeConst: Int = FieldModelStructEmpty.fbeTypeConst
