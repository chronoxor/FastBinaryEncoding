...
class FieldModelMapStringData: FieldModel {
    ...
    private let _modelValue: ChronoxorFbe.FieldModelData
    ...
    required init() {
        ...
        _modelValue = ChronoxorFbe.FieldModelData(buffer: buffer, offset: offset)
    }
    ...
    public func getItem(index: Int) -> (ChronoxorFbe.FieldModelString, ChronoxorFbe.FieldModelData) {
    ...
    func resize(size: Int) throws -> (ChronoxorFbe.FieldModelString, ChronoxorFbe.FieldModelData) {
