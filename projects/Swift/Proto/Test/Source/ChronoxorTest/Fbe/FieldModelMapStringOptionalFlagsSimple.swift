...
class FieldModelMapStringOptionalFlagsSimple: FieldModel {
    private let _modelKey: ChronoxorFbe.FieldModelString
    ...
    required init() {
        ...
        _modelKey = ChronoxorFbe.FieldModelString(buffer: buffer, offset: offset)
    ...
    public func getItem(index: Int) -> (ChronoxorFbe.FieldModelString, FieldModelOptionalFlagsSimple) {
    ...
    func resize(size: Int) throws -> (ChronoxorFbe.FieldModelString, FieldModelOptionalFlagsSimple) {
    ...
    public func get(values: inout Dictionary<String, ChronoxorTest.FlagsSimple?>) {
        values.removeAll()
    ...
    public func set(value values: Dictionary<String, ChronoxorTest.FlagsSimple?>) throws {
        if _buffer.offset + fbeOffset + fbeSize > _buffer.size {
