...
public class FieldModelOptionalEnumSimple: FieldModel {
    ...
    public let value: FieldModelEnumSimple
    ...
    public required init() {
        ...
        value = FieldModelEnumSimple(buffer: buffer, offset: 0)
    }
    ...
    public func get(defaults: EnumSimple? = nil) -> EnumSimple? {
    ...
    // Set the optional value (end phase)
      ...
      public func set(value optional: EnumSimple?) throws {
