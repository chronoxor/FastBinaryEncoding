...
public class FinalModelStructList: FinalModel {
    ...
    public func fbeAllocationSize(value fbeValue: StructList) -> Int {
        return 0
    ...
    public func get(size: inout Size) -> StructList {
        var fbeValue = StructList()
        return get(size: &size, fbeValue: &fbeValue)
    }

    // Get the struct value
    public func get(size: inout Size, fbeValue: inout StructList) -> StructList {
        _buffer.shift(offset: fbeOffset)
    ...
    public func getFields(fbeValue: inout StructList) -> Int {
        var fbeCurrentOffset: Int = 0
    ...
    public func set(value fbeValue: StructList) throws -> Int {
        _buffer.shift(offset: fbeOffset)
    ...
    public func setFields(fbeValue: StructList) throws -> Int {
        var fbeCurrentOffset: Int = 0
        var fbeCurrentSize: Int = 0
