...
public class FieldModelOptionalStructNested: FieldModel {
    ...
    public let value: FieldModelStructNested
    ...
    public required init() {
        ...
        value = FieldModelStructNested(buffer: buffer, offset: 0)
    }
    ...
    public func get(defaults: StructNested? = nil) -> StructNested? {
    ...
    // Set the optional value (end phase)
      ...
      public func set(value optional: StructNested?) throws {
