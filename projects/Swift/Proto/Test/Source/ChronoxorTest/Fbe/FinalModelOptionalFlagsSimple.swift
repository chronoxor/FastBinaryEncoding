...
class FinalModelOptionalFlagsSimple: FinalModel {

    var _buffer: Buffer
    var _offset: Int

    // Base field model value
    let value: FinalModelFlagsSimple
    ...
    required init() {
        ...
        value = FinalModelFlagsSimple(buffer: buffer, offset: offset)
    }
    ...
    func fbeAllocationSize(value optional: FlagsSimple?) -> Int {
    ...
    public func set(value optional: FlagsSimple?) throws -> Int {
        if _buffer.offset + fbeOffset + 1 > _buffer.size {
            assertionFailure("Model is broken!")
            return 0
        }
