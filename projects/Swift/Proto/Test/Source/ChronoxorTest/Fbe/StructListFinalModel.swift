...
public class StructListFinalModel: Model {
    private let _model: FinalModelStructList

    public override init(buffer: Buffer = Buffer()) {
        _model = FinalModelStructList(buffer: buffer, offset: 8)
    ...
    static let fbeTypeConst: Int = FinalModelStructList.fbeTypeConst
