...
class FinalModelOptionalEnumSimple: FinalModel {

    var _buffer: Buffer
    var _offset: Int

    // Base field model value
    let value: FinalModelEnumSimple
    ...
    required init() {
        ...
        value = FinalModelEnumSimple(buffer: buffer, offset: offset)
    }
    ...
    func fbeAllocationSize(value optional: EnumSimple?) -> Int {
    ...
    public func set(value optional: EnumSimple?) throws -> Int {
        if _buffer.offset + fbeOffset + 1 > _buffer.size {
            assertionFailure("Model is broken!")
            return 0
        }
