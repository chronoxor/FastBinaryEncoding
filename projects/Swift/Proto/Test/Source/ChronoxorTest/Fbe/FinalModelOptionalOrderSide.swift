...
class FinalModelOptionalOrderSide: FinalModel {
    ...
    let value: ChronoxorProto.FinalModelOrderSide
    ...
    required init() {
        ...
        value = ChronoxorProto.FinalModelOrderSide(buffer: buffer, offset: offset)
    }
    ...
    func fbeAllocationSize(value optional: ChronoxorProto.OrderSide?) -> Int {
    ...
    public func get(size: inout Size) -> ChronoxorProto.OrderSide? {
        if _buffer.offset + fbeOffset + 1 > _buffer.size {
    ...
    public func set(value optional: ChronoxorProto.OrderSide?) throws -> Int {
        if _buffer.offset + fbeOffset + 1 > _buffer.size {
            assertionFailure("Model is broken!")
            return 0
        }
