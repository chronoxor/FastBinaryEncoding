...
class FieldModelMapInt32StructSimple: FieldModel {
    ...
    public func getItem(index: Int) -> (ChronoxorFbe.FieldModelInt32, FieldModelStructSimple) {
    ...
    func resize(size: Int) throws -> (ChronoxorFbe.FieldModelInt32, FieldModelStructSimple) {
