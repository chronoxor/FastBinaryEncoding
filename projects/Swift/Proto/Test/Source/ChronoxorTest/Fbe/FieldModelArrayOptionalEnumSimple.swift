...
class FieldModelArrayOptionalEnumSimple: FieldModel {
    ...
    public func get() -> Array<ChronoxorTest.EnumSimple?> {
        var values = Array<ChronoxorTest.EnumSimple?>()
    ...
    public func get(values: inout Array<ChronoxorTest.EnumSimple?>) {
        values.removeAll()
    ...
    public func set(value values: Array<ChronoxorTest.EnumSimple?>) throws {
        if _buffer.offset + fbeOffset + fbeSize > _buffer.size {
