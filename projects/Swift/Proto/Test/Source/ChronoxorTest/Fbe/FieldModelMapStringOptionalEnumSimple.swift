...
class FieldModelMapStringOptionalEnumSimple: FieldModel {
    ...
    public func getItem(index: Int) -> (ChronoxorFbe.FieldModelString, FieldModelOptionalEnumSimple) {
    ...
    func resize(size: Int) throws -> (ChronoxorFbe.FieldModelString, FieldModelOptionalEnumSimple) {
    ...
    public func get(values: inout Dictionary<String, ChronoxorTest.EnumSimple?>) {
        values.removeAll()
    ...
    public func set(value values: Dictionary<String, ChronoxorTest.EnumSimple?>) throws {
        if _buffer.offset + fbeOffset + fbeSize > _buffer.size {
