...
class FinalModelVectorOptionalEnumSimple: FinalModel {
    ...
    func fbeAllocationSize(value values: Array<ChronoxorTest.EnumSimple?>) -> Int {
        var size: Int = 4
    ...
    public func get(values: inout Array<ChronoxorTest.EnumSimple?>) -> Int {
        values.removeAll()
    ...
    public func set(value values: Array<ChronoxorTest.EnumSimple?>) throws -> Int {
        if _buffer.offset + fbeOffset + 4 > _buffer.size {
            assertionFailure("Model is broken!")
            return 0
        }
