...
public class FieldModelStructEmpty: FieldModel {
    ...
    public func get() -> StructEmpty {
        var fbeValue = StructEmpty()
        return get(fbeValue: &fbeValue)
    }

    public func get(fbeValue: inout StructEmpty) -> StructEmpty {
    ...
    public func getFields(fbeValue: inout StructEmpty, fbeStructSize: Int) {
    }
    ...
    public func set(value fbeValue: StructEmpty) throws {
    ...
    public func setFields(fbeValue: StructEmpty) throws {
    }
}
