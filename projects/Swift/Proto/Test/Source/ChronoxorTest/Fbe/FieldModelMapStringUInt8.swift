...
class FieldModelMapStringUInt8: FieldModel {
    ...
    private let _modelValue: ChronoxorFbe.FieldModelUInt8
    ...
    required init() {
        ...
        _modelValue = ChronoxorFbe.FieldModelUInt8(buffer: buffer, offset: offset)
    }
    ...
    public func getItem(index: Int) -> (ChronoxorFbe.FieldModelString, ChronoxorFbe.FieldModelUInt8) {
    ...
    func resize(size: Int) throws -> (ChronoxorFbe.FieldModelString, ChronoxorFbe.FieldModelUInt8) {
