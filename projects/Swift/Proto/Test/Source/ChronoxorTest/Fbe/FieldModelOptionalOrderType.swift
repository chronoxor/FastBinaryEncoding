...
public class FieldModelOptionalOrderType: FieldModel {
    ...
    public let value: ChronoxorProto.FieldModelOrderType
    ...
    public required init() {
        ...
        value = ChronoxorProto.FieldModelOrderType(buffer: buffer, offset: 0)
    }
    ...
    public func get(defaults: ChronoxorProto.OrderType? = nil) -> ChronoxorProto.OrderType? {
    ...
    // Set the optional value (end phase)
      ...
      public func set(value optional: ChronoxorProto.OrderType?) throws {
