...
class FinalModelMapInt32OptionalFlagsSimple: FinalModel {
    ...
    func fbeAllocationSize(value values: Dictionary<Int32, ChronoxorTest.FlagsSimple?>) -> Int {
        var size: Int = 4
    ...
    public func get(values: inout Dictionary<Int32, ChronoxorTest.FlagsSimple?>) -> Int {
        values.removeAll()
    ...
    public func set(value values: Dictionary<Int32, ChronoxorTest.FlagsSimple?>) throws -> Int {
        if _buffer.offset + fbeOffset + 4 > _buffer.size {
            assertionFailure("Model is broken!")
            return 0
        }
