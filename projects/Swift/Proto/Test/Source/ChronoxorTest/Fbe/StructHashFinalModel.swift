...
public class StructHashFinalModel: Model {
    private let _model: FinalModelStructHash

    public override init(buffer: Buffer = Buffer()) {
        _model = FinalModelStructHash(buffer: buffer, offset: 8)
    ...
    static let fbeTypeConst: Int = FinalModelStructHash.fbeTypeConst
