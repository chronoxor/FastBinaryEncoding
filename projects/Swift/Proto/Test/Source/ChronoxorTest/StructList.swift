...
public protocol StructListBase {
...
public protocol StructListInheritance {
    var parent: StructList { get set }
}

extension StructListInheritance {
...
public struct StructList: StructListBase, Comparable, Hashable, Codable {
