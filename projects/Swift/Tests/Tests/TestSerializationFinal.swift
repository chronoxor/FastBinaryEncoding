...
class TestSerializationFinal: XCTestCase {
    ...
    func testSerializationStructOptional() {
        ...
        XCTAssertEqual(struct2.parent.f1, false)
        XCTAssertEqual(struct2.parent.f2, true)
        XCTAssertEqual(struct2.parent.f3, 0)
        XCTAssertEqual(struct2.parent.f4, 0xFF)
        XCTAssertEqual(struct2.parent.f5, "\0")
        XCTAssertEqual(struct2.parent.f6, "!")
        XCTAssertEqual(struct2.parent.f7, Character(UnicodeScalar(0)!))
        XCTAssertEqual(struct2.parent.f8, Character(UnicodeScalar(0x0444)!))
        XCTAssertEqual(struct2.parent.f9, 0)
        XCTAssertEqual(struct2.parent.f10, 127)
        XCTAssertEqual(struct2.parent.f11, 0)
        XCTAssertEqual(struct2.parent.f12, 0xFF)
        XCTAssertEqual(struct2.parent.f13, 0)
        XCTAssertEqual(struct2.parent.f14, 32767)
        XCTAssertEqual(struct2.parent.f15, 0)
        XCTAssertEqual(struct2.parent.f16, 0xFFFF)
        XCTAssertEqual(struct2.parent.f17, 0)
        XCTAssertEqual(struct2.parent.f18, 2147483647)
        XCTAssertEqual(struct2.parent.f19, 0)
        XCTAssertEqual(struct2.parent.f20, 0xFFFFFFFF)
        XCTAssertEqual(struct2.parent.f21, 0)
        XCTAssertEqual(struct2.parent.f22, 9223372036854775807)
        XCTAssertEqual(struct2.parent.f23, 0)
        XCTAssertEqual(struct2.parent.f24, 0xFFFFFFFFFFFFFFFF)
        XCTAssertEqual(struct2.parent.f25, 0.0)
        XCTAssertTrue(abs(struct2.parent.f26 - 123.456) < 0.0001)
        XCTAssertEqual(struct2.parent.f27, 0.0)
        XCTAssertTrue(abs(struct2.parent.f28 - -123.567e+123) < 1e+123)
        XCTAssertEqual(struct2.parent.f29, Decimal(0))
        XCTAssertEqual(struct2.parent.f30, Decimal(string: "123456.123456") ?? .nan)
        XCTAssertEqual(struct2.parent.f31, "")
        XCTAssertEqual(struct2.parent.f32, "Initial string!")
        XCTAssertTrue(struct2.parent.f33 == Date(timeIntervalSince1970: 0))
        XCTAssertTrue(struct2.parent.f34 == Date(timeIntervalSince1970: 0))
        XCTAssertTrue(struct2.parent.f35 > Date(timeIntervalSince1970: 1514764800)) // 01/01/2018
        XCTAssertTrue(struct2.parent.f36 == UUID(uuidString: "00000000-0000-0000-0000-000000000000"))
        XCTAssertTrue(struct2.parent.f37 != UUID(uuidString: "00000000-0000-0000-0000-000000000000"))
        XCTAssertTrue(struct2.parent.f38 == UUID(uuidString: "123e4567-e89b-12d3-a456-426655440000"))
        ...
        XCTAssertEqual(struct2.parent.f1, struct1.parent.f1)
        XCTAssertEqual(struct2.parent.f2, struct1.parent.f2)
        XCTAssertEqual(struct2.parent.f3, struct1.parent.f3)
        XCTAssertEqual(struct2.parent.f4, struct1.parent.f4)
        XCTAssertEqual(struct2.parent.f5, struct1.parent.f5)
        XCTAssertEqual(struct2.parent.f6, struct1.parent.f6)
        XCTAssertEqual(struct2.parent.f7, struct1.parent.f7)
        XCTAssertEqual(struct2.parent.f8, struct1.parent.f8)
        XCTAssertEqual(struct2.parent.f9, struct1.parent.f9)
        XCTAssertEqual(struct2.parent.f10, struct1.parent.f10)
        XCTAssertEqual(struct2.parent.f11, struct1.parent.f11)
        XCTAssertEqual(struct2.parent.f12, struct1.parent.f12)
        XCTAssertEqual(struct2.parent.f13, struct1.parent.f13)
        XCTAssertEqual(struct2.parent.f14, struct1.parent.f14)
        XCTAssertEqual(struct2.parent.f15, struct1.parent.f15)
        XCTAssertEqual(struct2.parent.f16, struct1.parent.f16)
        XCTAssertEqual(struct2.parent.f17, struct1.parent.f17)
        XCTAssertEqual(struct2.parent.f18, struct1.parent.f18)
        XCTAssertEqual(struct2.parent.f19, struct1.parent.f19)
        XCTAssertEqual(struct2.parent.f20, struct1.parent.f20)
        XCTAssertEqual(struct2.parent.f21, struct1.parent.f21)
        XCTAssertEqual(struct2.parent.f22, struct1.parent.f22)
        XCTAssertEqual(struct2.parent.f23, struct1.parent.f23)
        XCTAssertEqual(struct2.parent.f24, struct1.parent.f24)
        XCTAssertEqual(struct2.parent.f25, struct1.parent.f25)
        XCTAssertEqual(struct2.parent.f26, struct1.parent.f26)
        XCTAssertEqual(struct2.parent.f27, struct1.parent.f27)
        XCTAssertEqual(struct2.parent.f28, struct1.parent.f28)
        XCTAssertEqual(struct2.parent.f29, struct1.parent.f29)
        XCTAssertEqual(struct2.parent.f30, struct1.parent.f30)
        XCTAssertEqual(struct2.parent.f31, struct1.parent.f31)
        XCTAssertEqual(struct2.parent.f32, struct1.parent.f32)
        XCTAssertEqual(struct2.parent.f33, struct1.parent.f33)
        XCTAssertEqual(struct2.parent.f34, struct1.parent.f34)
        XCTAssertEqual(floor(struct2.parent.f35.timeIntervalSince1970 * 1000), floor(struct1.parent.f35.timeIntervalSince1970 * 1000))
        XCTAssertEqual(struct2.parent.f36, struct1.parent.f36)
        XCTAssertEqual(struct2.parent.f37, struct1.parent.f37)
        XCTAssertEqual(struct2.parent.f38, struct1.parent.f38)
        XCTAssertEqual(struct2.parent.f39, struct1.parent.f39)
        XCTAssertEqual(struct2.parent.f40, struct1.parent.f40)
    ...
    func testSerializationStructNested() {
        ...
        XCTAssertEqual(struct2.parent.parent.f1, false)
        XCTAssertEqual(struct2.parent.parent.f2, true)
        XCTAssertEqual(struct2.parent.parent.f3, 0)
        XCTAssertEqual(struct2.parent.parent.f4, 0xFF)
        XCTAssertEqual(struct2.parent.parent.f5, "\0")
        XCTAssertEqual(struct2.parent.parent.f6, "!")
        XCTAssertEqual(struct2.parent.parent.f7, Character(UnicodeScalar(0)!))
        XCTAssertEqual(struct2.parent.parent.f8, Character(UnicodeScalar(0x0444)!))
        XCTAssertEqual(struct2.parent.parent.f9, 0)
        XCTAssertEqual(struct2.parent.parent.f10, 127)
        XCTAssertEqual(struct2.parent.parent.f11, 0)
        XCTAssertEqual(struct2.parent.parent.f12, 0xFF)
        XCTAssertEqual(struct2.parent.parent.f13, 0)
        XCTAssertEqual(struct2.parent.parent.f14, 32767)
        XCTAssertEqual(struct2.parent.parent.f15, 0)
        XCTAssertEqual(struct2.parent.parent.f16, 0xFFFF)
        XCTAssertEqual(struct2.parent.parent.f17, 0)
        XCTAssertEqual(struct2.parent.parent.f18, 2147483647)
        XCTAssertEqual(struct2.parent.parent.f19, 0)
        XCTAssertEqual(struct2.parent.parent.f20, 0xFFFFFFFF)
        XCTAssertEqual(struct2.parent.parent.f21, 0)
        XCTAssertEqual(struct2.parent.parent.f22, 9223372036854775807)
        XCTAssertEqual(struct2.parent.parent.f23, 0)
        XCTAssertEqual(struct2.parent.parent.f24, 0xFFFFFFFFFFFFFFFF)
        XCTAssertEqual(struct2.parent.parent.f25, 0.0)
        XCTAssertTrue(abs(struct2.parent.parent.f26 - 123.456) < 0.0001)
        XCTAssertEqual(struct2.parent.parent.f27, 0.0)
        XCTAssertTrue(abs(struct2.parent.parent.f28 - -123.567e+123) < 1e+123)
        XCTAssertEqual(struct2.parent.parent.f29, Decimal(0))
        XCTAssertEqual(struct2.parent.parent.f30, Decimal(string: "123456.123456") ?? .nan)
        XCTAssertEqual(struct2.parent.parent.f31, "")
        XCTAssertEqual(struct2.parent.parent.f32, "Initial string!")
        XCTAssertTrue(struct2.parent.parent.f33 == Date(timeIntervalSince1970: 0))
        XCTAssertTrue(struct2.parent.parent.f34 == Date(timeIntervalSince1970: 0))
        XCTAssertTrue(struct2.parent.parent.f35 > Date(timeIntervalSince1970: 1514764800)) // 01/01/2018
        XCTAssertTrue(struct2.parent.parent.f36 == UUID(uuidString: "00000000-0000-0000-0000-000000000000"))
        XCTAssertTrue(struct2.parent.parent.f37 != UUID(uuidString: "123e4567-e89b-12d3-a456-426655440000"))
        XCTAssertTrue(struct2.parent.parent.f38 == UUID(uuidString: "123e4567-e89b-12d3-a456-426655440000"))

        XCTAssertEqual(struct2.parent.f100, nil)
        XCTAssertNotEqual(struct2.parent.f101, nil)
        XCTAssertEqual(struct2.parent.f101!, true)
        XCTAssertEqual(struct2.parent.f102, nil)
        XCTAssertEqual(struct2.parent.f103, nil)
        XCTAssertNotEqual(struct2.parent.f104, nil)
        XCTAssertEqual(struct2.parent.f104!, 0xFF)
        XCTAssertEqual(struct2.parent.f105, nil)
        XCTAssertEqual(struct2.parent.f106, nil)
        XCTAssertNotEqual(struct2.parent.f107, nil)
        XCTAssertEqual(struct2.parent.f107!, "!")
        XCTAssertEqual(struct2.parent.f108, nil)
        XCTAssertEqual(struct2.parent.f109, nil)
        XCTAssertNotEqual(struct2.parent.f110, nil)
        XCTAssertEqual(struct2.parent.f111, nil)
        XCTAssertEqual(struct2.parent.f112, nil)
        XCTAssertNotEqual(struct2.parent.f113, nil)
        XCTAssertEqual(struct2.parent.f113!, 127)
        XCTAssertEqual(struct2.parent.f114, nil)
        XCTAssertEqual(struct2.parent.f115, nil)
        XCTAssertNotEqual(struct2.parent.f116, nil)
        XCTAssertEqual(struct2.parent.f116!, 0xFF)
        XCTAssertEqual(struct2.parent.f117, nil)
        XCTAssertEqual(struct2.parent.f118, nil)
        XCTAssertNotEqual(struct2.parent.f119, nil)
        XCTAssertEqual(struct2.parent.f119!, 32767)
        XCTAssertEqual(struct2.parent.f120, nil)
        XCTAssertEqual(struct2.parent.f121, nil)
        XCTAssertNotEqual(struct2.parent.f122, nil)
        XCTAssertEqual(struct2.parent.f122!, 0xFFFF)
        XCTAssertEqual(struct2.parent.f123, nil)
        XCTAssertEqual(struct2.parent.f124, nil)
        XCTAssertNotEqual(struct2.parent.f125, nil)
        XCTAssertEqual(struct2.parent.f125!, 2147483647)
        XCTAssertEqual(struct2.parent.f126, nil)
        XCTAssertEqual(struct2.parent.f127, nil)
        XCTAssertNotEqual(struct2.parent.f128, nil)
        XCTAssertEqual(struct2.parent.f128!, 0xFFFFFFFF)
        XCTAssertEqual(struct2.parent.f129, nil)
        XCTAssertEqual(struct2.parent.f130, nil)
        XCTAssertNotEqual(struct2.parent.f131, nil)
        XCTAssertEqual(struct2.parent.f131!, 9223372036854775807)
        XCTAssertEqual(struct2.parent.f132, nil)
        XCTAssertEqual(struct2.parent.f133, nil)
        XCTAssertNotEqual(struct2.parent.f131, nil)
        XCTAssertEqual(struct2.parent.f134!, 0xFFFFFFFFFFFFFFFF)
        XCTAssertEqual(struct2.parent.f135, nil)
        XCTAssertEqual(struct2.parent.f136, nil)
        XCTAssertNotEqual(struct2.parent.f137, nil)
        XCTAssertTrue(abs(struct2.parent.f137! - 123.456) < 0.0001)
        XCTAssertEqual(struct2.parent.f138, nil)
        XCTAssertEqual(struct2.parent.f139, nil)
        XCTAssertNotEqual(struct2.parent.f140, nil)
        XCTAssertTrue(abs(struct2.parent.f140! - -123.567e+123) < 1e+123)
        XCTAssertEqual(struct2.parent.f141, nil)
        XCTAssertEqual(struct2.parent.f142, nil)
        XCTAssertNotEqual(struct2.parent.f143, nil)
        XCTAssertEqual(struct2.parent.f143, Decimal(string: "123456.123456") ?? .nan)
        XCTAssertEqual(struct2.parent.f144, nil)
        XCTAssertEqual(struct2.parent.f145, nil)
        XCTAssertNotEqual(struct2.parent.f146, nil)
        XCTAssertEqual(struct2.parent.f146, "Initial string!")
        XCTAssertEqual(struct2.parent.f147, nil)
        XCTAssertEqual(struct2.parent.f148, nil)
        XCTAssertNotEqual(struct2.parent.f149, nil)
        XCTAssertTrue(struct2.parent.f149! > Date(timeIntervalSince1970: 1514764800))//GregorianCalendar(2018, 1, 1).toInstant().epochSecond)
        XCTAssertEqual(struct2.parent.f150, nil)
        XCTAssertEqual(struct2.parent.f151, nil)
        XCTAssertNotEqual(struct2.parent.f152, nil)
        XCTAssertTrue(struct2.parent.f152! == UUID(uuidString: "123e4567-e89b-12d3-a456-426655440000"))
        XCTAssertEqual(struct2.parent.f153, nil)
        XCTAssertEqual(struct2.parent.f154, nil)
        XCTAssertEqual(struct2.parent.f155, nil)
        XCTAssertEqual(struct2.parent.f156, nil)
        XCTAssertEqual(struct2.parent.f157, nil)
        XCTAssertEqual(struct2.parent.f158, nil)
        XCTAssertEqual(struct2.parent.f159, nil)
        XCTAssertEqual(struct2.parent.f160, nil)
        XCTAssertEqual(struct2.parent.f161, nil)
        XCTAssertEqual(struct2.parent.f162, nil)
        XCTAssertEqual(struct2.parent.f163, nil)
        XCTAssertEqual(struct2.parent.f164, nil)
        XCTAssertEqual(struct2.parent.f165, nil)
        ...
        XCTAssertEqual(struct2.parent.parent.f1, struct1.parent.parent.f1)
        XCTAssertEqual(struct2.parent.parent.f2, struct1.parent.parent.f2)
        XCTAssertEqual(struct2.parent.parent.f3, struct1.parent.parent.f3)
        XCTAssertEqual(struct2.parent.parent.f4, struct1.parent.parent.f4)
        XCTAssertEqual(struct2.parent.parent.f5, struct1.parent.parent.f5)
        XCTAssertEqual(struct2.parent.parent.f6, struct1.parent.parent.f6)
        XCTAssertEqual(struct2.parent.parent.f7, struct1.parent.parent.f7)
        XCTAssertEqual(struct2.parent.parent.f8, struct1.parent.parent.f8)
        XCTAssertEqual(struct2.parent.parent.f9, struct1.parent.parent.f9)
        XCTAssertEqual(struct2.parent.parent.f10, struct1.parent.parent.f10)
        XCTAssertEqual(struct2.parent.parent.f11, struct1.parent.parent.f11)
        XCTAssertEqual(struct2.parent.parent.f12, struct1.parent.parent.f12)
        XCTAssertEqual(struct2.parent.parent.f13, struct1.parent.parent.f13)
        XCTAssertEqual(struct2.parent.parent.f14, struct1.parent.parent.f14)
        XCTAssertEqual(struct2.parent.parent.f15, struct1.parent.parent.f15)
        XCTAssertEqual(struct2.parent.parent.f16, struct1.parent.parent.f16)
        XCTAssertEqual(struct2.parent.parent.f17, struct1.parent.parent.f17)
        XCTAssertEqual(struct2.parent.parent.f18, struct1.parent.parent.f18)
        XCTAssertEqual(struct2.parent.parent.f19, struct1.parent.parent.f19)
        XCTAssertEqual(struct2.parent.parent.f20, struct1.parent.parent.f20)
        XCTAssertEqual(struct2.parent.parent.f21, struct1.parent.parent.f21)
        XCTAssertEqual(struct2.parent.parent.f22, struct1.parent.parent.f22)
        XCTAssertEqual(struct2.parent.parent.f23, struct1.parent.parent.f23)
        XCTAssertEqual(struct2.parent.parent.f24, struct1.parent.parent.f24)
        XCTAssertEqual(struct2.parent.parent.f25, struct1.parent.parent.f25)
        XCTAssertEqual(struct2.parent.parent.f26, struct1.parent.parent.f26)
        XCTAssertEqual(struct2.parent.parent.f27, struct1.parent.parent.f27)
        XCTAssertEqual(struct2.parent.parent.f28, struct1.parent.parent.f28)
        XCTAssertEqual(struct2.parent.parent.f29, struct1.parent.parent.f29)
        XCTAssertEqual(struct2.parent.parent.f30, struct1.parent.parent.f30)
        XCTAssertEqual(struct2.parent.parent.f31, struct1.parent.parent.f31)
        XCTAssertEqual(struct2.parent.parent.f32, struct1.parent.parent.f32)
        XCTAssertEqual(struct2.parent.parent.f33, struct1.parent.parent.f33)
        XCTAssertEqual(struct2.parent.parent.f34, struct1.parent.parent.f34)
        XCTAssertEqual(floor(struct2.parent.parent.f35.timeIntervalSince1970 * 1000), floor(struct1.parent.parent.f35.timeIntervalSince1970 * 1000))
        XCTAssertEqual(struct2.parent.parent.f36, struct1.parent.parent.f36)
        XCTAssertEqual(struct2.parent.parent.f37, struct1.parent.parent.f37)
        XCTAssertEqual(struct2.parent.parent.f38, struct1.parent.parent.f38)
        XCTAssertEqual(struct2.parent.parent.f39, struct1.parent.parent.f39)
        XCTAssertEqual(struct2.parent.parent.f40, struct1.parent.parent.f40)

        XCTAssertEqual(struct2.parent.f100, struct1.parent.f100)
        XCTAssertEqual(struct2.parent.f101, struct1.parent.f101)
        XCTAssertEqual(struct2.parent.f102, struct1.parent.f102)
        XCTAssertEqual(struct2.parent.f103, struct1.parent.f103)
        XCTAssertEqual(struct2.parent.f104, struct1.parent.f104)
        XCTAssertEqual(struct2.parent.f105, struct1.parent.f105)
        XCTAssertEqual(struct2.parent.f106, struct1.parent.f106)
        XCTAssertEqual(struct2.parent.f107, struct1.parent.f107)
        XCTAssertEqual(struct2.parent.f108, struct1.parent.f108)
        XCTAssertEqual(struct2.parent.f109, struct1.parent.f109)
        XCTAssertEqual(struct2.parent.f110, struct1.parent.f110)
        XCTAssertEqual(struct2.parent.f111, struct1.parent.f111)
        XCTAssertEqual(struct2.parent.f112, struct1.parent.f112)
        XCTAssertEqual(struct2.parent.f113, struct1.parent.f113)
        XCTAssertEqual(struct2.parent.f114, struct1.parent.f114)
        XCTAssertEqual(struct2.parent.f115, struct1.parent.f115)
        XCTAssertEqual(struct2.parent.f116, struct1.parent.f116)
        XCTAssertEqual(struct2.parent.f117, struct1.parent.f117)
        XCTAssertEqual(struct2.parent.f118, struct1.parent.f118)
        XCTAssertEqual(struct2.parent.f119, struct1.parent.f119)
        XCTAssertEqual(struct2.parent.f120, struct1.parent.f120)
        XCTAssertEqual(struct2.parent.f121, struct1.parent.f121)
        XCTAssertEqual(struct2.parent.f122, struct1.parent.f122)
        XCTAssertEqual(struct2.parent.f123, struct1.parent.f123)
        XCTAssertEqual(struct2.parent.f124, struct1.parent.f124)
        XCTAssertEqual(struct2.parent.f125, struct1.parent.f125)
        XCTAssertEqual(struct2.parent.f126, struct1.parent.f126)
        XCTAssertEqual(struct2.parent.f127, struct1.parent.f127)
        XCTAssertEqual(struct2.parent.f128, struct1.parent.f128)
        XCTAssertEqual(struct2.parent.f129, struct1.parent.f129)
        XCTAssertEqual(struct2.parent.f130, struct1.parent.f130)
        XCTAssertEqual(struct2.parent.f131, struct1.parent.f131)
        XCTAssertEqual(struct2.parent.f132, struct1.parent.f132)
        XCTAssertEqual(struct2.parent.f133, struct1.parent.f133)
        XCTAssertEqual(struct2.parent.f134, struct1.parent.f134)
        XCTAssertEqual(struct2.parent.f135, struct1.parent.f135)
        XCTAssertEqual(struct2.parent.f136, struct1.parent.f136)
        XCTAssertEqual(struct2.parent.f137, struct1.parent.f137)
        XCTAssertEqual(struct2.parent.f138, struct1.parent.f138)
        XCTAssertEqual(struct2.parent.f139, struct1.parent.f139)
        XCTAssertEqual(struct2.parent.f140, struct1.parent.f140)
        XCTAssertEqual(struct2.parent.f141, struct1.parent.f141)
        XCTAssertEqual(struct2.parent.f142, struct1.parent.f142)
        XCTAssertEqual(struct2.parent.f143, struct1.parent.f143)
        XCTAssertEqual(struct2.parent.f144, struct1.parent.f144)
        XCTAssertEqual(struct2.parent.f145, struct1.parent.f145)
        XCTAssertEqual(struct2.parent.f146, struct1.parent.f146)
        XCTAssertEqual(struct2.parent.f147, struct1.parent.f147)
        XCTAssertEqual(struct2.parent.f148, struct1.parent.f148)
        XCTAssertEqual(floor(struct2.parent.f149!.timeIntervalSince1970 * 1000), floor(struct1.parent.f149!.timeIntervalSince1970 * 1000))
        XCTAssertEqual(struct2.parent.f150, struct1.parent.f150)
        XCTAssertEqual(struct2.parent.f151, struct1.parent.f151)
        XCTAssertEqual(struct2.parent.f152, struct1.parent.f152)
        XCTAssertEqual(struct2.parent.f153, struct1.parent.f153)
        XCTAssertEqual(struct2.parent.f154, struct1.parent.f154)
        XCTAssertEqual(struct2.parent.f155, struct1.parent.f155)
        XCTAssertEqual(struct2.parent.f156, struct1.parent.f156)
        XCTAssertEqual(struct2.parent.f157, struct1.parent.f157)
