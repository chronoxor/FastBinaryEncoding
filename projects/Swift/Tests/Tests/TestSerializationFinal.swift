...
class TestSerializationFinal: XCTestCase {
    ...
    func testSerializationStructOptional() {
        ...
        XCTAssertEqual(struct2.parent.f35, struct1.parent.f35)
        ...
        XCTAssertEqual(struct2.f149, struct1.f149)
    ...
    func testSerializationStructNested() {
        ...
        XCTAssertEqual(struct2.parent.parent.f35, struct1.parent.parent.f35)
        ...
        XCTAssertEqual(struct2.parent.f149, struct1.parent.f149)
