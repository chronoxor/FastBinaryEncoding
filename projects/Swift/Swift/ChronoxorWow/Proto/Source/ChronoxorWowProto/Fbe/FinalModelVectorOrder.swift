...
class FinalModelVectorOrder: FinalModel {
    ...
    func fbeAllocationSize(value values: Array<ChronoxorWowProto.Order>) -> Int {
        var size: Int = 4
    ...
    public func get(values: inout Array<ChronoxorWowProto.Order>) -> Int {
        values.removeAll()
    ...
    public func set(value values: Array<ChronoxorWowProto.Order>) throws -> Int {
        if _buffer.offset + fbeOffset + 4 > _buffer.size {
            assertionFailure("Model is broken!")
            return 0
        }
