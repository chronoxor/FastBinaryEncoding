...
open class Order: Comparable, Hashable, Codable {
    ...
    public var side: OrderSide = ChronoxorWowProto.OrderSide()
    public var type: OrderType = ChronoxorWowProto.OrderType()
    ...
    public required init(from decoder: Decoder) throws {
        ...
        side = try container.decode(ChronoxorWowProto.OrderSide.self, forKey: .side)
        type = try container.decode(ChronoxorWowProto.OrderType.self, forKey: .type)
