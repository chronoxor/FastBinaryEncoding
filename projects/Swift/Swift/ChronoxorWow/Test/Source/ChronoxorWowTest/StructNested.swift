...
open class StructNested: StructOptional {
    public var f1000: EnumSimple = ChronoxorWowTest.EnumSimple()
    public var f1001: EnumSimple? = nil
    public var f1002: EnumTyped = ChronoxorWowTest.EnumTyped.ENUM_VALUE_2
    public var f1003: EnumTyped? = nil
    public var f1004: FlagsSimple = ChronoxorWowTest.FlagsSimple()
    ...
    public var f1008: StructSimple = ChronoxorWowTest.StructSimple()
    public var f1009: StructSimple? = nil
    public var f1010: StructOptional = ChronoxorWowTest.StructOptional()
    ...
    public required init(from decoder: Decoder) throws {
        ...
        f1000 = try container.decode(ChronoxorWowTest.EnumSimple.self, forKey: .f1000)
        f1001 = try container.decode(ChronoxorWowTest.EnumSimple?.self, forKey: .f1001)
        f1002 = try container.decode(ChronoxorWowTest.EnumTyped.self, forKey: .f1002)
        f1003 = try container.decode(ChronoxorWowTest.EnumTyped?.self, forKey: .f1003)
        f1004 = try container.decode(ChronoxorWowTest.FlagsSimple.self, forKey: .f1004)
        f1005 = try container.decode(ChronoxorWowTest.FlagsSimple?.self, forKey: .f1005)
        f1006 = try container.decode(ChronoxorWowTest.FlagsTyped.self, forKey: .f1006)
        f1007 = try container.decode(ChronoxorWowTest.FlagsTyped?.self, forKey: .f1007)
        f1008 = try container.decode(ChronoxorWowTest.StructSimple.self, forKey: .f1008)
        f1009 = try container.decode(ChronoxorWowTest.StructSimple?.self, forKey: .f1009)
        f1010 = try container.decode(ChronoxorWowTest.StructOptional.self, forKey: .f1010)
        f1011 = try container.decode(ChronoxorWowTest.StructOptional?.self, forKey: .f1011)
    }
