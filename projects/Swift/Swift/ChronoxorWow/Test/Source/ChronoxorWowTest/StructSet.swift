...
open class StructSet: Comparable, Hashable, Codable {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        f2 = try container.decode(Array<ChronoxorWowTest.EnumSimple>.self, forKey: .f2)
        f3 = try container.decode(Array<ChronoxorWowTest.FlagsSimple>.self, forKey: .f3)
        f4 = try container.decode(Array<ChronoxorWowTest.StructSimple>.self, forKey: .f4)
    }
