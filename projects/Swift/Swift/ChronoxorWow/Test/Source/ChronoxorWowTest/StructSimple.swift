...
open class StructSimple: Comparable, Hashable, Codable {
    ...
    public var f36: UUID = ChronoxorWowFbe.UUIDGenerator.nil()
    public var f37: UUID = ChronoxorWowFbe.UUIDGenerator.sequential()
    public var f38: UUID = UUID(uuidString: "123e4567-e89b-12d3-a456-426655440000")!
    public var f39: ChronoxorWowProto.OrderSide = ChronoxorWowProto.OrderSide()
    public var f40: ChronoxorWowProto.OrderType = ChronoxorWowProto.OrderType()
    public var f41: ChronoxorWowProto.Order = ChronoxorWowProto.Order()
    public var f42: ChronoxorWowProto.Balance = ChronoxorWowProto.Balance()
    public var f43: ChronoxorWowProto.State = ChronoxorWowProto.State()
    public var f44: ChronoxorWowProto.Account = ChronoxorWowProto.Account()

    public init() { }
    public init(id: Int32, f1: Bool, f2: Bool, f3: UInt8, f4: UInt8, f5: Character, f6: Character, f7: Character, f8: Character, f9: Int8, f10: Int8, f11: UInt8, f12: UInt8, f13: Int16, f14: Int16, f15: UInt16, f16: UInt16, f17: Int32, f18: Int32, f19: UInt32, f20: UInt32, f21: Int64, f22: Int64, f23: UInt64, f24: UInt64, f25: Float, f26: Float, f27: Double, f28: Double, f29: Decimal, f30: Decimal, f31: String, f32: String, f33: TimeInterval, f34: TimeInterval, f35: TimeInterval, f36: UUID, f37: UUID, f38: UUID, f39: ChronoxorWowProto.OrderSide, f40: ChronoxorWowProto.OrderType, f41: ChronoxorWowProto.Order, f42: ChronoxorWowProto.Balance, f43: ChronoxorWowProto.State, f44: ChronoxorWowProto.Account) {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        f39 = try container.decode(ChronoxorWowProto.OrderSide.self, forKey: .f39)
        f40 = try container.decode(ChronoxorWowProto.OrderType.self, forKey: .f40)
        f41 = try container.decode(ChronoxorWowProto.Order.self, forKey: .f41)
        f42 = try container.decode(ChronoxorWowProto.Balance.self, forKey: .f42)
        f43 = try container.decode(ChronoxorWowProto.State.self, forKey: .f43)
        f44 = try container.decode(ChronoxorWowProto.Account.self, forKey: .f44)
    }
    ...
    open func encode(to encoder: Encoder) throws {
        ...
        try container.encode(f33, forKey: .f33)
        try container.encode(f34, forKey: .f34)
        try container.encode(f35, forKey: .f35)
