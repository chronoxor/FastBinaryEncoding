...
class FieldModelArrayOptionalStructSimple: FieldModel {
    private let _model: FieldModelOptionalStructSimple
    ...
    required init() {
        ...
        _model = FieldModelOptionalStructSimple(buffer: buffer, offset: offset)
    }
    ...
    public func getItem(index: Int) -> FieldModelOptionalStructSimple {
    ...
    public func get() -> Array<ChronoxorWowTest.StructSimple?> {
        var values = Array<ChronoxorWowTest.StructSimple?>()
    ...
    public func get(values: inout Array<ChronoxorWowTest.StructSimple?>) {
        values.removeAll()
    ...
    public func set(value values: Array<ChronoxorWowTest.StructSimple?>) throws {
        if _buffer.offset + fbeOffset + fbeSize > _buffer.size {
