...
class FinalModelMapStructSimpleStructNested: FinalModel {
    var _buffer: Buffer = Buffer()
    var _offset: Int = 0

    private var _modelKey: FinalModelStructSimple
    private var _modelValue: FinalModelStructNested
    ...
    init(buffer: Buffer, offset: Int) {
        ...
        _modelValue = FinalModelStructNested(buffer: buffer, offset: offset)
    }
