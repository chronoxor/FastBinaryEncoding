...
class FieldModelMapInt32OptionalFlagsSimple: FieldModel {
    private let _modelKey: ChronoxorWowFbe.FieldModelInt32
    ...
    required init() {
        ...
        _modelKey = ChronoxorWowFbe.FieldModelInt32(buffer: buffer, offset: offset)
    ...
    public func getItem(index: Int) -> (ChronoxorWowFbe.FieldModelInt32, FieldModelOptionalFlagsSimple) {
    ...
    func resize(size: Int) throws -> (ChronoxorWowFbe.FieldModelInt32, FieldModelOptionalFlagsSimple) {
    ...
    public func get(values: inout Dictionary<Int32, ChronoxorWowTest.FlagsSimple?>) {
        values.removeAll()
    ...
    public func set(value values: Dictionary<Int32, ChronoxorWowTest.FlagsSimple?>) throws {
        if _buffer.offset + fbeOffset + fbeSize > _buffer.size {
