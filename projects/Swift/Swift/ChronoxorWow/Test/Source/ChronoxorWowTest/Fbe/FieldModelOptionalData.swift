...
// Fast Binary Encoding optional Data field model
public class FieldModelOptionalData: FieldModel {
    ...
    public let value: ChronoxorWowFbe.FieldModelData
    ...
    public required init() {
        ...
        value = ChronoxorWowFbe.FieldModelData(buffer: buffer, offset: 0)
    }
    ...
    public func get(defaults: Data? = nil) -> Data? {
    ...
    // Set the optional value (end phase)
      ...
      public func set(value optional: Data?) throws {
