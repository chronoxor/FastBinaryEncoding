...
class FinalModelOptionalBoolean: FinalModel {

    var _buffer: Buffer
    var _offset: Int

    // Base field model value
    let value: ChronoxorWowFbe.FinalModelBoolean
    ...
    required init() {
        ...
        value = ChronoxorWowFbe.FinalModelBoolean(buffer: buffer, offset: offset)
    }
    ...
    public func set(value optional: Bool?) throws -> Int {
        if _buffer.offset + fbeOffset + 1 > _buffer.size {
            assertionFailure("Model is broken!")
            return 0
        }
