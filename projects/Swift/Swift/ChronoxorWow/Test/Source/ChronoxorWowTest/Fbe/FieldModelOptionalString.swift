...
public class FieldModelOptionalString: FieldModel {
    ...
    public let value: ChronoxorWowFbe.FieldModelString
    ...
    public required init() {
        ...
        value = ChronoxorWowFbe.FieldModelString(buffer: buffer, offset: 0)
    }
    ...
    public func get(defaults: String? = nil) -> String? {
    ...
    // Set the optional value (end phase)
      ...
      public func set(value optional: String?) throws {
