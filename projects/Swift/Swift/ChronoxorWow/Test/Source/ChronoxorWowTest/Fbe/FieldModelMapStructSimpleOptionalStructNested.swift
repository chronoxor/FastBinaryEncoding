...
class FieldModelMapStructSimpleOptionalStructNested: FieldModel {
    private let _modelKey: FieldModelStructSimple
    private let _modelValue: FieldModelOptionalStructNested
    ...
    required init() {
        ...
        _modelKey = FieldModelStructSimple(buffer: buffer, offset: offset)
        _modelValue = FieldModelOptionalStructNested(buffer: buffer, offset: offset)
    }
    ...
    public func getItem(index: Int) -> (FieldModelStructSimple, FieldModelOptionalStructNested) {
    ...
    func resize(size: Int) throws -> (FieldModelStructSimple, FieldModelOptionalStructNested) {
    ...
    public func get(values: inout Dictionary<ChronoxorWowTest.StructSimple, ChronoxorWowTest.StructNested?>) {
        values.removeAll()
    ...
    public func set(value values: Dictionary<ChronoxorWowTest.StructSimple, ChronoxorWowTest.StructNested?>) throws {
        if _buffer.offset + fbeOffset + fbeSize > _buffer.size {
