...
class FieldModelVectorData: FieldModel {
    private let _model: ChronoxorWowFbe.FieldModelData
    ...
    required init() {
        ...
        _model = ChronoxorWowFbe.FieldModelData(buffer: buffer, offset: offset)
    }
    ...
    public func getItem(index: Int) -> ChronoxorWowFbe.FieldModelData {
    ...
    func resize(size: Int) throws -> ChronoxorWowFbe.FieldModelData {
