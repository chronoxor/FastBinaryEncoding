...
// Fast Binary Encoding optional Order final model
class FinalModelOptionalOrder: FinalModel {

    var _buffer: Buffer
    var _offset: Int

    // Base field model value
    let value: ChronoxorWowProto.FinalModelOrder
    ...
    required init() {
        ...
        value = ChronoxorWowProto.FinalModelOrder(buffer: buffer, offset: offset)
    }
    ...
    func fbeAllocationSize(value optional: ChronoxorWowProto.Order?) -> Int {
    ...
    public func get(size: inout Size) -> ChronoxorWowProto.Order? {
        if _buffer.offset + fbeOffset + 1 > _buffer.size {
    ...
    public func set(value optional: ChronoxorWowProto.Order?) throws -> Int {
        if _buffer.offset + fbeOffset + 1 > _buffer.size {
            assertionFailure("Model is broken!")
            return 0
        }
