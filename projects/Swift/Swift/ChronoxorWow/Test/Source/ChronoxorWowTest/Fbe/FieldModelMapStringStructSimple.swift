...
class FieldModelMapStringStructSimple: FieldModel {
    private let _modelKey: ChronoxorWowFbe.FieldModelString
    private let _modelValue: FieldModelStructSimple
    ...
    required init() {
        ...
        _modelValue = FieldModelStructSimple(buffer: buffer, offset: offset)
    }
    ...
    public func getItem(index: Int) -> (ChronoxorWowFbe.FieldModelString, FieldModelStructSimple) {
    ...
    func resize(size: Int) throws -> (ChronoxorWowFbe.FieldModelString, FieldModelStructSimple) {
    ...
    public func get(values: inout Dictionary<String, ChronoxorWowTest.StructSimple>) {
        values.removeAll()
    ...
    public func set(value values: Dictionary<String, ChronoxorWowTest.StructSimple>) throws {
        if _buffer.offset + fbeOffset + fbeSize > _buffer.size {
