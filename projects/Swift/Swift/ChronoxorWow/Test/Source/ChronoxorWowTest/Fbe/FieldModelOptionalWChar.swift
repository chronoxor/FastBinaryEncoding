...
public class FieldModelOptionalWChar: FieldModel {
    ...
    public let value: ChronoxorWowFbe.FieldModelWChar
    ...
    public required init() {
        ...
        value = ChronoxorWowFbe.FieldModelWChar(buffer: buffer, offset: 0)
    }
    ...
    public func get(defaults: Character? = nil) -> Character? {
    ...
    // Set the optional value (end phase)
      ...
      public func set(value optional: Character?) throws {
