...
public class FieldModelStructSimple: FieldModel {
    ...
    let id: ChronoxorWowFbe.FieldModelInt32
    let f1: ChronoxorWowFbe.FieldModelBoolean
    let f2: ChronoxorWowFbe.FieldModelBoolean
    let f3: ChronoxorWowFbe.FieldModelUInt8
    let f4: ChronoxorWowFbe.FieldModelUInt8
    let f5: ChronoxorWowFbe.FieldModelChar
    let f6: ChronoxorWowFbe.FieldModelChar
    let f7: ChronoxorWowFbe.FieldModelWChar
    let f8: ChronoxorWowFbe.FieldModelWChar
    let f9: ChronoxorWowFbe.FieldModelInt8
    let f10: ChronoxorWowFbe.FieldModelInt8
    let f11: ChronoxorWowFbe.FieldModelUInt8
    let f12: ChronoxorWowFbe.FieldModelUInt8
    let f13: ChronoxorWowFbe.FieldModelInt16
    let f14: ChronoxorWowFbe.FieldModelInt16
    let f15: ChronoxorWowFbe.FieldModelUInt16
    let f16: ChronoxorWowFbe.FieldModelUInt16
    let f17: ChronoxorWowFbe.FieldModelInt32
    let f18: ChronoxorWowFbe.FieldModelInt32
    let f19: ChronoxorWowFbe.FieldModelUInt32
    let f20: ChronoxorWowFbe.FieldModelUInt32
    let f21: ChronoxorWowFbe.FieldModelInt64
    let f22: ChronoxorWowFbe.FieldModelInt64
    let f23: ChronoxorWowFbe.FieldModelUInt64
    let f24: ChronoxorWowFbe.FieldModelUInt64
    let f25: ChronoxorWowFbe.FieldModelFloat
    let f26: ChronoxorWowFbe.FieldModelFloat
    let f27: ChronoxorWowFbe.FieldModelDouble
    let f28: ChronoxorWowFbe.FieldModelDouble
    let f29: ChronoxorWowFbe.FieldModelDecimal
    let f30: ChronoxorWowFbe.FieldModelDecimal
    let f31: ChronoxorWowFbe.FieldModelString
    let f32: ChronoxorWowFbe.FieldModelString
    let f33: ChronoxorWowFbe.FieldModelTimestamp
    let f34: ChronoxorWowFbe.FieldModelTimestamp
    let f35: ChronoxorWowFbe.FieldModelTimestamp
    let f36: ChronoxorWowFbe.FieldModelUUID
    let f37: ChronoxorWowFbe.FieldModelUUID
    let f38: ChronoxorWowFbe.FieldModelUUID
    let f39: ChronoxorWowProto.FieldModelOrderSide
    let f40: ChronoxorWowProto.FieldModelOrderType
    let f41: ChronoxorWowProto.FieldModelOrder
    let f42: ChronoxorWowProto.FieldModelBalance
    let f43: ChronoxorWowProto.FieldModelState
    let f44: ChronoxorWowProto.FieldModelAccount
    ...
    public required init() {
        ...
        f39 = ChronoxorWowProto.FieldModelOrderSide(buffer: buffer, offset: f38.fbeOffset + f38.fbeSize)
        f40 = ChronoxorWowProto.FieldModelOrderType(buffer: buffer, offset: f39.fbeOffset + f39.fbeSize)
        f41 = ChronoxorWowProto.FieldModelOrder(buffer: buffer, offset: f40.fbeOffset + f40.fbeSize)
        f42 = ChronoxorWowProto.FieldModelBalance(buffer: buffer, offset: f41.fbeOffset + f41.fbeSize)
        f43 = ChronoxorWowProto.FieldModelState(buffer: buffer, offset: f42.fbeOffset + f42.fbeSize)
        f44 = ChronoxorWowProto.FieldModelAccount(buffer: buffer, offset: f43.fbeOffset + f43.fbeSize)
    ...
    public func getFields(fbeValue: inout StructSimple, fbeStructSize: Int) {
        ...
        if fbeCurrentSize + f36.fbeSize <= fbeStructSize {
            ...
            fbeValue.f36 = ChronoxorWowFbe.UUIDGenerator.nil()
        }
        fbeCurrentSize += f36.fbeSize

        if fbeCurrentSize + f37.fbeSize <= fbeStructSize {
            fbeValue.f37 = f37.get(defaults: ChronoxorWowFbe.UUIDGenerator.sequential())
        } else {
            fbeValue.f37 = ChronoxorWowFbe.UUIDGenerator.sequential()
        }
        fbeCurrentSize += f37.fbeSize
        ...
        if fbeCurrentSize + f39.fbeSize <= fbeStructSize {
            ...
            fbeValue.f39 = ChronoxorWowProto.OrderSide()
        }
        fbeCurrentSize += f39.fbeSize
        ...
        if fbeCurrentSize + f40.fbeSize <= fbeStructSize {
            ...
            fbeValue.f40 = ChronoxorWowProto.OrderType()
        }
        fbeCurrentSize += f40.fbeSize
        ...
        if fbeCurrentSize + f41.fbeSize <= fbeStructSize {
            ...
            fbeValue.f41 = ChronoxorWowProto.Order()
        }
        fbeCurrentSize += f41.fbeSize
        ...
        if fbeCurrentSize + f42.fbeSize <= fbeStructSize {
            ...
            fbeValue.f42 = ChronoxorWowProto.Balance()
        }
        fbeCurrentSize += f42.fbeSize
        ...
        if fbeCurrentSize + f43.fbeSize <= fbeStructSize {
            ...
            fbeValue.f43 = ChronoxorWowProto.State()
        }
        fbeCurrentSize += f43.fbeSize
        ...
        if fbeCurrentSize + f44.fbeSize <= fbeStructSize {
            ...
            fbeValue.f44 = ChronoxorWowProto.Account()
        }
        fbeCurrentSize += f44.fbeSize
    }
