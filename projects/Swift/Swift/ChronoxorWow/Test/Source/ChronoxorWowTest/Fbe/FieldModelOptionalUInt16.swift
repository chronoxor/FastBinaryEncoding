...
public class FieldModelOptionalUInt16: FieldModel {
    ...
    public let value: ChronoxorWowFbe.FieldModelUInt16
    ...
    public required init() {
        ...
        value = ChronoxorWowFbe.FieldModelUInt16(buffer: buffer, offset: 0)
    }
    ...
    public func get(defaults: UInt16? = nil) -> UInt16? {
    ...
    // Set the optional value (end phase)
      ...
      public func set(value optional: UInt16?) throws {
