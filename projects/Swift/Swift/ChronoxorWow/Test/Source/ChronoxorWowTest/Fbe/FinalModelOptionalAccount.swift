...
// Fast Binary Encoding optional Account final model
class FinalModelOptionalAccount: FinalModel {

    var _buffer: Buffer
    var _offset: Int

    // Base field model value
    let value: ChronoxorWowProto.FinalModelAccount
    ...
    required init() {
        ...
        value = ChronoxorWowProto.FinalModelAccount(buffer: buffer, offset: offset)
    }
    ...
    func fbeAllocationSize(value optional: ChronoxorWowProto.Account?) -> Int {
    ...
    public func get(size: inout Size) -> ChronoxorWowProto.Account? {
        if _buffer.offset + fbeOffset + 1 > _buffer.size {
    ...
    public func set(value optional: ChronoxorWowProto.Account?) throws -> Int {
        if _buffer.offset + fbeOffset + 1 > _buffer.size {
            assertionFailure("Model is broken!")
            return 0
        }
