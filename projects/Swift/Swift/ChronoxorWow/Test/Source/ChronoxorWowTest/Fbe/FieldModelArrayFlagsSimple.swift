...
class FieldModelArrayFlagsSimple: FieldModel {
    ...
    public func get() -> Array<ChronoxorWowTest.FlagsSimple> {
        var values = Array<ChronoxorWowTest.FlagsSimple>()
    ...
    public func get(values: inout Array<ChronoxorWowTest.FlagsSimple>) {
        values.removeAll()
    ...
    public func set(value values: Array<ChronoxorWowTest.FlagsSimple>) throws {
        if _buffer.offset + fbeOffset + fbeSize > _buffer.size {
