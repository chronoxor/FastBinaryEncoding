...
public class FieldModelOptionalFloat: FieldModel {
    ...
    public let value: ChronoxorWowFbe.FieldModelFloat
    ...
    public required init() {
        ...
        value = ChronoxorWowFbe.FieldModelFloat(buffer: buffer, offset: 0)
    }
    ...
    public func get(defaults: Float? = nil) -> Float? {
    ...
    // Set the optional value (end phase)
      ...
      public func set(value optional: Float?) throws {
