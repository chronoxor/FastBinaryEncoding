...
public class FieldModelOptionalTimestamp: FieldModel {
    ...
    public let value: ChronoxorWowFbe.FieldModelTimestamp
    ...
    public required init() {
        ...
        value = ChronoxorWowFbe.FieldModelTimestamp(buffer: buffer, offset: 0)
    }
