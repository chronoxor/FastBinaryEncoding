...
// Fast Binary Encoding optional OrderType field model
public class FieldModelOptionalOrderType: FieldModel {
    ...
    public let value: ChronoxorWowProto.FieldModelOrderType
    ...
    public required init() {
        ...
        value = ChronoxorWowProto.FieldModelOrderType(buffer: buffer, offset: 0)
    }
    ...
    public func get(defaults: ChronoxorWowProto.OrderType? = nil) -> ChronoxorWowProto.OrderType? {
    ...
    // Set the optional value (end phase)
      ...
      public func set(value optional: ChronoxorWowProto.OrderType?) throws {
