...
class FinalModelOptionalString: FinalModel {

    var _buffer: Buffer
    var _offset: Int

    // Base field model value
    let value: ChronoxorWowFbe.FinalModelString
    ...
    required init() {
        ...
        value = ChronoxorWowFbe.FinalModelString(buffer: buffer, offset: offset)
    }
    ...
    func fbeAllocationSize(value optional: String?) -> Int {
    ...
    public func set(value optional: String?) throws -> Int {
        if _buffer.offset + fbeOffset + 1 > _buffer.size {
            assertionFailure("Model is broken!")
            return 0
        }
