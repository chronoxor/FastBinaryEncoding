...
class FinalModelOptionalBalance: FinalModel {
    ...
    let value: ChronoxorWowProto.FinalModelBalance
    ...
    required init() {
        ...
        value = ChronoxorWowProto.FinalModelBalance(buffer: buffer, offset: offset)
    }
    ...
    func fbeAllocationSize(value optional: ChronoxorWowProto.Balance?) -> Int {
    ...
    public func get(size: inout Size) -> ChronoxorWowProto.Balance? {
        if _buffer.offset + fbeOffset + 1 > _buffer.size {
    ...
    public func set(value optional: ChronoxorWowProto.Balance?) throws -> Int {
        if _buffer.offset + fbeOffset + 1 > _buffer.size {
            assertionFailure("Model is broken!")
            return 0
        }
