...
// Fast Binary Encoding Int32->OptionalUInt8 map final model
class FinalModelMapInt32OptionalUInt8: FinalModel {
    var _buffer: Buffer = Buffer()
    var _offset: Int = 0

    private var _modelKey: ChronoxorWowFbe.FinalModelInt32
    private var _modelValue: FinalModelOptionalUInt8
    ...
    init(buffer: Buffer, offset: Int) {
        ...
        _modelValue = FinalModelOptionalUInt8(buffer: buffer, offset: offset)
    }
