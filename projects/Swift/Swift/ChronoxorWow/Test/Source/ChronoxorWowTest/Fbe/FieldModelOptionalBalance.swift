...
public class FieldModelOptionalBalance: FieldModel {
    ...
    public let value: ChronoxorWowProto.FieldModelBalance
    ...
    public required init() {
        ...
        value = ChronoxorWowProto.FieldModelBalance(buffer: buffer, offset: 0)
    }
    ...
    public func get(defaults: ChronoxorWowProto.Balance? = nil) -> ChronoxorWowProto.Balance? {
    ...
    // Set the optional value (end phase)
      ...
      public func set(value optional: ChronoxorWowProto.Balance?) throws {
