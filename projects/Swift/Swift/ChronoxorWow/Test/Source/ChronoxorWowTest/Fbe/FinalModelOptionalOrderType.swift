...
class FinalModelOptionalOrderType: FinalModel {
    ...
    let value: ChronoxorWowProto.FinalModelOrderType
    ...
    required init() {
        ...
        value = ChronoxorWowProto.FinalModelOrderType(buffer: buffer, offset: offset)
    }
    ...
    func fbeAllocationSize(value optional: ChronoxorWowProto.OrderType?) -> Int {
    ...
    public func get(size: inout Size) -> ChronoxorWowProto.OrderType? {
        if _buffer.offset + fbeOffset + 1 > _buffer.size {
    ...
    public func set(value optional: ChronoxorWowProto.OrderType?) throws -> Int {
        if _buffer.offset + fbeOffset + 1 > _buffer.size {
            assertionFailure("Model is broken!")
            return 0
        }
