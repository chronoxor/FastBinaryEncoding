...
// Fast Binary Encoding String->OptionalUInt8 map field model
class FieldModelMapStringOptionalUInt8: FieldModel {
    ...
    public func getItem(index: Int) -> (ChronoxorWowFbe.FieldModelString, FieldModelOptionalUInt8) {
    ...
    func resize(size: Int) throws -> (ChronoxorWowFbe.FieldModelString, FieldModelOptionalUInt8) {
