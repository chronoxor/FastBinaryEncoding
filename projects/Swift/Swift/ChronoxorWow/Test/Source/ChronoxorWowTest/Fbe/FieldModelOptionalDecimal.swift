...
public class FieldModelOptionalDecimal: FieldModel {
    ...
    public let value: ChronoxorWowFbe.FieldModelDecimal
    ...
    public required init() {
        ...
        value = ChronoxorWowFbe.FieldModelDecimal(buffer: buffer, offset: 0)
    }
    ...
    public func get(defaults: Decimal? = nil) -> Decimal? {
    ...
    // Set the optional value (end phase)
      ...
      public func set(value optional: Decimal?) throws {
