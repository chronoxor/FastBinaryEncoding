...
public class FieldModelOptionalInt64: FieldModel {
    ...
    public let value: ChronoxorWowFbe.FieldModelInt64
    ...
    public required init() {
        ...
        value = ChronoxorWowFbe.FieldModelInt64(buffer: buffer, offset: 0)
    }
    ...
    public func get(defaults: Int64? = nil) -> Int64? {
    ...
    // Set the optional value (end phase)
      ...
      public func set(value optional: Int64?) throws {
