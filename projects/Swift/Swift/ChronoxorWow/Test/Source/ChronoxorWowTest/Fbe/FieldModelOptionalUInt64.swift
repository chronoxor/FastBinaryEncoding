...
public class FieldModelOptionalUInt64: FieldModel {
    ...
    public let value: ChronoxorWowFbe.FieldModelUInt64
    ...
    public required init() {
        ...
        value = ChronoxorWowFbe.FieldModelUInt64(buffer: buffer, offset: 0)
    }
    ...
    public func get(defaults: UInt64? = nil) -> UInt64? {
    ...
    // Set the optional value (end phase)
      ...
      public func set(value optional: UInt64?) throws {
