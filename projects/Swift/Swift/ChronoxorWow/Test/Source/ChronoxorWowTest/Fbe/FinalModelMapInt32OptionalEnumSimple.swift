...
class FinalModelMapInt32OptionalEnumSimple: FinalModel {
    var _buffer: Buffer = Buffer()
    var _offset: Int = 0

    private var _modelKey: ChronoxorWowFbe.FinalModelInt32
    ...
    init(buffer: Buffer, offset: Int) {
        ...
        _modelKey = ChronoxorWowFbe.FinalModelInt32(buffer: buffer, offset: offset)
        _modelValue = FinalModelOptionalEnumSimple(buffer: buffer, offset: offset)
    }

    // Get the allocation size
    func fbeAllocationSize(value values: Dictionary<Int32, ChronoxorWowTest.EnumSimple?>) -> Int {
        var size: Int = 4
    ...
    public func get(values: inout Dictionary<Int32, ChronoxorWowTest.EnumSimple?>) -> Int {
        values.removeAll()
    ...
    public func set(value values: Dictionary<Int32, ChronoxorWowTest.EnumSimple?>) throws -> Int {
        if _buffer.offset + fbeOffset + 4 > _buffer.size {
            assertionFailure("Model is broken!")
            return 0
        }
