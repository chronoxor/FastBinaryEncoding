...
class FieldModelMapInt32OptionalUInt8: FieldModel {
    ...
    public func getItem(index: Int) -> (ChronoxorWowFbe.FieldModelInt32, FieldModelOptionalUInt8) {
    ...
    func resize(size: Int) throws -> (ChronoxorWowFbe.FieldModelInt32, FieldModelOptionalUInt8) {
