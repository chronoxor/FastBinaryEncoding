...
public class FieldModelOptionalBoolean: FieldModel {
    ...
    public let value: ChronoxorWowFbe.FieldModelBoolean
    ...
    public required init() {
        ...
        value = ChronoxorWowFbe.FieldModelBoolean(buffer: buffer, offset: 0)
    }
    ...
    public func get(defaults: Bool? = nil) -> Bool? {
    ...
    // Set the optional value (end phase)
      ...
      public func set(value optional: Bool?) throws {
