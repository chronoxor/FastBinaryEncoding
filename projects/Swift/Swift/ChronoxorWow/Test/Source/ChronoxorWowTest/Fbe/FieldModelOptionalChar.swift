...
public class FieldModelOptionalChar: FieldModel {
    ...
    public let value: ChronoxorWowFbe.FieldModelChar
    ...
    public required init() {
        ...
        value = ChronoxorWowFbe.FieldModelChar(buffer: buffer, offset: 0)
    }
