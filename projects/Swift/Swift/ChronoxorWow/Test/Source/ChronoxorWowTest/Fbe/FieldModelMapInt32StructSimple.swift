...
class FieldModelMapInt32StructSimple: FieldModel {
    ...
    public func getItem(index: Int) -> (ChronoxorWowFbe.FieldModelInt32, FieldModelStructSimple) {
    ...
    func resize(size: Int) throws -> (ChronoxorWowFbe.FieldModelInt32, FieldModelStructSimple) {
    ...
    public func get(values: inout Dictionary<Int32, ChronoxorWowTest.StructSimple>) {
        values.removeAll()
    ...
    public func set(value values: Dictionary<Int32, ChronoxorWowTest.StructSimple>) throws {
        if _buffer.offset + fbeOffset + fbeSize > _buffer.size {
