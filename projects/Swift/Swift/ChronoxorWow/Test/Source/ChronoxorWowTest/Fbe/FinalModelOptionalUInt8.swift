...
class FinalModelOptionalUInt8: FinalModel {

    var _buffer: Buffer
    var _offset: Int

    // Base field model value
    let value: ChronoxorWowFbe.FinalModelUInt8
    ...
    required init() {
        ...
        value = ChronoxorWowFbe.FinalModelUInt8(buffer: buffer, offset: offset)
    }
    ...
    func fbeAllocationSize(value optional: UInt8?) -> Int {
