...
public class FieldModelOptionalInt16: FieldModel {
    ...
    public let value: ChronoxorWowFbe.FieldModelInt16
    ...
    public required init() {
        ...
        value = ChronoxorWowFbe.FieldModelInt16(buffer: buffer, offset: 0)
    }
    ...
    public func get(defaults: Int16? = nil) -> Int16? {
    ...
    // Set the optional value (end phase)
      ...
      public func set(value optional: Int16?) throws {
