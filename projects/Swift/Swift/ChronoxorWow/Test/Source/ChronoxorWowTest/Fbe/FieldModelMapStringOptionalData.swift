...
// Fast Binary Encoding String->OptionalData map field model
class FieldModelMapStringOptionalData: FieldModel {
    ...
    public func getItem(index: Int) -> (ChronoxorWowFbe.FieldModelString, FieldModelOptionalData) {
    ...
    func resize(size: Int) throws -> (ChronoxorWowFbe.FieldModelString, FieldModelOptionalData) {
