...
class FieldModelMapStringOptionalEnumSimple: FieldModel {
    private let _modelKey: ChronoxorWowFbe.FieldModelString
    private let _modelValue: FieldModelOptionalEnumSimple
    ...
    required init() {
        ...
        _modelValue = FieldModelOptionalEnumSimple(buffer: buffer, offset: offset)
    }
    ...
    public func getItem(index: Int) -> (ChronoxorWowFbe.FieldModelString, FieldModelOptionalEnumSimple) {
    ...
    func resize(size: Int) throws -> (ChronoxorWowFbe.FieldModelString, FieldModelOptionalEnumSimple) {
    ...
    public func get(values: inout Dictionary<String, ChronoxorWowTest.EnumSimple?>) {
        values.removeAll()
    ...
    public func set(value values: Dictionary<String, ChronoxorWowTest.EnumSimple?>) throws {
        if _buffer.offset + fbeOffset + fbeSize > _buffer.size {
