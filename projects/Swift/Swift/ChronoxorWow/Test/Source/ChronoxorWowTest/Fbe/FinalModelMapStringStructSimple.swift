...
class FinalModelMapStringStructSimple: FinalModel {
    var _buffer: Buffer = Buffer()
    var _offset: Int = 0

    private var _modelKey: ChronoxorWowFbe.FinalModelString
    private var _modelValue: FinalModelStructSimple
    ...
    init(buffer: Buffer, offset: Int) {
        ...
        _modelValue = FinalModelStructSimple(buffer: buffer, offset: offset)
    }

    // Get the allocation size
    func fbeAllocationSize(value values: Dictionary<String, ChronoxorWowTest.StructSimple>) -> Int {
        var size: Int = 4
    ...
    public func get(values: inout Dictionary<String, ChronoxorWowTest.StructSimple>) -> Int {
        values.removeAll()
    ...
    public func set(value values: Dictionary<String, ChronoxorWowTest.StructSimple>) throws -> Int {
        if _buffer.offset + fbeOffset + 4 > _buffer.size {
            assertionFailure("Model is broken!")
            return 0
        }
