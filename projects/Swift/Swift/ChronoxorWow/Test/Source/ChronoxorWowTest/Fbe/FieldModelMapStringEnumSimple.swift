...
class FieldModelMapStringEnumSimple: FieldModel {
    private let _modelKey: ChronoxorWowFbe.FieldModelString
    private let _modelValue: FieldModelEnumSimple
    ...
    required init() {
        ...
        _modelValue = FieldModelEnumSimple(buffer: buffer, offset: offset)
    }
    ...
    public func getItem(index: Int) -> (ChronoxorWowFbe.FieldModelString, FieldModelEnumSimple) {
    ...
    func resize(size: Int) throws -> (ChronoxorWowFbe.FieldModelString, FieldModelEnumSimple) {
