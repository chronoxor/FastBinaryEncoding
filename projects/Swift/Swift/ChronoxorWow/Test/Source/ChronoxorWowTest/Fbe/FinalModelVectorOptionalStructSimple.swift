...
class FinalModelVectorOptionalStructSimple: FinalModel {
    ...
    func fbeAllocationSize(value values: Array<ChronoxorWowTest.StructSimple?>) -> Int {
        var size: Int = 4
    ...
    public func get(values: inout Array<ChronoxorWowTest.StructSimple?>) -> Int {
        values.removeAll()
    ...
    public func set(value values: Array<ChronoxorWowTest.StructSimple?>) throws -> Int {
        if _buffer.offset + fbeOffset + 4 > _buffer.size {
            assertionFailure("Model is broken!")
            return 0
        }
