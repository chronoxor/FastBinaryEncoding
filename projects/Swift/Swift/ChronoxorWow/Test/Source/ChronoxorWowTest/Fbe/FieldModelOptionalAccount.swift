...
// Fast Binary Encoding optional Account field model
public class FieldModelOptionalAccount: FieldModel {
    ...
    public let value: ChronoxorWowProto.FieldModelAccount
    ...
    public required init() {
        ...
        value = ChronoxorWowProto.FieldModelAccount(buffer: buffer, offset: 0)
    }
    ...
    public func get(defaults: ChronoxorWowProto.Account? = nil) -> ChronoxorWowProto.Account? {
    ...
    // Set the optional value (end phase)
      ...
      public func set(value optional: ChronoxorWowProto.Account?) throws {
