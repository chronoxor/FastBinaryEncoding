...
class FieldModelMapInt32OptionalData: FieldModel {
    ...
    public func getItem(index: Int) -> (ChronoxorWowFbe.FieldModelInt32, FieldModelOptionalData) {
    ...
    func resize(size: Int) throws -> (ChronoxorWowFbe.FieldModelInt32, FieldModelOptionalData) {
