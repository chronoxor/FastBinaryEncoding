...
public class FieldModelOptionalUInt8: FieldModel {
    ...
    public let value: ChronoxorWowFbe.FieldModelUInt8
    ...
    public required init() {
        ...
        value = ChronoxorWowFbe.FieldModelUInt8(buffer: buffer, offset: 0)
    }
    ...
    public func get(defaults: UInt8? = nil) -> UInt8? {
    ...
    // Set the optional value (end phase)
      ...
      public func set(value optional: UInt8?) throws {
