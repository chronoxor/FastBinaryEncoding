...
public class FieldModelOptionalUInt32: FieldModel {
    ...
    public let value: ChronoxorWowFbe.FieldModelUInt32
    ...
    public required init() {
        ...
        value = ChronoxorWowFbe.FieldModelUInt32(buffer: buffer, offset: 0)
    }
    ...
    public func get(defaults: UInt32? = nil) -> UInt32? {
    ...
    // Set the optional value (end phase)
      ...
      public func set(value optional: UInt32?) throws {
