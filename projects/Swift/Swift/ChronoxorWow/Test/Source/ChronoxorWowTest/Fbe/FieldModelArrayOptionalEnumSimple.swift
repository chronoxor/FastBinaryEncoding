...
class FieldModelArrayOptionalEnumSimple: FieldModel {
    private let _model: FieldModelOptionalEnumSimple
    ...
    required init() {
        ...
        _model = FieldModelOptionalEnumSimple(buffer: buffer, offset: offset)
    }
    ...
    public func getItem(index: Int) -> FieldModelOptionalEnumSimple {
    ...
    public func get() -> Array<ChronoxorWowTest.EnumSimple?> {
        var values = Array<ChronoxorWowTest.EnumSimple?>()
    ...
    public func get(values: inout Array<ChronoxorWowTest.EnumSimple?>) {
        values.removeAll()
    ...
    public func set(value values: Array<ChronoxorWowTest.EnumSimple?>) throws {
        if _buffer.offset + fbeOffset + fbeSize > _buffer.size {
