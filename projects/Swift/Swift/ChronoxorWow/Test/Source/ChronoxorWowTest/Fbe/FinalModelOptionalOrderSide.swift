...
// Fast Binary Encoding optional OrderSide final model
class FinalModelOptionalOrderSide: FinalModel {

    var _buffer: Buffer
    var _offset: Int

    // Base field model value
    let value: ChronoxorWowProto.FinalModelOrderSide
    ...
    required init() {
        ...
        value = ChronoxorWowProto.FinalModelOrderSide(buffer: buffer, offset: offset)
    }
    ...
    func fbeAllocationSize(value optional: ChronoxorWowProto.OrderSide?) -> Int {
    ...
    public func get(size: inout Size) -> ChronoxorWowProto.OrderSide? {
        if _buffer.offset + fbeOffset + 1 > _buffer.size {
    ...
    public func set(value optional: ChronoxorWowProto.OrderSide?) throws -> Int {
        if _buffer.offset + fbeOffset + 1 > _buffer.size {
            assertionFailure("Model is broken!")
            return 0
        }
