...
// Fast Binary Encoding String->Data map field model
class FieldModelMapStringData: FieldModel {
    private let _modelKey: ChronoxorWowFbe.FieldModelString
    private let _modelValue: ChronoxorWowFbe.FieldModelData
    ...
    required init() {
        ...
        _modelValue = ChronoxorWowFbe.FieldModelData(buffer: buffer, offset: offset)
    }
    ...
    public func getItem(index: Int) -> (ChronoxorWowFbe.FieldModelString, ChronoxorWowFbe.FieldModelData) {
    ...
    func resize(size: Int) throws -> (ChronoxorWowFbe.FieldModelString, ChronoxorWowFbe.FieldModelData) {
    ...
    public func get(values: inout Dictionary<String, Data>) {
        values.removeAll()
