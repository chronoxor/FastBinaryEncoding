...
public class FieldModelOptionalInt8: FieldModel {
    ...
    public let value: ChronoxorWowFbe.FieldModelInt8
    ...
    public required init() {
        ...
        value = ChronoxorWowFbe.FieldModelInt8(buffer: buffer, offset: 0)
    }
    ...
    public func get(defaults: Int8? = nil) -> Int8? {
    ...
    // Set the optional value (end phase)
      ...
      public func set(value optional: Int8?) throws {
