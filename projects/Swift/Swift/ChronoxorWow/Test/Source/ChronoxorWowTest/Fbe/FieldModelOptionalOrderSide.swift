...
// Fast Binary Encoding optional OrderSide field model
public class FieldModelOptionalOrderSide: FieldModel {
    ...
    public let value: ChronoxorWowProto.FieldModelOrderSide
    ...
    public required init() {
        ...
        value = ChronoxorWowProto.FieldModelOrderSide(buffer: buffer, offset: 0)
    }
    ...
    public func get(defaults: ChronoxorWowProto.OrderSide? = nil) -> ChronoxorWowProto.OrderSide? {
    ...
    // Set the optional value (end phase)
      ...
      public func set(value optional: ChronoxorWowProto.OrderSide?) throws {
