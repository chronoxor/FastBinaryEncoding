...
class FieldModelMapStructSimpleStructNested: FieldModel {
    private let _modelKey: FieldModelStructSimple
    private let _modelValue: FieldModelStructNested
    ...
    required init() {
        ...
        _modelValue = FieldModelStructNested(buffer: buffer, offset: offset)
    }
    ...
    public func getItem(index: Int) -> (FieldModelStructSimple, FieldModelStructNested) {
    ...
    func resize(size: Int) throws -> (FieldModelStructSimple, FieldModelStructNested) {
