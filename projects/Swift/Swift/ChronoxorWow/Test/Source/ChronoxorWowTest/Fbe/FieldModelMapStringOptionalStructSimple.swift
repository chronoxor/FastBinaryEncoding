...
class FieldModelMapStringOptionalStructSimple: FieldModel {
    ...
    public func getItem(index: Int) -> (ChronoxorWowFbe.FieldModelString, FieldModelOptionalStructSimple) {
    ...
    func resize(size: Int) throws -> (ChronoxorWowFbe.FieldModelString, FieldModelOptionalStructSimple) {
