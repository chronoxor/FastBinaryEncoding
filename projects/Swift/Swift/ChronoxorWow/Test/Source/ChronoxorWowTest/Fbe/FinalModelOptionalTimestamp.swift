...
class FinalModelOptionalTimestamp: FinalModel {

    var _buffer: Buffer
    var _offset: Int

    // Base field model value
    let value: ChronoxorWowFbe.FinalModelTimestamp
    ...
    required init() {
        ...
        value = ChronoxorWowFbe.FinalModelTimestamp(buffer: buffer, offset: offset)
    }
