...
public class FieldModelOptionalUUID: FieldModel {
    ...
    public let value: ChronoxorWowFbe.FieldModelUUID
    ...
    public required init() {
        ...
        value = ChronoxorWowFbe.FieldModelUUID(buffer: buffer, offset: 0)
    }
    ...
    public func get(defaults: UUID? = nil) -> UUID? {
    ...
    // Set the optional value (end phase)
      ...
      public func set(value optional: UUID?) throws {
