...
class FieldModelMapStringOptionalFlagsSimple: FieldModel {
    private let _modelKey: ChronoxorWowFbe.FieldModelString
    private let _modelValue: FieldModelOptionalFlagsSimple
    ...
    required init() {
        ...
        _modelKey = ChronoxorWowFbe.FieldModelString(buffer: buffer, offset: offset)
        _modelValue = FieldModelOptionalFlagsSimple(buffer: buffer, offset: offset)
    }
    ...
    public func getItem(index: Int) -> (ChronoxorWowFbe.FieldModelString, FieldModelOptionalFlagsSimple) {
    ...
    func resize(size: Int) throws -> (ChronoxorWowFbe.FieldModelString, FieldModelOptionalFlagsSimple) {
    ...
    public func get(values: inout Dictionary<String, ChronoxorWowTest.FlagsSimple?>) {
        values.removeAll()
    ...
    public func set(value values: Dictionary<String, ChronoxorWowTest.FlagsSimple?>) throws {
        if _buffer.offset + fbeOffset + fbeSize > _buffer.size {
