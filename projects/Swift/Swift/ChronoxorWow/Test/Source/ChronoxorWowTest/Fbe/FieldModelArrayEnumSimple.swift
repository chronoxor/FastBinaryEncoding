...
class FieldModelArrayEnumSimple: FieldModel {
    private let _model: FieldModelEnumSimple
    ...
    required init() {
        ...
        _model = FieldModelEnumSimple(buffer: buffer, offset: offset)
    }
    ...
    public func getItem(index: Int) -> FieldModelEnumSimple {
