...
// Fast Binary Encoding UInt8 vector field model
class FieldModelVectorUInt8: FieldModel {
    private let _model: ChronoxorWowFbe.FieldModelUInt8
    ...
    required init() {
        ...
        _model = ChronoxorWowFbe.FieldModelUInt8(buffer: buffer, offset: offset)
    }
    ...
    public func getItem(index: Int) -> ChronoxorWowFbe.FieldModelUInt8 {
    ...
    func resize(size: Int) throws -> ChronoxorWowFbe.FieldModelUInt8 {
