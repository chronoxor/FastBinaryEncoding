...
public class FinalModelStructSimple: FinalModel {
    ...
    let id: ChronoxorWowFbe.FinalModelInt32
    let f1: ChronoxorWowFbe.FinalModelBoolean
    let f2: ChronoxorWowFbe.FinalModelBoolean
    let f3: ChronoxorWowFbe.FinalModelUInt8
    let f4: ChronoxorWowFbe.FinalModelUInt8
    let f5: ChronoxorWowFbe.FinalModelChar
    let f6: ChronoxorWowFbe.FinalModelChar
    let f7: ChronoxorWowFbe.FinalModelWChar
    let f8: ChronoxorWowFbe.FinalModelWChar
    let f9: ChronoxorWowFbe.FinalModelInt8
    let f10: ChronoxorWowFbe.FinalModelInt8
    let f11: ChronoxorWowFbe.FinalModelUInt8
    let f12: ChronoxorWowFbe.FinalModelUInt8
    let f13: ChronoxorWowFbe.FinalModelInt16
    let f14: ChronoxorWowFbe.FinalModelInt16
    let f15: ChronoxorWowFbe.FinalModelUInt16
    let f16: ChronoxorWowFbe.FinalModelUInt16
    let f17: ChronoxorWowFbe.FinalModelInt32
    let f18: ChronoxorWowFbe.FinalModelInt32
    let f19: ChronoxorWowFbe.FinalModelUInt32
    let f20: ChronoxorWowFbe.FinalModelUInt32
    let f21: ChronoxorWowFbe.FinalModelInt64
    let f22: ChronoxorWowFbe.FinalModelInt64
    let f23: ChronoxorWowFbe.FinalModelUInt64
    let f24: ChronoxorWowFbe.FinalModelUInt64
    let f25: ChronoxorWowFbe.FinalModelFloat
    let f26: ChronoxorWowFbe.FinalModelFloat
    let f27: ChronoxorWowFbe.FinalModelDouble
    let f28: ChronoxorWowFbe.FinalModelDouble
    let f29: ChronoxorWowFbe.FinalModelDecimal
    let f30: ChronoxorWowFbe.FinalModelDecimal
    let f31: ChronoxorWowFbe.FinalModelString
    let f32: ChronoxorWowFbe.FinalModelString
    let f33: ChronoxorWowFbe.FinalModelTimestamp
    let f34: ChronoxorWowFbe.FinalModelTimestamp
    let f35: ChronoxorWowFbe.FinalModelTimestamp
    let f36: ChronoxorWowFbe.FinalModelUUID
    let f37: ChronoxorWowFbe.FinalModelUUID
    let f38: ChronoxorWowFbe.FinalModelUUID
    let f39: ChronoxorWowProto.FinalModelOrderSide
    let f40: ChronoxorWowProto.FinalModelOrderType
    let f41: ChronoxorWowProto.FinalModelOrder
    let f42: ChronoxorWowProto.FinalModelBalance
    let f43: ChronoxorWowProto.FinalModelState
    let f44: ChronoxorWowProto.FinalModelAccount
    ...
    public required init(buffer: Buffer, offset: Int) {
        ...
        f39 = ChronoxorWowProto.FinalModelOrderSide(buffer: buffer, offset: 0)
        f40 = ChronoxorWowProto.FinalModelOrderType(buffer: buffer, offset: 0)
        f41 = ChronoxorWowProto.FinalModelOrder(buffer: buffer, offset: 0)
        f42 = ChronoxorWowProto.FinalModelBalance(buffer: buffer, offset: 0)
        f43 = ChronoxorWowProto.FinalModelState(buffer: buffer, offset: 0)
        f44 = ChronoxorWowProto.FinalModelAccount(buffer: buffer, offset: 0)
    }
