...
// Fast Binary Encoding Int32->UInt8 map field model
class FieldModelMapInt32UInt8: FieldModel {
    ...
    public func getItem(index: Int) -> (ChronoxorWowFbe.FieldModelInt32, ChronoxorWowFbe.FieldModelUInt8) {
    ...
    func resize(size: Int) throws -> (ChronoxorWowFbe.FieldModelInt32, ChronoxorWowFbe.FieldModelUInt8) {
    ...
    public func get(values: inout Dictionary<Int32, UInt8>) {
        values.removeAll()
    ...
    public func set(value values: Dictionary<Int32, UInt8>) throws {
        if _buffer.offset + fbeOffset + fbeSize > _buffer.size {
