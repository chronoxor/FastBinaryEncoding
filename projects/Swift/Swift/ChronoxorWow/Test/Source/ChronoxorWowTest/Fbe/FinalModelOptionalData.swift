...
// Fast Binary Encoding optional Data final model
class FinalModelOptionalData: FinalModel {

    var _buffer: Buffer
    var _offset: Int

    // Base field model value
    let value: ChronoxorWowFbe.FinalModelData
    ...
    required init() {
        ...
        value = ChronoxorWowFbe.FinalModelData(buffer: buffer, offset: offset)
    }
    ...
    func fbeAllocationSize(value optional: Data?) -> Int {
    ...
    public func set(value optional: Data?) throws -> Int {
        if _buffer.offset + fbeOffset + 1 > _buffer.size {
            assertionFailure("Model is broken!")
            return 0
        }
