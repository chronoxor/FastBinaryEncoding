...
public class FieldModelOptionalDouble: FieldModel {
    ...
    public let value: ChronoxorWowFbe.FieldModelDouble
    ...
    public required init() {
        ...
        value = ChronoxorWowFbe.FieldModelDouble(buffer: buffer, offset: 0)
    }
    ...
    public func get(defaults: Double? = nil) -> Double? {
    ...
    // Set the optional value (end phase)
      ...
      public func set(value optional: Double?) throws {
