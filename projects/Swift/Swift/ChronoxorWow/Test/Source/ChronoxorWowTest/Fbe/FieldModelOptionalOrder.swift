...
// Fast Binary Encoding optional Order field model
public class FieldModelOptionalOrder: FieldModel {
    ...
    public let value: ChronoxorWowProto.FieldModelOrder
    ...
    public required init() {
        ...
        value = ChronoxorWowProto.FieldModelOrder(buffer: buffer, offset: 0)
    }
    ...
    public func get(defaults: ChronoxorWowProto.Order? = nil) -> ChronoxorWowProto.Order? {
    ...
    // Set the optional value (end phase)
      ...
      public func set(value optional: ChronoxorWowProto.Order?) throws {
