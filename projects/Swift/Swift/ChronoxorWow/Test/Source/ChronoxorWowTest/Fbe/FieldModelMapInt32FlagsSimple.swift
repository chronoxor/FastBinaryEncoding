...
class FieldModelMapInt32FlagsSimple: FieldModel {
    ...
    public func getItem(index: Int) -> (ChronoxorWowFbe.FieldModelInt32, FieldModelFlagsSimple) {
    ...
    func resize(size: Int) throws -> (ChronoxorWowFbe.FieldModelInt32, FieldModelFlagsSimple) {
