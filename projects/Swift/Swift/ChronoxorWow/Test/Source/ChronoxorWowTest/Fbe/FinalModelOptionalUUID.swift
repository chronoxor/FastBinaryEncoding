...
class FinalModelOptionalUUID: FinalModel {

    var _buffer: Buffer
    var _offset: Int

    // Base field model value
    let value: ChronoxorWowFbe.FinalModelUUID
    ...
    required init() {
        ...
        value = ChronoxorWowFbe.FinalModelUUID(buffer: buffer, offset: offset)
    }
    ...
    public func set(value optional: UUID?) throws -> Int {
        if _buffer.offset + fbeOffset + 1 > _buffer.size {
            assertionFailure("Model is broken!")
            return 0
        }
