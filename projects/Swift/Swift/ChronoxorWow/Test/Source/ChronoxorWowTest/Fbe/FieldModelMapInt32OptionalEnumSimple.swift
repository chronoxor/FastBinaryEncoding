...
class FieldModelMapInt32OptionalEnumSimple: FieldModel {
    ...
    public func getItem(index: Int) -> (ChronoxorWowFbe.FieldModelInt32, FieldModelOptionalEnumSimple) {
    ...
    func resize(size: Int) throws -> (ChronoxorWowFbe.FieldModelInt32, FieldModelOptionalEnumSimple) {
    ...
    public func get(values: inout Dictionary<Int32, ChronoxorWowTest.EnumSimple?>) {
        values.removeAll()
    ...
    public func set(value values: Dictionary<Int32, ChronoxorWowTest.EnumSimple?>) throws {
        if _buffer.offset + fbeOffset + fbeSize > _buffer.size {
