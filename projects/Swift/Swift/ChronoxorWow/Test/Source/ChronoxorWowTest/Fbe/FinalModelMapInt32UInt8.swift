...
// Fast Binary Encoding Int32->UInt8 map final model
class FinalModelMapInt32UInt8: FinalModel {
    var _buffer: Buffer = Buffer()
    var _offset: Int = 0

    private var _modelKey: ChronoxorWowFbe.FinalModelInt32
    private var _modelValue: ChronoxorWowFbe.FinalModelUInt8
    ...
    init(buffer: Buffer, offset: Int) {
        ...
        _modelValue = ChronoxorWowFbe.FinalModelUInt8(buffer: buffer, offset: offset)
    }

    // Get the allocation size
    func fbeAllocationSize(value values: Dictionary<Int32, UInt8>) -> Int {
        var size: Int = 4
