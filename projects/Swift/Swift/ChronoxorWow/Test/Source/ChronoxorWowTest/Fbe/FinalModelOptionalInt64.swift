...
class FinalModelOptionalInt64: FinalModel {

    var _buffer: Buffer
    var _offset: Int

    // Base field model value
    let value: ChronoxorWowFbe.FinalModelInt64
    ...
    required init() {
        ...
        value = ChronoxorWowFbe.FinalModelInt64(buffer: buffer, offset: offset)
    }
    ...
    func fbeAllocationSize(value optional: Int64?) -> Int {
    ...
    public func set(value optional: Int64?) throws -> Int {
        if _buffer.offset + fbeOffset + 1 > _buffer.size {
            assertionFailure("Model is broken!")
            return 0
        }
