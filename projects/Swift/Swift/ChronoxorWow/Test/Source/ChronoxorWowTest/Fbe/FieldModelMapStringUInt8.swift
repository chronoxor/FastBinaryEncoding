...
// Fast Binary Encoding String->UInt8 map field model
class FieldModelMapStringUInt8: FieldModel {
    private let _modelKey: ChronoxorWowFbe.FieldModelString
    private let _modelValue: ChronoxorWowFbe.FieldModelUInt8
    ...
    required init() {
        ...
        _modelValue = ChronoxorWowFbe.FieldModelUInt8(buffer: buffer, offset: offset)
    }
    ...
    public func getItem(index: Int) -> (ChronoxorWowFbe.FieldModelString, ChronoxorWowFbe.FieldModelUInt8) {
    ...
    func resize(size: Int) throws -> (ChronoxorWowFbe.FieldModelString, ChronoxorWowFbe.FieldModelUInt8) {
    ...
    public func get(values: inout Dictionary<String, UInt8>) {
        values.removeAll()
    ...
    public func set(value values: Dictionary<String, UInt8>) throws {
        if _buffer.offset + fbeOffset + fbeSize > _buffer.size {
