...
class FieldModelMapInt32Data: FieldModel {
    ...
    public func getItem(index: Int) -> (ChronoxorWowFbe.FieldModelInt32, ChronoxorWowFbe.FieldModelData) {
    ...
    func resize(size: Int) throws -> (ChronoxorWowFbe.FieldModelInt32, ChronoxorWowFbe.FieldModelData) {
