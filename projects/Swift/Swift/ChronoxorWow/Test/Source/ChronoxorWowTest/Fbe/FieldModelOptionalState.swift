...
public class FieldModelOptionalState: FieldModel {
    ...
    public let value: ChronoxorWowProto.FieldModelState
    ...
    public required init() {
        ...
        value = ChronoxorWowProto.FieldModelState(buffer: buffer, offset: 0)
    }
    ...
    public func get(defaults: ChronoxorWowProto.State? = nil) -> ChronoxorWowProto.State? {
    ...
    // Set the optional value (end phase)
      ...
      public func set(value optional: ChronoxorWowProto.State?) throws {
