...
open class FinalSender : ChronoxorFbe.SenderProtocol { 
    ...
    public init() {
        OrderModel = ChronoxorProto.OrderFinalModel(buffer: buffer)
        BalanceModel = ChronoxorProto.BalanceFinalModel(buffer: buffer)
        AccountModel = ChronoxorProto.AccountFinalModel(buffer: buffer)
        build(with: true)
    }
