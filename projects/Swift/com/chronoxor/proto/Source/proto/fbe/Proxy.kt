    ...
    open fun onReceiveListener(listener: ProxyListener, type: Long, buffer: ByteArray, offset: Long, size: Long): Boolean
    {
        when (type)
        {
            com.chronoxor.proto.fbe.OrderModel.fbeTypeConst ->
            {
                ...
                assertionFailure(OrderModel.verify()) { "com.chronoxor.proto.Order validation failed!" }
            ...
            com.chronoxor.proto.fbe.BalanceModel.fbeTypeConst ->
            {
                ...
                assertionFailure(BalanceModel.verify()) { "com.chronoxor.proto.Balance validation failed!" }
            ...
            com.chronoxor.proto.fbe.AccountModel.fbeTypeConst ->
            {
                ...
                assertionFailure(AccountModel.verify()) { "com.chronoxor.proto.Account validation failed!" }
