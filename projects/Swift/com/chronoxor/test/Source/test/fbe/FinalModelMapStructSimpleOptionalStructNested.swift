...
class FinalModelMapStructSimpleOptionalStructNested: FinalModel {
    ...
    func fbeAllocationSize(value values: Dictionary<test.StructSimple, test.StructNested?>) -> Int {
        var size: Int = 4
    ...
    public func get(values: inout Dictionary<test.StructSimple, test.StructNested?>) -> Int {
        values.removeAll()
    ...
    public func set(value values: Dictionary<test.StructSimple, test.StructNested?>) throws -> Int {
        assert(_buffer.offset + fbeOffset + 4 <= _buffer.size, "Model is broken!")
        if _buffer.offset + fbeOffset + 4 > _buffer.size {
            return 0
        }
