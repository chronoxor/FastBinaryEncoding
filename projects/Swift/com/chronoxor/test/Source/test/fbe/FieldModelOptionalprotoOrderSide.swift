...
public class FieldModelOptionalprotoOrderSide: FieldModel {
    ...
    public func get(defaults: OrderSide? = nil) -> OrderSide? {
    ...
    // Set the optional value (end phase)
      ...
      public func set(value optional: OrderSide?) throws {
