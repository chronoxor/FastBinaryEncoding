...
class FinalModelVectorOptionalFlagsSimple: FinalModel {
    ...
    func fbeAllocationSize(value values: Array<test.FlagsSimple?>) -> Int {
        var size: Int = 4
        for value in values {
    ...
    public func get(values: inout Array<test.FlagsSimple?>) -> Int {
        values.removeAll()
    ...
    public func set(value values: Array<test.FlagsSimple?>) throws -> Int {
        assert(_buffer.offset + fbeOffset + 4 <= _buffer.size, "Model is broken!")
        if _buffer.offset + fbeOffset + 4 > _buffer.size {
            return 0
        }
