...
class FinalModelMapInt32OptionalFlagsSimple: FinalModel {
    ...
    func fbeAllocationSize(value values: Dictionary<Int32, test.FlagsSimple?>) -> Int {
        var size: Int = 4
    ...
    public func get(values: inout Dictionary<Int32, test.FlagsSimple?>) -> Int {
        values.removeAll()
    ...
    public func set(value values: Dictionary<Int32, test.FlagsSimple?>) throws -> Int {
        assert(_buffer.offset + fbeOffset + 4 <= _buffer.size, "Model is broken!")
        if _buffer.offset + fbeOffset + 4 > _buffer.size {
            return 0
        }
