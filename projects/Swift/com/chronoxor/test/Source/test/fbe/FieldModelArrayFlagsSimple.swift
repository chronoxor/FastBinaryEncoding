...
class FieldModelArrayFlagsSimple: FieldModel {
    ...
    public func get() -> Array<test.FlagsSimple> {
        var values = Array<test.FlagsSimple>()
    ...
    public func get(values: inout Array<test.FlagsSimple>) {
        values.removeAll()
    ...
    public func set(value values: Array<test.FlagsSimple>) throws {
        assert(_buffer.offset + fbeOffset + fbeSize <= _buffer.size, "Model is broken!")
        if _buffer.offset + fbeOffset + fbeSize > _buffer.size {
            return
        }
