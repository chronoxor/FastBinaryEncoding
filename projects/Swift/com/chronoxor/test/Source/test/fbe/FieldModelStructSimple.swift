...
public class FieldModelStructSimple: FieldModel {
    ...
    let f42: proto.FieldModelBalance
    let f43: proto.FieldModelState
    let f44: proto.FieldModelAccount
    ...
    public required init() {
        ...
        f39 = proto.FieldModelOrderSide(buffer: buffer, offset: f38.fbeOffset + f38.fbeSize)
        f40 = proto.FieldModelOrderType(buffer: buffer, offset: f39.fbeOffset + f39.fbeSize)
        f41 = proto.FieldModelOrder(buffer: buffer, offset: f40.fbeOffset + f40.fbeSize)
        f42 = proto.FieldModelBalance(buffer: buffer, offset: f41.fbeOffset + f41.fbeSize)
        f43 = proto.FieldModelState(buffer: buffer, offset: f42.fbeOffset + f42.fbeSize)
        f44 = proto.FieldModelAccount(buffer: buffer, offset: f43.fbeOffset + f43.fbeSize)
    ...
    public func getFields(fbeValue: inout StructSimple, fbeStructSize: Int) {
        ...
        if fbeCurrentSize + f37.fbeSize <= fbeStructSize {
            fbeValue.f37 = f37.get(defaults: fbe.UUIDGenerator.sequential())
        } else {
