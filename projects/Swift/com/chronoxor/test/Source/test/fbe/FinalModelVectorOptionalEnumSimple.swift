...
class FinalModelVectorOptionalEnumSimple: FinalModel {
    ...
    func fbeAllocationSize(value values: Array<test.EnumSimple?>) -> Int {
        var size: Int = 4
    ...
    public func get(values: inout Array<test.EnumSimple?>) -> Int {
        values.removeAll()
    ...
    public func set(value values: Array<test.EnumSimple?>) throws -> Int {
        if _buffer.offset + fbeOffset + 4 > _buffer.size {
            assertionFailure("Model is broken!")
            return 0
        }
