...
class FinalModelOptionalprotoOrderType: FinalModel {
    ...
    func fbeAllocationSize(value optional: OrderType?) -> Int {
    ...
    public func set(value optional: OrderType?) throws -> Int {
       assert(_buffer.offset + fbeOffset + 1 <= _buffer.size, "Model is broken!")
        if _buffer.offset + fbeOffset + 1 > _buffer.size {
            return 0
        }
