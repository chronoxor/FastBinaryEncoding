...
public class FieldModelOptionalprotoOrderType: FieldModel {
    ...
    public func get(defaults: OrderType? = nil) -> OrderType? {
    ...
    // Set the optional value (end phase)
      ...
      public func set(value optional: OrderType?) throws {
