...
class FieldModelOptionalBalance: FieldModel {
    ...
    let value: FieldModelBalance = FieldModelBalance()
    ...
    func get(defaults: Balance? = nil) -> Balance? {
    ...
    // Set the optional value (end phase)
      ...
      func set(optional: Balance?) throws {
