...
public class AccountMessageModel: Model {
    public let model: FieldModelAccountMessage

    public override init(buffer: Buffer = Buffer()) {
        model = FieldModelAccountMessage(buffer: buffer, offset: 4)
    ...
    static let fbeTypeConst: Int = FieldModelAccountMessage.fbeTypeConst
