...
class TestSerializationJson: XCTestCase {
    ...
    func testSerializationJsonStructSimple() {
        ...
        XCTAssertTrue(struct2.f35 > Date(timeIntervalSinceReferenceDate: 0).timeIntervalSince1970)// GregorianCalendar(2018, 1, 1).toInstant().epochSecond)
    ...
    func testSerializationJsonStructOptional() {
        ...
        XCTAssertTrue(struct2.f149! > Date(timeIntervalSinceReferenceDate: 0).timeIntervalSince1970) // GregorianCalendar(2018, 1, 1).toInstant().epochSecond)
