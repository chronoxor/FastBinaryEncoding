...
class TestCreate: XCTestCase {
    ...
    func testCreateAndAccess() {
        do {
            ...
            writer.model.asset.value.amount.set(value: 100.0)
            ...
            order.id.set(value: 1)
            try order.symbol.set(value: "EURUSD")
            order.side.set(value: OrderSide.buy)
            order.type.set(value: OrderType.market)
            order.price.set(value: 1.23456)
            order.volume.set(value: 1000.0)
            order.setEnd(fbeBegin: orderBegin)
            order.fbeShift(size: order.fbeSize)
            orderBegin = try order.setBegin()
            order.id.set(value: 2)
            try order.symbol.set(value: "EURUSD")
            order.side.set(value: OrderSide.sell)
            order.type.set(value: OrderType.limit)
            order.price.set(value: 1.0)
            order.volume.set(value: 100.0)
            order.setEnd(fbeBegin: orderBegin)
            order.fbeShift(size: order.fbeSize)
            orderBegin = try order.setBegin()
            order.id.set(value: 3)
            try order.symbol.set(value: "EURUSD")
            order.side.set(value: OrderSide.buy)
            order.type.set(value: OrderType.stop)
            order.price.set(value: 1.5)
            order.volume.set(value: 10.0)
            order.setEnd(fbeBegin: orderBegin)
            order.fbeShift(size: order.fbeSize)
