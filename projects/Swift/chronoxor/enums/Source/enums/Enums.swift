...
open class Enums: Comparable, Hashable, Codable {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        byte0 = try container.decode(EnumByte.self, forKey: .byte0)
        byte1 = try container.decode(EnumByte.self, forKey: .byte1)
        byte2 = try container.decode(EnumByte.self, forKey: .byte2)
        byte3 = try container.decode(EnumByte.self, forKey: .byte3)
        byte4 = try container.decode(EnumByte.self, forKey: .byte4)
        byte5 = try container.decode(EnumByte.self, forKey: .byte5)
        char0 = try container.decode(EnumChar.self, forKey: .char0)
        char1 = try container.decode(EnumChar.self, forKey: .char1)
        char2 = try container.decode(EnumChar.self, forKey: .char2)
        char3 = try container.decode(EnumChar.self, forKey: .char3)
        char4 = try container.decode(EnumChar.self, forKey: .char4)
        char5 = try container.decode(EnumChar.self, forKey: .char5)
        wchar0 = try container.decode(EnumWChar.self, forKey: .wchar0)
        wchar1 = try container.decode(EnumWChar.self, forKey: .wchar1)
        wchar2 = try container.decode(EnumWChar.self, forKey: .wchar2)
        wchar3 = try container.decode(EnumWChar.self, forKey: .wchar3)
        wchar4 = try container.decode(EnumWChar.self, forKey: .wchar4)
        wchar5 = try container.decode(EnumWChar.self, forKey: .wchar5)
        int8b0 = try container.decode(EnumInt8.self, forKey: .int8b0)
        int8b1 = try container.decode(EnumInt8.self, forKey: .int8b1)
        int8b2 = try container.decode(EnumInt8.self, forKey: .int8b2)
        int8b3 = try container.decode(EnumInt8.self, forKey: .int8b3)
        int8b4 = try container.decode(EnumInt8.self, forKey: .int8b4)
        int8b5 = try container.decode(EnumInt8.self, forKey: .int8b5)
        uint8b0 = try container.decode(EnumUInt8.self, forKey: .uint8b0)
        uint8b1 = try container.decode(EnumUInt8.self, forKey: .uint8b1)
        uint8b2 = try container.decode(EnumUInt8.self, forKey: .uint8b2)
        uint8b3 = try container.decode(EnumUInt8.self, forKey: .uint8b3)
        uint8b4 = try container.decode(EnumUInt8.self, forKey: .uint8b4)
        uint8b5 = try container.decode(EnumUInt8.self, forKey: .uint8b5)
        int16b0 = try container.decode(EnumInt16.self, forKey: .int16b0)
        int16b1 = try container.decode(EnumInt16.self, forKey: .int16b1)
        int16b2 = try container.decode(EnumInt16.self, forKey: .int16b2)
        int16b3 = try container.decode(EnumInt16.self, forKey: .int16b3)
        int16b4 = try container.decode(EnumInt16.self, forKey: .int16b4)
        int16b5 = try container.decode(EnumInt16.self, forKey: .int16b5)
        uint16b0 = try container.decode(EnumUInt16.self, forKey: .uint16b0)
        uint16b1 = try container.decode(EnumUInt16.self, forKey: .uint16b1)
        uint16b2 = try container.decode(EnumUInt16.self, forKey: .uint16b2)
        uint16b3 = try container.decode(EnumUInt16.self, forKey: .uint16b3)
        uint16b4 = try container.decode(EnumUInt16.self, forKey: .uint16b4)
        uint16b5 = try container.decode(EnumUInt16.self, forKey: .uint16b5)
        int32b0 = try container.decode(EnumInt32.self, forKey: .int32b0)
        int32b1 = try container.decode(EnumInt32.self, forKey: .int32b1)
        int32b2 = try container.decode(EnumInt32.self, forKey: .int32b2)
        int32b3 = try container.decode(EnumInt32.self, forKey: .int32b3)
        int32b4 = try container.decode(EnumInt32.self, forKey: .int32b4)
        int32b5 = try container.decode(EnumInt32.self, forKey: .int32b5)
        uint32b0 = try container.decode(EnumUInt32.self, forKey: .uint32b0)
        uint32b1 = try container.decode(EnumUInt32.self, forKey: .uint32b1)
        uint32b2 = try container.decode(EnumUInt32.self, forKey: .uint32b2)
        uint32b3 = try container.decode(EnumUInt32.self, forKey: .uint32b3)
        uint32b4 = try container.decode(EnumUInt32.self, forKey: .uint32b4)
        uint32b5 = try container.decode(EnumUInt32.self, forKey: .uint32b5)
        int64b0 = try container.decode(EnumInt64.self, forKey: .int64b0)
        int64b1 = try container.decode(EnumInt64.self, forKey: .int64b1)
        int64b2 = try container.decode(EnumInt64.self, forKey: .int64b2)
        int64b3 = try container.decode(EnumInt64.self, forKey: .int64b3)
        int64b4 = try container.decode(EnumInt64.self, forKey: .int64b4)
        int64b5 = try container.decode(EnumInt64.self, forKey: .int64b5)
        uint64b0 = try container.decode(EnumUInt64.self, forKey: .uint64b0)
        uint64b1 = try container.decode(EnumUInt64.self, forKey: .uint64b1)
        uint64b2 = try container.decode(EnumUInt64.self, forKey: .uint64b2)
        uint64b3 = try container.decode(EnumUInt64.self, forKey: .uint64b3)
        uint64b4 = try container.decode(EnumUInt64.self, forKey: .uint64b4)
        uint64b5 = try container.decode(EnumUInt64.self, forKey: .uint64b5)
    }
