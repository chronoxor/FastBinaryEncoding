...
open class StructSimple: Comparable, Hashable, Codable {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        f39 = try container.decode(proto.OrderSide.self, forKey: .f39)
        f40 = try container.decode(proto.OrderType.self, forKey: .f40)
        f41 = try container.decode(proto.Order.self, forKey: .f41)
        f42 = try container.decode(proto.Balance.self, forKey: .f42)
        f43 = try container.decode(proto.State.self, forKey: .f43)
        f44 = try container.decode(proto.Account.self, forKey: .f44)
    }
