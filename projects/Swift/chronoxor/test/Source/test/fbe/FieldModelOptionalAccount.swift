...
public class FieldModelOptionalAccount: FieldModel {
    ...
    public let value: proto.FieldModelAccount
    ...
    public required init() {
        ...
        value = proto.FieldModelAccount(buffer: buffer, offset: 0)
    }
    ...
    public func get(defaults: proto.Account? = nil) -> proto.Account? {
    ...
    // Set the optional value (end phase)
      ...
      public func set(value optional: proto.Account?) throws {
