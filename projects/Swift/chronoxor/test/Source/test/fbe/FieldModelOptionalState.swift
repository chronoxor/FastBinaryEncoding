...
public class FieldModelOptionalState: FieldModel {
    ...
    public let value: proto.FieldModelState
    ...
    public required init() {
        ...
        value = proto.FieldModelState(buffer: buffer, offset: 0)
    }
    ...
    public func get(defaults: proto.State? = nil) -> proto.State? {
    ...
    // Set the optional value (end phase)
      ...
      public func set(value optional: proto.State?) throws {
