...
class FinalModelOptionalOrderType: FinalModel {
    ...
    let value: proto.FinalModelOrderType
    ...
    required init() {
        ...
        value = proto.FinalModelOrderType(buffer: buffer, offset: offset)
    }
    ...
    func fbeAllocationSize(value optional: proto.OrderType?) -> Int {
    ...
    public func get(size: inout Size) -> proto.OrderType? {
        if _buffer.offset + fbeOffset + 1 > _buffer.size {
    ...
    public func set(value optional: proto.OrderType?) throws -> Int {
        if _buffer.offset + fbeOffset + 1 > _buffer.size {
            assertionFailure("Model is broken!")
            return 0
        }
