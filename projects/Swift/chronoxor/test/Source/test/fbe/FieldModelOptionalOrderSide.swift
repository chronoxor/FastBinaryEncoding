...
public class FieldModelOptionalOrderSide: FieldModel {
    ...
    public let value: proto.FieldModelOrderSide
    ...
    public required init() {
        ...
        value = proto.FieldModelOrderSide(buffer: buffer, offset: 0)
    }
    ...
    public func get(defaults: proto.OrderSide? = nil) -> proto.OrderSide? {
    ...
    // Set the optional value (end phase)
      ...
      public func set(value optional: proto.OrderSide?) throws {
