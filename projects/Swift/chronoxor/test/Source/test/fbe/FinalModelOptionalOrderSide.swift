...
class FinalModelOptionalOrderSide: FinalModel {
    ...
    let value: proto.FinalModelOrderSide
    ...
    required init() {
        ...
        value = proto.FinalModelOrderSide(buffer: buffer, offset: offset)
    }
    ...
    func fbeAllocationSize(value optional: proto.OrderSide?) -> Int {
    ...
    public func get(size: inout Size) -> proto.OrderSide? {
        if _buffer.offset + fbeOffset + 1 > _buffer.size {
    ...
    public func set(value optional: proto.OrderSide?) throws -> Int {
        if _buffer.offset + fbeOffset + 1 > _buffer.size {
            assertionFailure("Model is broken!")
            return 0
        }
