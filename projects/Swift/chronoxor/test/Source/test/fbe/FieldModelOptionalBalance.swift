...
public class FieldModelOptionalBalance: FieldModel {
    ...
    public let value: proto.FieldModelBalance
    ...
    public required init() {
        ...
        value = proto.FieldModelBalance(buffer: buffer, offset: 0)
    }
    ...
    public func get(defaults: proto.Balance? = nil) -> proto.Balance? {
    ...
    // Set the optional value (end phase)
      ...
      public func set(value optional: proto.Balance?) throws {
