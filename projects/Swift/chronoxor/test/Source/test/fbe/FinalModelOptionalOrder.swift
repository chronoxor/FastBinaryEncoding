...
class FinalModelOptionalOrder: FinalModel {
    ...
    let value: proto.FinalModelOrder
    ...
    required init() {
        ...
        value = proto.FinalModelOrder(buffer: buffer, offset: offset)
    }
    ...
    func fbeAllocationSize(value optional: proto.Order?) -> Int {
    ...
    public func get(size: inout Size) -> proto.Order? {
        if _buffer.offset + fbeOffset + 1 > _buffer.size {
    ...
    public func set(value optional: proto.Order?) throws -> Int {
        if _buffer.offset + fbeOffset + 1 > _buffer.size {
            assertionFailure("Model is broken!")
            return 0
        }
