...
class FieldModelMapInt32OptionalFlagsSimple: FieldModel {
    ...
    public func getItem(index: Int) -> (fbe.FieldModelInt32, FieldModelOptionalFlagsSimple) {
    ...
    func resize(size: Int) throws -> (fbe.FieldModelInt32, FieldModelOptionalFlagsSimple) {
    ...
    public func get(values: inout Dictionary<Int32, test.FlagsSimple?>) {
        values.removeAll()
    ...
    public func set(value values: Dictionary<Int32, test.FlagsSimple?>) throws {
        if _buffer.offset + fbeOffset + fbeSize > _buffer.size {
