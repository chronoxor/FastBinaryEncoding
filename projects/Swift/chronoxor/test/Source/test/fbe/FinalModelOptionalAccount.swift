...
class FinalModelOptionalAccount: FinalModel {
    ...
    let value: proto.FinalModelAccount
    ...
    required init() {
        ...
        value = proto.FinalModelAccount(buffer: buffer, offset: offset)
    }
    ...
    func fbeAllocationSize(value optional: proto.Account?) -> Int {
    ...
    public func get(size: inout Size) -> proto.Account? {
        if _buffer.offset + fbeOffset + 1 > _buffer.size {
    ...
    public func set(value optional: proto.Account?) throws -> Int {
        if _buffer.offset + fbeOffset + 1 > _buffer.size {
            assertionFailure("Model is broken!")
            return 0
        }
