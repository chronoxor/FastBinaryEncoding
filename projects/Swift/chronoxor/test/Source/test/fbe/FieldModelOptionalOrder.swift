...
public class FieldModelOptionalOrder: FieldModel {
    ...
    public let value: proto.FieldModelOrder
    ...
    public required init() {
        ...
        value = proto.FieldModelOrder(buffer: buffer, offset: 0)
    }
    ...
    public func get(defaults: proto.Order? = nil) -> proto.Order? {
    ...
    // Set the optional value (end phase)
      ...
      public func set(value optional: proto.Order?) throws {
