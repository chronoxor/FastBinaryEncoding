...
class FinalModelOptionalBalance: FinalModel {
    ...
    let value: proto.FinalModelBalance
    ...
    required init() {
        ...
        value = proto.FinalModelBalance(buffer: buffer, offset: offset)
    }
    ...
    func fbeAllocationSize(value optional: proto.Balance?) -> Int {
    ...
    public func get(size: inout Size) -> proto.Balance? {
        if _buffer.offset + fbeOffset + 1 > _buffer.size {
    ...
    public func set(value optional: proto.Balance?) throws -> Int {
        if _buffer.offset + fbeOffset + 1 > _buffer.size {
            assertionFailure("Model is broken!")
            return 0
        }
