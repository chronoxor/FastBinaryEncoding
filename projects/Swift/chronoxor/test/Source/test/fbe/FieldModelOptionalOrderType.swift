...
public class FieldModelOptionalOrderType: FieldModel {
    ...
    public let value: proto.FieldModelOrderType
    ...
    public required init() {
        ...
        value = proto.FieldModelOrderType(buffer: buffer, offset: 0)
    }
    ...
    public func get(defaults: proto.OrderType? = nil) -> proto.OrderType? {
    ...
    // Set the optional value (end phase)
      ...
      public func set(value optional: proto.OrderType?) throws {
