...
public class FinalModelStructSimple: FinalModel {
    ...
    let f1: FinalModelBoolean
    let f2: FinalModelBoolean
    let f3: FinalModelUInt8
    let f4: FinalModelUInt8
    let f5: FinalModelChar
    let f6: FinalModelChar
    let f7: FinalModelWChar
    let f8: FinalModelWChar
    let f9: FinalModelInt8
    let f10: FinalModelInt8
    let f11: FinalModelUInt8
    let f12: FinalModelUInt8
    let f13: FinalModelInt16
    let f14: FinalModelInt16
    let f15: FinalModelUInt16
    let f16: FinalModelUInt16
    let f17: FinalModelInt32
    let f18: FinalModelInt32
    let f19: FinalModelUInt32
    let f20: FinalModelUInt32
    let f21: FinalModelInt64
    let f22: FinalModelInt64
    let f23: FinalModelUInt64
    let f24: FinalModelUInt64
    let f25: FinalModelFloat
    let f26: FinalModelFloat
    let f27: FinalModelDouble
    let f28: FinalModelDouble
    let f29: FinalModelDecimal
    let f30: FinalModelDecimal
    let f31: FinalModelString
    let f32: FinalModelString
    let f33: FinalModelTimestamp
    let f34: FinalModelTimestamp
    let f35: FinalModelTimestamp
    let f36: FinalModelUUID
    let f37: FinalModelUUID
    let f38: FinalModelUUID
