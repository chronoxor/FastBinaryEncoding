...
class FinalModelVectorOrder: FinalModel {
    ...
    func fbeAllocationSize(value values: Array<protoex.Order>) -> Int {
        var size: Int = 4
    ...
    public func get(values: inout Array<protoex.Order>) -> Int {
        values.removeAll()
    ...
    public func set(value values: Array<protoex.Order>) throws -> Int {
        if _buffer.offset + fbeOffset + 4 > _buffer.size {
            assertionFailure("Model is broken!")
            return 0
        }
