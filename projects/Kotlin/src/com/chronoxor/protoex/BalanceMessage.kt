...
open class BalanceMessage : Comparable<Any?>
{
    ...
    @Transient open var fbeType: Long = 12
    ...
    open fun clone(): BalanceMessage
    {
        ...
        val writer = com.chronoxor.protoex.fbe.BalanceMessageModel()
        writer.serialize(this)

        // Deserialize the struct from the FBE stream
        val reader = com.chronoxor.protoex.fbe.BalanceMessageModel()
    ...
    companion object
    {
        ...
        fun fromJson(json: String): BalanceMessage = com.chronoxor.protoex.fbe.Json.engine.fromJson(json, BalanceMessage::class.java)
    }
}
