...
class FieldModelOrderMessage(buffer: com.chronoxor.fbe.Buffer, offset: Long) : com.chronoxor.fbe.FieldModel(buffer, offset)
{
    val body: FieldModelOrder = FieldModelOrder(buffer, 4 + 4)
    ...
    fun get(fbeValue: com.chronoxor.protoex.OrderMessage = com.chronoxor.protoex.OrderMessage()): com.chronoxor.protoex.OrderMessage
    {
    ...
    @Suppress("UNUSED_PARAMETER")
    fun getFields(fbeValue: com.chronoxor.protoex.OrderMessage, fbeStructSize: Long)
    {
        var fbeCurrentSize = 4L + 4L
        ...
        if ((fbeCurrentSize + body.fbeSize) <= fbeStructSize)
            ...
            fbeValue.body = com.chronoxor.protoex.Order()
        fbeCurrentSize += body.fbeSize
    }
    ...
    fun set(fbeValue: com.chronoxor.protoex.OrderMessage)
    {
    ...
    @Suppress("UNUSED_PARAMETER")
    fun setFields(fbeValue: com.chronoxor.protoex.OrderMessage)
    {
