...
class BalanceMessageModel : com.chronoxor.fbe.Model
{
    ...
    fun serialize(value: com.chronoxor.protoex.BalanceMessage): Long
    {
    ...
    fun deserialize(): com.chronoxor.protoex.BalanceMessage { val value = com.chronoxor.protoex.BalanceMessage(); deserialize(value); return value }
    @Suppress("UNUSED_VALUE")
    fun deserialize(value: com.chronoxor.protoex.BalanceMessage): Long
    {
        var valueRef = value

        if ((buffer.offset + model.fbeOffset - 4) > buffer.size)
        {
            valueRef = com.chronoxor.protoex.BalanceMessage()
            return 0
        }
