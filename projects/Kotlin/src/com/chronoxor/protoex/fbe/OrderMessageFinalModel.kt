...
class OrderMessageFinalModel : com.chronoxor.fbe.Model
{
    private val _model: FinalModelOrderMessage

    constructor() { _model = FinalModelOrderMessage(buffer, 8) }
    constructor(buffer: com.chronoxor.fbe.Buffer) : super(buffer) { _model = FinalModelOrderMessage(buffer, 8) }
    ...
    companion object
    {
        const val fbeTypeConst: Long = FinalModelOrderMessage.fbeTypeConst
    }
    ...
    fun serialize(value: com.chronoxor.protoex.OrderMessage): Long
    {
    ...
    fun deserialize(): com.chronoxor.protoex.OrderMessage { val value = com.chronoxor.protoex.OrderMessage(); deserialize(value); return value }
    @Suppress("UNUSED_VALUE")
    fun deserialize(value: com.chronoxor.protoex.OrderMessage): Long
    {
        var valueRef = value
