...
class FinalModelBalanceMessage(buffer: com.chronoxor.fbe.Buffer, offset: Long) : com.chronoxor.fbe.FinalModel(buffer, offset)
{
    ...
    fun fbeAllocationSize(fbeValue: com.chronoxor.protoex.BalanceMessage): Long = (0
    ...
    fun get(fbeSize: com.chronoxor.fbe.Size, fbeValue: com.chronoxor.protoex.BalanceMessage = com.chronoxor.protoex.BalanceMessage()): com.chronoxor.protoex.BalanceMessage
    {
        _buffer.shift(fbeOffset)
    ...
    @Suppress("UNUSED_PARAMETER")
    fun getFields(fbeValue: com.chronoxor.protoex.BalanceMessage): Long
    {
        var fbeCurrentOffset = 0L
    ...
    fun set(fbeValue: com.chronoxor.protoex.BalanceMessage): Long
    {
        _buffer.shift(fbeOffset)
    ...
    @Suppress("UNUSED_PARAMETER")
    fun setFields(fbeValue: com.chronoxor.protoex.BalanceMessage): Long
    {
        var fbeCurrentOffset = 0L
        var fbeCurrentSize = 0L
        val fbeFieldSize = com.chronoxor.fbe.Size()
