...
class FieldModelAccountMessage(buffer: com.chronoxor.fbe.Buffer, offset: Long) : com.chronoxor.fbe.FieldModel(buffer, offset)
{
    ...
    fun get(fbeValue: com.chronoxor.protoex.AccountMessage = com.chronoxor.protoex.AccountMessage()): com.chronoxor.protoex.AccountMessage
    {
    ...
    @Suppress("UNUSED_PARAMETER")
    fun getFields(fbeValue: com.chronoxor.protoex.AccountMessage, fbeStructSize: Long)
    {
        var fbeCurrentSize = 4L + 4L
        ...
        if ((fbeCurrentSize + body.fbeSize) <= fbeStructSize)
            ...
            fbeValue.body = com.chronoxor.protoex.Account()
        fbeCurrentSize += body.fbeSize
    }
    ...
    fun set(fbeValue: com.chronoxor.protoex.AccountMessage)
    {
    ...
    @Suppress("UNUSED_PARAMETER")
    fun setFields(fbeValue: com.chronoxor.protoex.AccountMessage)
    {
