...
class FieldModelVectorOrder(buffer: com.chronoxor.fbe.Buffer, offset: Long) : com.chronoxor.fbe.FieldModel(buffer, offset)
{
    ...
    operator fun get(values: java.util.ArrayList<com.chronoxor.protoex.Order>)
    {
        values.clear()
    ...
    operator fun get(values: java.util.LinkedList<com.chronoxor.protoex.Order>)
    {
        values.clear()
    ...
    operator fun get(values: java.util.HashSet<com.chronoxor.protoex.Order>)
    {
        values.clear()
    ...
    fun set(values: java.util.ArrayList<com.chronoxor.protoex.Order>)
    {
        assert((_buffer.offset + fbeOffset + fbeSize) <= _buffer.size) { "Model is broken!" }
        if ((_buffer.offset + fbeOffset + fbeSize) > _buffer.size)
            return
    ...
    fun set(values: java.util.LinkedList<com.chronoxor.protoex.Order>)
    {
        assert((_buffer.offset + fbeOffset + fbeSize) <= _buffer.size) { "Model is broken!" }
        if ((_buffer.offset + fbeOffset + fbeSize) > _buffer.size)
            return
    ...
    fun set(values: java.util.HashSet<com.chronoxor.protoex.Order>)
    {
        assert((_buffer.offset + fbeOffset + fbeSize) <= _buffer.size) { "Model is broken!" }
        if ((_buffer.offset + fbeOffset + fbeSize) > _buffer.size)
            return
