...
class FieldModelBalanceMessage(buffer: com.chronoxor.fbe.Buffer, offset: Long) : com.chronoxor.fbe.FieldModel(buffer, offset)
{
    val body: FieldModelBalance = FieldModelBalance(buffer, 4 + 4)
    ...
    companion object
    {
        const val fbeTypeConst: Long = 12
    }
    ...
    fun get(fbeValue: com.chronoxor.protoex.BalanceMessage = com.chronoxor.protoex.BalanceMessage()): com.chronoxor.protoex.BalanceMessage
    {
    ...
    @Suppress("UNUSED_PARAMETER")
    fun getFields(fbeValue: com.chronoxor.protoex.BalanceMessage, fbeStructSize: Long)
    {
        var fbeCurrentSize = 4L + 4L
        ...
        if ((fbeCurrentSize + body.fbeSize) <= fbeStructSize)
            ...
            fbeValue.body = com.chronoxor.protoex.Balance()
        fbeCurrentSize += body.fbeSize
    }
    ...
    fun set(fbeValue: com.chronoxor.protoex.BalanceMessage)
    {
    ...
    @Suppress("UNUSED_PARAMETER")
    fun setFields(fbeValue: com.chronoxor.protoex.BalanceMessage)
    {
