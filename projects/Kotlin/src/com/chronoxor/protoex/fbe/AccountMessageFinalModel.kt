...
class AccountMessageFinalModel : com.chronoxor.fbe.Model
{
    private val _model: FinalModelAccountMessage

    constructor() { _model = FinalModelAccountMessage(buffer, 8) }
    constructor(buffer: com.chronoxor.fbe.Buffer) : super(buffer) { _model = FinalModelAccountMessage(buffer, 8) }
    ...
    companion object
    {
        const val fbeTypeConst: Long = FinalModelAccountMessage.fbeTypeConst
    }
