...
class FieldModelOptionalBalance(buffer: com.chronoxor.fbe.Buffer, offset: Long) : com.chronoxor.fbe.FieldModel(buffer, offset)
{
    ...
    val value = FieldModelBalance(buffer, 0)
    ...
    fun get(defaults: com.chronoxor.protoex.Balance? = null): com.chronoxor.protoex.Balance?
    {
    ...
    fun set(optional: com.chronoxor.protoex.Balance?)
    {
