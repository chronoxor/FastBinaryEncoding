...
class FieldModelVectorStructSimple(buffer: com.chronoxor.fbe.Buffer, offset: Long) : com.chronoxor.fbe.FieldModel(buffer, offset)
{
    ...
    fun resize(size: Long): FieldModelStructSimple
    {
    ...
    operator fun get(values: java.util.ArrayList<com.chronoxor.test.StructSimple>)
    {
        values.clear()
    ...
    operator fun get(values: java.util.LinkedList<com.chronoxor.test.StructSimple>)
    {
        values.clear()
    ...
    operator fun get(values: java.util.HashSet<com.chronoxor.test.StructSimple>)
    {
        values.clear()
    ...
    fun set(values: java.util.LinkedList<com.chronoxor.test.StructSimple>)
    {
        assert((_buffer.offset + fbeOffset + fbeSize) <= _buffer.size) { "Model is broken!" }
        if ((_buffer.offset + fbeOffset + fbeSize) > _buffer.size)
            return
    ...
    fun set(values: java.util.HashSet<com.chronoxor.test.StructSimple>)
    {
        assert((_buffer.offset + fbeOffset + fbeSize) <= _buffer.size) { "Model is broken!" }
        if ((_buffer.offset + fbeOffset + fbeSize) > _buffer.size)
            return
