...
class FinalModelMapInt32Byte(buffer: com.chronoxor.fbe.Buffer, offset: Long) : com.chronoxor.fbe.FinalModel(buffer, offset)
{
    private val _modelKey = com.chronoxor.fbe.FinalModelInt32(buffer, offset)
    private val _modelValue = com.chronoxor.fbe.FinalModelByte(buffer, offset)

    // Get the allocation size
    fun fbeAllocationSize(values: java.util.TreeMap<Int, Byte>): Long
    {
        var size: Long = 4
    ...
    fun fbeAllocationSize(values: java.util.HashMap<Int, Byte>): Long
    {
        var size: Long = 4
        for ((key, value1) in values)
        {
    ...
    fun get(values: java.util.TreeMap<Int, Byte>): Long
    {
        values.clear()
    ...
    fun get(values: java.util.HashMap<Int, Byte>): Long
    {
        values.clear()
    ...
    fun set(values: java.util.TreeMap<Int, Byte>): Long
    {
        assert((_buffer.offset + fbeOffset + 4) <= _buffer.size) { "Model is broken!" }
        if ((_buffer.offset + fbeOffset + 4) > _buffer.size)
            return 0
    ...
    fun set(values: java.util.HashMap<Int, Byte>): Long
    {
        assert((_buffer.offset + fbeOffset + 4) <= _buffer.size) { "Model is broken!" }
        if ((_buffer.offset + fbeOffset + 4) > _buffer.size)
            return 0
