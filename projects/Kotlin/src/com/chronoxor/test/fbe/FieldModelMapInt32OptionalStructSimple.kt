...
class FieldModelMapInt32OptionalStructSimple(buffer: com.chronoxor.fbe.Buffer, offset: Long) : com.chronoxor.fbe.FieldModel(buffer, offset)
{
    ...
    // Map index operator
    fun getItem(index: Long): Pair<com.chronoxor.fbe.FieldModelInt32, FieldModelOptionalStructSimple>
    {
    ...
    fun resize(size: Long): Pair<com.chronoxor.fbe.FieldModelInt32, FieldModelOptionalStructSimple>
    {
    ...
    fun get(values: java.util.TreeMap<Int, com.chronoxor.test.StructSimple?>)
    {
        values.clear()
    ...
    fun get(values: java.util.HashMap<Int, com.chronoxor.test.StructSimple?>)
    {
        values.clear()
    ...
    fun set(values: java.util.TreeMap<Int, com.chronoxor.test.StructSimple?>)
    {
        assert((_buffer.offset + fbeOffset + fbeSize) <= _buffer.size) { "Model is broken!" }
        if ((_buffer.offset + fbeOffset + fbeSize) > _buffer.size)
            return
    ...
    fun set(values: java.util.HashMap<Int, com.chronoxor.test.StructSimple?>)
    {
        assert((_buffer.offset + fbeOffset + fbeSize) <= _buffer.size) { "Model is broken!" }
        if ((_buffer.offset + fbeOffset + fbeSize) > _buffer.size)
            return
