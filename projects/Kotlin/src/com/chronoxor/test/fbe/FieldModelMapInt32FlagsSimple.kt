...
class FieldModelMapInt32FlagsSimple(buffer: com.chronoxor.fbe.Buffer, offset: Long) : com.chronoxor.fbe.FieldModel(buffer, offset)
{
    ...
    // Map index operator
    fun getItem(index: Long): Pair<com.chronoxor.fbe.FieldModelInt32, FieldModelFlagsSimple>
    {
    ...
    fun resize(size: Long): Pair<com.chronoxor.fbe.FieldModelInt32, FieldModelFlagsSimple>
    {
