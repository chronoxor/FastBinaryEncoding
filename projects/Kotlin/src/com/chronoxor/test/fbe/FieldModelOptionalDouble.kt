...
class FieldModelOptionalDouble(buffer: com.chronoxor.fbe.Buffer, offset: Long) : com.chronoxor.fbe.FieldModel(buffer, offset)
{
    // Field size
    ...
    val value = com.chronoxor.fbe.FieldModelDouble(buffer, 0)
    ...
    fun get(defaults: Double? = null): Double?
    {
