...
class FieldModelMapStringOptionalFlagsSimple(buffer: com.chronoxor.fbe.Buffer, offset: Long) : com.chronoxor.fbe.FieldModel(buffer, offset)
{
    ...
    // Map index operator
    fun getItem(index: Long): Pair<com.chronoxor.fbe.FieldModelString, FieldModelOptionalFlagsSimple>
    {
    ...
    fun resize(size: Long): Pair<com.chronoxor.fbe.FieldModelString, FieldModelOptionalFlagsSimple>
    {
    ...
    fun get(values: java.util.TreeMap<String, com.chronoxor.test.FlagsSimple?>)
    {
        values.clear()
    ...
    fun get(values: java.util.HashMap<String, com.chronoxor.test.FlagsSimple?>)
    {
        values.clear()
    ...
    fun set(values: java.util.TreeMap<String, com.chronoxor.test.FlagsSimple?>)
    {
        assert((_buffer.offset + fbeOffset + fbeSize) <= _buffer.size) { "Model is broken!" }
        if ((_buffer.offset + fbeOffset + fbeSize) > _buffer.size)
            return
    ...
    fun set(values: java.util.HashMap<String, com.chronoxor.test.FlagsSimple?>)
    {
        assert((_buffer.offset + fbeOffset + fbeSize) <= _buffer.size) { "Model is broken!" }
        if ((_buffer.offset + fbeOffset + fbeSize) > _buffer.size)
            return
