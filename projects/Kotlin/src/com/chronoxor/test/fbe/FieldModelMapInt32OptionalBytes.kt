...
class FieldModelMapInt32OptionalBytes(buffer: com.chronoxor.fbe.Buffer, offset: Long) : com.chronoxor.fbe.FieldModel(buffer, offset)
{
    private val _modelKey = com.chronoxor.fbe.FieldModelInt32(buffer, offset)
    private val _modelValue = FieldModelOptionalBytes(buffer, offset)
    ...
    // Map index operator
    fun getItem(index: Long): Pair<com.chronoxor.fbe.FieldModelInt32, FieldModelOptionalBytes>
    {
    ...
    fun resize(size: Long): Pair<com.chronoxor.fbe.FieldModelInt32, FieldModelOptionalBytes>
    {
    ...
    fun get(values: java.util.TreeMap<Int, ByteArray?>)
    {
        values.clear()
    ...
    fun get(values: java.util.HashMap<Int, ByteArray?>)
    {
        values.clear()
    ...
    fun set(values: java.util.TreeMap<Int, ByteArray?>)
    {
        assert((_buffer.offset + fbeOffset + fbeSize) <= _buffer.size) { "Model is broken!" }
        if ((_buffer.offset + fbeOffset + fbeSize) > _buffer.size)
            return
    ...
    fun set(values: java.util.HashMap<Int, ByteArray?>)
    {
        assert((_buffer.offset + fbeOffset + fbeSize) <= _buffer.size) { "Model is broken!" }
        if ((_buffer.offset + fbeOffset + fbeSize) > _buffer.size)
            return
