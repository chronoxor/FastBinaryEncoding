...
class FinalModelArrayEnumSimple(buffer: com.chronoxor.fbe.Buffer, offset: Long, private val _size: Long) : com.chronoxor.fbe.FinalModel(buffer, offset)
{
    ...
    {
        val values = Array(_size.toInt()) { com.chronoxor.test.EnumSimple() }
