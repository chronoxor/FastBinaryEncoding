...
class FieldModelArrayOptionalFlagsSimple(buffer: com.chronoxor.fbe.Buffer, offset: Long, val size: Long) : com.chronoxor.fbe.FieldModel(buffer, offset)
{
    ...
    {
        val values = arrayOfNulls<com.chronoxor.test.FlagsSimple?>(size.toInt())
