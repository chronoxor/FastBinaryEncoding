...
class FinalModelStructVector(buffer: com.chronoxor.fbe.Buffer, offset: Long) : com.chronoxor.fbe.FinalModel(buffer, offset)
{
    ...
    fun fbeAllocationSize(fbeValue: com.chronoxor.test.StructVector): Long = (0
    ...
    fun get(fbeSize: com.chronoxor.fbe.Size, fbeValue: com.chronoxor.test.StructVector = com.chronoxor.test.StructVector()): com.chronoxor.test.StructVector
    {
        _buffer.shift(fbeOffset)
    ...
    @Suppress("UNUSED_PARAMETER")
    fun getFields(fbeValue: com.chronoxor.test.StructVector): Long
    {
        var fbeCurrentOffset = 0L
    ...
    fun set(fbeValue: com.chronoxor.test.StructVector): Long
    {
        _buffer.shift(fbeOffset)
    ...
    @Suppress("UNUSED_PARAMETER")
    fun setFields(fbeValue: com.chronoxor.test.StructVector): Long
    {
        var fbeCurrentOffset = 0L
        var fbeCurrentSize = 0L
        val fbeFieldSize = com.chronoxor.fbe.Size()
