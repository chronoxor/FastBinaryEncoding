...
class FinalModelOptionalWChar(buffer: com.chronoxor.fbe.Buffer, offset: Long) : com.chronoxor.fbe.FinalModel(buffer, offset)
{
    ...
    val value = com.chronoxor.fbe.FinalModelWChar(buffer, 0)
    ...
    fun get(size: com.chronoxor.fbe.Size): Char?
    {
