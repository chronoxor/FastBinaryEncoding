...
class FieldModelMapInt32OptionalEnumSimple(buffer: com.chronoxor.fbe.Buffer, offset: Long) : com.chronoxor.fbe.FieldModel(buffer, offset)
{
    ...
    // Map index operator
    fun getItem(index: Long): Pair<com.chronoxor.fbe.FieldModelInt32, FieldModelOptionalEnumSimple>
    {
    ...
    fun resize(size: Long): Pair<com.chronoxor.fbe.FieldModelInt32, FieldModelOptionalEnumSimple>
    {
