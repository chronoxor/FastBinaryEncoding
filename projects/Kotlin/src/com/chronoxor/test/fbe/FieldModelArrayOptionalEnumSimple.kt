...
class FieldModelArrayOptionalEnumSimple(buffer: com.chronoxor.fbe.Buffer, offset: Long, val size: Long) : com.chronoxor.fbe.FieldModel(buffer, offset)
{
    ...
    // Get the array
    fun get(): Array<com.chronoxor.test.EnumSimple?>
    {
        val values = arrayOfNulls<com.chronoxor.test.EnumSimple?>(size.toInt())
    ...
    // Get the array
    fun get(values: Array<com.chronoxor.test.EnumSimple?>)
    {
        val fbeModel = getItem(0)
        var i: Long = 0
    ...
    fun get(values: java.util.ArrayList<com.chronoxor.test.EnumSimple?>)
    {
        values.clear()
    ...
    // Set the array
    fun set(values: Array<com.chronoxor.test.EnumSimple?>)
    {
        assert((_buffer.offset + fbeOffset + fbeSize) <= _buffer.size) { "Model is broken!" }
        if ((_buffer.offset + fbeOffset + fbeSize) > _buffer.size)
            return
