...
class FinalModelOptionalString(buffer: com.chronoxor.fbe.Buffer, offset: Long) : com.chronoxor.fbe.FinalModel(buffer, offset)
{
    // Get the allocation size
    fun fbeAllocationSize(optional: String?): Long = 1 + (if (optional != null) value.fbeAllocationSize(optional) else 0)
    ...
    val value = com.chronoxor.fbe.FinalModelString(buffer, 0)
    ...
    fun get(size: com.chronoxor.fbe.Size): String?
    {
