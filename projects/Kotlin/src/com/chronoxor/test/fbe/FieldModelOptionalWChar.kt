...
class FieldModelOptionalWChar(buffer: com.chronoxor.fbe.Buffer, offset: Long) : com.chronoxor.fbe.FieldModel(buffer, offset)
{
    // Field size
    ...
    val value = com.chronoxor.fbe.FieldModelWChar(buffer, 0)
