...
class FieldModelOptionalprotoOrderSide(buffer: com.chronoxor.fbe.Buffer, offset: Long) : com.chronoxor.fbe.FieldModel(buffer, offset)
{
    // Field size
    ...
    val value = com.chronoxor.proto.fbe.FieldModelOrderSide(buffer, 0)
    ...
    fun get(defaults: com.chronoxor.proto.OrderSide? = null): com.chronoxor.proto.OrderSide?
    {
    ...
    fun set(optional: com.chronoxor.proto.OrderSide?)
    {
