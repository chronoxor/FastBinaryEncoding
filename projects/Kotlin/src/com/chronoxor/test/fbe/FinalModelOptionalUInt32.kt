...
class FinalModelOptionalUInt32(buffer: com.chronoxor.fbe.Buffer, offset: Long) : com.chronoxor.fbe.FinalModel(buffer, offset)
{
    // Get the allocation size
    fun fbeAllocationSize(optional: UInt?): Long = 1 + (if (optional != null) value.fbeAllocationSize(optional) else 0)
    ...
    val value = com.chronoxor.fbe.FinalModelUInt32(buffer, 0)
    ...
    fun get(size: com.chronoxor.fbe.Size): UInt?
    {
