...
class FieldModelOptionalprotoState(buffer: com.chronoxor.fbe.Buffer, offset: Long) : com.chronoxor.fbe.FieldModel(buffer, offset)
{
    // Field size
    ...
    val value = com.chronoxor.proto.fbe.FieldModelState(buffer, 0)
    ...
    fun get(defaults: com.chronoxor.proto.State? = null): com.chronoxor.proto.State?
    {
    ...
    fun set(optional: com.chronoxor.proto.State?)
    {
