...
class FinalModelOptionalUInt64(buffer: com.chronoxor.fbe.Buffer, offset: Long) : com.chronoxor.fbe.FinalModel(buffer, offset)
{
    // Get the allocation size
    fun fbeAllocationSize(optional: ULong?): Long = 1 + (if (optional != null) value.fbeAllocationSize(optional) else 0)
    ...
    val value = com.chronoxor.fbe.FinalModelUInt64(buffer, 0)
    ...
    fun get(size: com.chronoxor.fbe.Size): ULong?
    {
