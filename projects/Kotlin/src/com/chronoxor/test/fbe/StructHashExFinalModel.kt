...
class StructHashExFinalModel : com.chronoxor.fbe.Model
{
    private val _model: FinalModelStructHashEx

    constructor() { _model = FinalModelStructHashEx(buffer, 8) }
    constructor(buffer: com.chronoxor.fbe.Buffer) : super(buffer) { _model = FinalModelStructHashEx(buffer, 8) }
    ...
    companion object
    {
        const val fbeTypeConst: Long = FinalModelStructHashEx.fbeTypeConst
    }
