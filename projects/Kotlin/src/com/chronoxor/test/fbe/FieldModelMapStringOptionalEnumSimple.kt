...
class FieldModelMapStringOptionalEnumSimple(buffer: com.chronoxor.fbe.Buffer, offset: Long) : com.chronoxor.fbe.FieldModel(buffer, offset)
{
    private val _modelKey = com.chronoxor.fbe.FieldModelString(buffer, offset)
    private val _modelValue = FieldModelOptionalEnumSimple(buffer, offset)
    ...
    // Map index operator
    fun getItem(index: Long): Pair<com.chronoxor.fbe.FieldModelString, FieldModelOptionalEnumSimple>
    {
    ...
    fun resize(size: Long): Pair<com.chronoxor.fbe.FieldModelString, FieldModelOptionalEnumSimple>
    {
    ...
    fun get(values: java.util.TreeMap<String, com.chronoxor.test.EnumSimple?>)
    {
        values.clear()
    ...
    fun get(values: java.util.HashMap<String, com.chronoxor.test.EnumSimple?>)
    {
        values.clear()
    ...
    fun set(values: java.util.TreeMap<String, com.chronoxor.test.EnumSimple?>)
    {
        assert((_buffer.offset + fbeOffset + fbeSize) <= _buffer.size) { "Model is broken!" }
        if ((_buffer.offset + fbeOffset + fbeSize) > _buffer.size)
            return
    ...
    fun set(values: java.util.HashMap<String, com.chronoxor.test.EnumSimple?>)
    {
        assert((_buffer.offset + fbeOffset + fbeSize) <= _buffer.size) { "Model is broken!" }
        if ((_buffer.offset + fbeOffset + fbeSize) > _buffer.size)
            return
