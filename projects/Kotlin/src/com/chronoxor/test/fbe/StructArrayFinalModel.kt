...
class StructArrayFinalModel : com.chronoxor.fbe.Model
{
    private val _model: FinalModelStructArray

    constructor() { _model = FinalModelStructArray(buffer, 8) }
    constructor(buffer: com.chronoxor.fbe.Buffer) : super(buffer) { _model = FinalModelStructArray(buffer, 8) }
    ...
    companion object
    {
        const val fbeTypeConst: Long = FinalModelStructArray.fbeTypeConst
    }
