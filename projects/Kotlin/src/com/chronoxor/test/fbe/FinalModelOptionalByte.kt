...
class FinalModelOptionalByte(buffer: com.chronoxor.fbe.Buffer, offset: Long) : com.chronoxor.fbe.FinalModel(buffer, offset)
{
    ...
    val value = com.chronoxor.fbe.FinalModelByte(buffer, 0)
