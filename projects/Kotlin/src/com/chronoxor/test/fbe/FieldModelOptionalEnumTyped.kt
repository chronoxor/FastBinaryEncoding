...
class FieldModelOptionalEnumTyped(buffer: com.chronoxor.fbe.Buffer, offset: Long) : com.chronoxor.fbe.FieldModel(buffer, offset)
{
    // Field size
    ...
    val value = FieldModelEnumTyped(buffer, 0)
    ...
    fun get(defaults: com.chronoxor.test.EnumTyped? = null): com.chronoxor.test.EnumTyped?
    {
    ...
    fun set(optional: com.chronoxor.test.EnumTyped?)
    {
