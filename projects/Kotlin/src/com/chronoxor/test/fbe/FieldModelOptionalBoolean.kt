...
class FieldModelOptionalBoolean(buffer: com.chronoxor.fbe.Buffer, offset: Long) : com.chronoxor.fbe.FieldModel(buffer, offset)
{
    // Field size
    ...
    val value = com.chronoxor.fbe.FieldModelBoolean(buffer, 0)
    ...
    fun get(defaults: Boolean? = null): Boolean?
    {
