...
class FieldModelOptionalprotoOrderType(buffer: com.chronoxor.fbe.Buffer, offset: Long) : com.chronoxor.fbe.FieldModel(buffer, offset)
{
    // Field size
    ...
    val value = com.chronoxor.proto.fbe.FieldModelOrderType(buffer, 0)
    ...
    fun get(defaults: com.chronoxor.proto.OrderType? = null): com.chronoxor.proto.OrderType?
    {
    ...
    fun set(optional: com.chronoxor.proto.OrderType?)
    {
