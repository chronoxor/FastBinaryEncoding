...
class FieldModelOptionalprotoAccount(buffer: com.chronoxor.fbe.Buffer, offset: Long) : com.chronoxor.fbe.FieldModel(buffer, offset)
{
    // Field size
    ...
    val value = com.chronoxor.proto.fbe.FieldModelAccount(buffer, 0)
    ...
    fun get(defaults: com.chronoxor.proto.Account? = null): com.chronoxor.proto.Account?
    {
    ...
    fun set(optional: com.chronoxor.proto.Account?)
    {
