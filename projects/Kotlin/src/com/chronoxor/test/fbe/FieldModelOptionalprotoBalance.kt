...
class FieldModelOptionalprotoBalance(buffer: com.chronoxor.fbe.Buffer, offset: Long) : com.chronoxor.fbe.FieldModel(buffer, offset)
{
    // Field size
    ...
    val value = com.chronoxor.proto.fbe.FieldModelBalance(buffer, 0)
