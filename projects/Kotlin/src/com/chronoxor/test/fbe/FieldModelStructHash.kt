...
class FieldModelStructHash(buffer: com.chronoxor.fbe.Buffer, offset: Long) : com.chronoxor.fbe.FieldModel(buffer, offset)
{
    ...
    val f3: FieldModelMapStringBytes = FieldModelMapStringBytes(buffer, f2.fbeOffset + f2.fbeSize)
    val f4: FieldModelMapStringOptionalBytes = FieldModelMapStringOptionalBytes(buffer, f3.fbeOffset + f3.fbeSize)
    val f5: FieldModelMapStringEnumSimple = FieldModelMapStringEnumSimple(buffer, f4.fbeOffset + f4.fbeSize)
    val f6: FieldModelMapStringOptionalEnumSimple = FieldModelMapStringOptionalEnumSimple(buffer, f5.fbeOffset + f5.fbeSize)
    val f7: FieldModelMapStringFlagsSimple = FieldModelMapStringFlagsSimple(buffer, f6.fbeOffset + f6.fbeSize)
    val f8: FieldModelMapStringOptionalFlagsSimple = FieldModelMapStringOptionalFlagsSimple(buffer, f7.fbeOffset + f7.fbeSize)
    val f9: FieldModelMapStringStructSimple = FieldModelMapStringStructSimple(buffer, f8.fbeOffset + f8.fbeSize)
    val f10: FieldModelMapStringOptionalStructSimple = FieldModelMapStringOptionalStructSimple(buffer, f9.fbeOffset + f9.fbeSize)
