...
class FieldModelMapStringFlagsSimple(buffer: com.chronoxor.fbe.Buffer, offset: Long) : com.chronoxor.fbe.FieldModel(buffer, offset)
{
    private val _modelKey = com.chronoxor.fbe.FieldModelString(buffer, offset)
    private val _modelValue = FieldModelFlagsSimple(buffer, offset)
    ...
    // Map index operator
    fun getItem(index: Long): Pair<com.chronoxor.fbe.FieldModelString, FieldModelFlagsSimple>
    {
    ...
    fun resize(size: Long): Pair<com.chronoxor.fbe.FieldModelString, FieldModelFlagsSimple>
    {
