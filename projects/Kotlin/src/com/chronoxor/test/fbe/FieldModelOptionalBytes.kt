...
class FieldModelOptionalBytes(buffer: com.chronoxor.fbe.Buffer, offset: Long) : com.chronoxor.fbe.FieldModel(buffer, offset)
{
    // Field size
    ...
    val value = com.chronoxor.fbe.FieldModelBytes(buffer, 0)
    ...
    fun get(defaults: ByteArray? = null): ByteArray?
    {
