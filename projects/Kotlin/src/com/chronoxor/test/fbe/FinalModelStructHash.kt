...
class FinalModelStructHash(buffer: com.chronoxor.fbe.Buffer, offset: Long) : com.chronoxor.fbe.FinalModel(buffer, offset)
{
    ...
    val f3: FinalModelMapStringBytes = FinalModelMapStringBytes(buffer, 0)
    val f4: FinalModelMapStringOptionalBytes = FinalModelMapStringOptionalBytes(buffer, 0)
    val f5: FinalModelMapStringEnumSimple = FinalModelMapStringEnumSimple(buffer, 0)
    val f6: FinalModelMapStringOptionalEnumSimple = FinalModelMapStringOptionalEnumSimple(buffer, 0)
    val f7: FinalModelMapStringFlagsSimple = FinalModelMapStringFlagsSimple(buffer, 0)
    val f8: FinalModelMapStringOptionalFlagsSimple = FinalModelMapStringOptionalFlagsSimple(buffer, 0)
    val f9: FinalModelMapStringStructSimple = FinalModelMapStringStructSimple(buffer, 0)
    val f10: FinalModelMapStringOptionalStructSimple = FinalModelMapStringOptionalStructSimple(buffer, 0)
