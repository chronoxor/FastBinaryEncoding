...
class FinalModelVectorBytes(buffer: com.chronoxor.fbe.Buffer, offset: Long) : com.chronoxor.fbe.FinalModel(buffer, offset)
{
    private val _model = com.chronoxor.fbe.FinalModelBytes(buffer, offset)
    ...
    fun fbeAllocationSize(values: java.util.LinkedList<ByteArray>): Long
    {
        var size: Long = 4
        for (value in values)
            size += _model.fbeAllocationSize(value)
    ...
    fun fbeAllocationSize(values: java.util.HashSet<ByteArray>): Long
    {
        var size: Long = 4
        for (value in values)
            size += _model.fbeAllocationSize(value)
    ...
    fun get(values: java.util.LinkedList<ByteArray>): Long
    {
        values.clear()
    ...
    fun get(values: java.util.HashSet<ByteArray>): Long
    {
        values.clear()
    ...
    fun set(values: java.util.LinkedList<ByteArray>): Long
    {
        assert((_buffer.offset + fbeOffset + 4) <= _buffer.size) { "Model is broken!" }
        if ((_buffer.offset + fbeOffset + 4) > _buffer.size)
            return 0
    ...
    fun set(values: java.util.HashSet<ByteArray>): Long
    {
        assert((_buffer.offset + fbeOffset + 4) <= _buffer.size) { "Model is broken!" }
        if ((_buffer.offset + fbeOffset + 4) > _buffer.size)
            return 0
