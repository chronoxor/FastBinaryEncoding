...
class FieldModelOptionalprotoOrder(buffer: com.chronoxor.fbe.Buffer, offset: Long) : com.chronoxor.fbe.FieldModel(buffer, offset)
{
    // Field size
    ...
    val value = com.chronoxor.proto.fbe.FieldModelOrder(buffer, 0)
    ...
    fun get(defaults: com.chronoxor.proto.Order? = null): com.chronoxor.proto.Order?
    {
    ...
    fun set(optional: com.chronoxor.proto.Order?)
    {
