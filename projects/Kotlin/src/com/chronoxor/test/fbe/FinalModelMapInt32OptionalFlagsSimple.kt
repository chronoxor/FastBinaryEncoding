...
class FinalModelMapInt32OptionalFlagsSimple(buffer: com.chronoxor.fbe.Buffer, offset: Long) : com.chronoxor.fbe.FinalModel(buffer, offset)
{
    ...
    fun fbeAllocationSize(values: java.util.TreeMap<Int, com.chronoxor.test.FlagsSimple?>): Long
    {
        var size: Long = 4
    ...
    fun fbeAllocationSize(values: java.util.HashMap<Int, com.chronoxor.test.FlagsSimple?>): Long
    {
        var size: Long = 4
        for ((key, value1) in values)
        {
    ...
    fun get(values: java.util.TreeMap<Int, com.chronoxor.test.FlagsSimple?>): Long
    {
        values.clear()
    ...
    fun get(values: java.util.HashMap<Int, com.chronoxor.test.FlagsSimple?>): Long
    {
        values.clear()
    ...
    fun set(values: java.util.TreeMap<Int, com.chronoxor.test.FlagsSimple?>): Long
    {
        assert((_buffer.offset + fbeOffset + 4) <= _buffer.size) { "Model is broken!" }
        if ((_buffer.offset + fbeOffset + 4) > _buffer.size)
            return 0
    ...
    fun set(values: java.util.HashMap<Int, com.chronoxor.test.FlagsSimple?>): Long
    {
        assert((_buffer.offset + fbeOffset + 4) <= _buffer.size) { "Model is broken!" }
        if ((_buffer.offset + fbeOffset + 4) > _buffer.size)
            return 0
