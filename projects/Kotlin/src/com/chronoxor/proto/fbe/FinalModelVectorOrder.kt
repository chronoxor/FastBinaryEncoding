...
class FinalModelVectorOrder(buffer: com.chronoxor.fbe.Buffer, offset: Long) : com.chronoxor.fbe.FinalModel(buffer, offset)
{
    ...
    fun fbeAllocationSize(values: java.util.ArrayList<com.chronoxor.proto.Order>): Long
    {
        var size: Long = 4
        for (value in values)
    ...
    fun fbeAllocationSize(values: java.util.LinkedList<com.chronoxor.proto.Order>): Long
    {
        var size: Long = 4
        for (value in values)
            size += _model.fbeAllocationSize(value)
    ...
    fun fbeAllocationSize(values: java.util.HashSet<com.chronoxor.proto.Order>): Long
    {
        var size: Long = 4
        for (value in values)
            size += _model.fbeAllocationSize(value)
    ...
    fun get(values: java.util.ArrayList<com.chronoxor.proto.Order>): Long
    {
        values.clear()
    ...
    fun get(values: java.util.LinkedList<com.chronoxor.proto.Order>): Long
    {
        values.clear()
    ...
    fun get(values: java.util.HashSet<com.chronoxor.proto.Order>): Long
    {
        values.clear()
    ...
    fun set(values: java.util.ArrayList<com.chronoxor.proto.Order>): Long
    {
        assert((_buffer.offset + fbeOffset + 4) <= _buffer.size) { "Model is broken!" }
        if ((_buffer.offset + fbeOffset + 4) > _buffer.size)
            return 0
    ...
    fun set(values: java.util.LinkedList<com.chronoxor.proto.Order>): Long
    {
        assert((_buffer.offset + fbeOffset + 4) <= _buffer.size) { "Model is broken!" }
        if ((_buffer.offset + fbeOffset + 4) > _buffer.size)
            return 0
    ...
    fun set(values: java.util.HashSet<com.chronoxor.proto.Order>): Long
    {
        assert((_buffer.offset + fbeOffset + 4) <= _buffer.size) { "Model is broken!" }
        if ((_buffer.offset + fbeOffset + 4) > _buffer.size)
            return 0
