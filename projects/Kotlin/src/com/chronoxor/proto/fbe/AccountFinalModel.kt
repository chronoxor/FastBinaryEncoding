...
class AccountFinalModel : com.chronoxor.fbe.Model
{
    private val _model: FinalModelAccount

    constructor() { _model = FinalModelAccount(buffer, 8) }
    constructor(buffer: com.chronoxor.fbe.Buffer) : super(buffer) { _model = FinalModelAccount(buffer, 8) }
    ...
    fun serialize(value: com.chronoxor.proto.Account): Long
    {
    ...
    fun deserialize(): com.chronoxor.proto.Account { val value = com.chronoxor.proto.Account(); deserialize(value); return value }
    @Suppress("UNUSED_VALUE")
    fun deserialize(value: com.chronoxor.proto.Account): Long
    {
        var valueRef = value
