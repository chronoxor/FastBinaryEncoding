...
class FieldModelOrderMessage(buffer: com.chronoxor.fbe.Buffer, offset: Long) : com.chronoxor.fbe.FieldModel(buffer, offset)
{
    ...
    fun get(fbeValue: com.chronoxor.proto.OrderMessage = com.chronoxor.proto.OrderMessage()): com.chronoxor.proto.OrderMessage
    {
    ...
    @Suppress("UNUSED_PARAMETER")
    fun getFields(fbeValue: com.chronoxor.proto.OrderMessage, fbeStructSize: Long)
    {
        var fbeCurrentSize = 4L + 4L
        ...
        if ((fbeCurrentSize + body.fbeSize) <= fbeStructSize)
            ...
            fbeValue.body = com.chronoxor.proto.Order()
        fbeCurrentSize += body.fbeSize
    }
    ...
    fun set(fbeValue: com.chronoxor.proto.OrderMessage)
    {
    ...
    @Suppress("UNUSED_PARAMETER")
    fun setFields(fbeValue: com.chronoxor.proto.OrderMessage)
    {
