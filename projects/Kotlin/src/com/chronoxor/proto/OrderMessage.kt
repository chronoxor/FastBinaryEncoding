...
open class OrderMessage : Comparable<Any?>
{
    ...
    open fun clone(): OrderMessage
    {
        ...
        val writer = com.chronoxor.proto.fbe.OrderMessageModel()
        writer.serialize(this)

        // Deserialize the struct from the FBE stream
        val reader = com.chronoxor.proto.fbe.OrderMessageModel()
    ...
    companion object
    {
        ...
        fun fromJson(json: String): OrderMessage = com.chronoxor.proto.fbe.Json.engine.fromJson(json, OrderMessage::class.java)
    }
}
