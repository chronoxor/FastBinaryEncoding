...
{
    val parent: proto.fbe.FieldModelBalance = proto.fbe.FieldModelBalance(buffer, 4 + 4)
    val locked: FieldModelDouble = FieldModelDouble(buffer, parent.fbeOffset + parent.fbeBody - 4 - 4)
    ...
    companion object
    {
        const val fbeTypeConst: Long = proto.fbe.FieldModelBalance.fbeTypeConst
    }
