...
class FinalModelStructSimple(buffer: Buffer, offset: Long) : FinalModel(buffer, offset)
{
    ...
    val f39: proto.fbe.FinalModelOrderSide = proto.fbe.FinalModelOrderSide(buffer, 0)
    val f40: proto.fbe.FinalModelOrderType = proto.fbe.FinalModelOrderType(buffer, 0)
    val f41: proto.fbe.FinalModelOrder = proto.fbe.FinalModelOrder(buffer, 0)
    val f42: proto.fbe.FinalModelBalance = proto.fbe.FinalModelBalance(buffer, 0)
    val f43: proto.fbe.FinalModelState = proto.fbe.FinalModelState(buffer, 0)
