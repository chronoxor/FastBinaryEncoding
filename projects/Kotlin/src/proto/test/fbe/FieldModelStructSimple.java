...
public final class FieldModelStructSimple extends FieldModel
{
    ...
    public final FieldModelUInt8 f11;
    public final FieldModelUInt8 f12;
    public final FieldModelInt16 f13;
    public final FieldModelInt16 f14;
    public final FieldModelUInt16 f15;
    public final FieldModelUInt16 f16;
    public final FieldModelInt32 f17;
    public final FieldModelInt32 f18;
    public final FieldModelUInt32 f19;
    public final FieldModelUInt32 f20;
    public final FieldModelInt64 f21;
    public final FieldModelInt64 f22;
    public final FieldModelUInt64 f23;
    public final FieldModelUInt64 f24;
    ...
    public FieldModelStructSimple(Buffer buffer, long offset)
    {
        ...
        f11 = new FieldModelUInt8(buffer, f10.fbeOffset() + f10.fbeSize());
        f12 = new FieldModelUInt8(buffer, f11.fbeOffset() + f11.fbeSize());
        f13 = new FieldModelInt16(buffer, f12.fbeOffset() + f12.fbeSize());
        f14 = new FieldModelInt16(buffer, f13.fbeOffset() + f13.fbeSize());
        f15 = new FieldModelUInt16(buffer, f14.fbeOffset() + f14.fbeSize());
        f16 = new FieldModelUInt16(buffer, f15.fbeOffset() + f15.fbeSize());
        f17 = new FieldModelInt32(buffer, f16.fbeOffset() + f16.fbeSize());
        f18 = new FieldModelInt32(buffer, f17.fbeOffset() + f17.fbeSize());
        f19 = new FieldModelUInt32(buffer, f18.fbeOffset() + f18.fbeSize());
        f20 = new FieldModelUInt32(buffer, f19.fbeOffset() + f19.fbeSize());
        f21 = new FieldModelInt64(buffer, f20.fbeOffset() + f20.fbeSize());
        f22 = new FieldModelInt64(buffer, f21.fbeOffset() + f21.fbeSize());
        f23 = new FieldModelUInt64(buffer, f22.fbeOffset() + f22.fbeSize());
        f24 = new FieldModelUInt64(buffer, f23.fbeOffset() + f23.fbeSize());
    ...
    public void getFields(StructSimple fbeValue, long fbeStructSize)
    {
        ...
        if ((fbeCurrentSize + f30.fbeSize()) <= fbeStructSize)
            fbeValue.f30 = f30.get(BigDecimal(123456.123456));
        else
            fbeValue.f30 = BigDecimal(123456.123456);
        fbeCurrentSize += f30.fbeSize();
