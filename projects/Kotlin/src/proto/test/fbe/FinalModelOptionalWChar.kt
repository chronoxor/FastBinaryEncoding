...
class FinalModelOptionalWChar(buffer: Buffer, offset: Long) : FinalModel(buffer, offset)
{
    // Get the allocation size
    fun FBEAllocationSize(optional: Char?): Long {
    ...
    val value = FinalModelWChar(buffer, 0)
