...
class FieldModelMapInt32OptionalEnumSimple(buffer: Buffer, offset: Long) : FieldModel(buffer, offset)
{
    ...
    // Map index operator
    fun getItem(index: Long): Pair<FieldModelInt32, FieldModelOptionalEnumSimple> {
    ...
    fun resize(size: Long): Pair<FieldModelInt32, FieldModelOptionalEnumSimple> {
    ...
    operator fun get(values: HashMap<Int, EnumSimple?>) {
        values.clear()
