...
// Fast Binary Encoding optional Bytes final model class
class FinalModelOptionalBytes(buffer: Buffer, offset: Long) : FinalModel(buffer, offset)
{
    // Get the allocation size
    fun fbeAllocationSize(optional: ByteArray?): Long = (1 + (if (optional != null) value.fbeAllocationSize(optional) else 0)).toLong()
    ...
    val value = FinalModelBytes(buffer, 0)
