...
class FieldModelMapStringOptionalFlagsSimple(buffer: Buffer, offset: Long) : FieldModel(buffer, offset)
{
    ...
    // Map index operator
    fun getItem(index: Long): Pair<FieldModelString, FieldModelOptionalFlagsSimple>
    {
    ...
    fun resize(size: Long): Pair<FieldModelString, FieldModelOptionalFlagsSimple>
    {
