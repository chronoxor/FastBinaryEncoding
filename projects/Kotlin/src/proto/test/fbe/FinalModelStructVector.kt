...
class FinalModelStructVector(buffer: Buffer, offset: Long) : FinalModel(buffer, offset)
{
    ...
    fun fbeAllocationSize(fbeValue: StructVector): Long = (0
    ...
    fun get(fbeSize: Size, fbeValue: StructVector = StructVector()): StructVector
    {
        _buffer.shift(fbeOffset)
    ...
    fun getFields(fbeValue: StructVector): Long
    {
        var fbeCurrentOffset = 0L
    ...
    fun set(fbeValue: StructVector): Long
    {
        _buffer.shift(fbeOffset)
    ...
    fun setFields(fbeValue: StructVector): Long
    {
        var fbeCurrentOffset = 0L
        var fbeCurrentSize = 0L
        val fbeFieldSize = Size(0)
