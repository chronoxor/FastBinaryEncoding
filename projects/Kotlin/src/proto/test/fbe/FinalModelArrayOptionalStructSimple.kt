...
class FinalModelArrayOptionalStructSimple(buffer: Buffer, offset: Long, private val _size: Long) : FinalModel(buffer, offset)
{
    ...
    {
        val values = arrayOfNulls<StructSimple?>(_size.toInt())
