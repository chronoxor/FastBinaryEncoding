...
// Fast Binary Encoding optional Bytes field model class
class FieldModelOptionalBytes(buffer: Buffer, offset: Long) : FieldModel(buffer, offset)
{
    // Field size
    ...
    val value = FieldModelBytes(buffer, 0)
