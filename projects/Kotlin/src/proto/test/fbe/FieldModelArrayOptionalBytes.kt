...
// Fast Binary Encoding OptionalBytes array field model class
class FieldModelArrayOptionalBytes(buffer: Buffer, offset: Long, val size: Long) : FieldModel(buffer, offset)
{
