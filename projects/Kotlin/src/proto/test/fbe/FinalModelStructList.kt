...
class FinalModelStructList(buffer: Buffer, offset: Long) : FinalModel(buffer, offset)
{
    ...
    fun fbeAllocationSize(fbeValue: StructList): Long = (0
    ...
    fun get(fbeSize: Size, fbeValue: StructList = StructList()): StructList
    {
        _buffer.shift(fbeOffset)
    ...
    @Suppress("UNUSED_PARAMETER")
    fun getFields(fbeValue: StructList): Long
    {
        var fbeCurrentOffset = 0L
    ...
    fun set(fbeValue: StructList): Long
    {
        _buffer.shift(fbeOffset)
    ...
    @Suppress("UNUSED_PARAMETER")
    fun setFields(fbeValue: StructList): Long
    {
        var fbeCurrentOffset = 0L
        var fbeCurrentSize = 0L
        val fbeFieldSize = Size(0)
