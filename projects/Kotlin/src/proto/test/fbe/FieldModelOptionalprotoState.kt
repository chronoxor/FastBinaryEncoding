...
class FieldModelOptionalprotoState(buffer: Buffer, offset: Long) : FieldModel(buffer, offset)
{
    // Field size
    ...
    val value = proto.fbe.FieldModelState(buffer, 0)
    ...
    fun get(defaults: proto.State? = null): proto.State? {
