...
class FieldModelMapInt32OptionalByte(buffer: Buffer, offset: Long) : FieldModel(buffer, offset)
{
    ...
    // Map index operator
    fun getItem(index: Long): Pair<FieldModelInt32, FieldModelOptionalByte> {
    ...
    fun resize(size: Long): Pair<FieldModelInt32, FieldModelOptionalByte> {
    ...
    operator fun get(values: HashMap<Int, Byte?>) {
        values.clear()
