...
class FieldModelStructSimple(buffer: Buffer, offset: Long) : FieldModel(buffer, offset)
{
    ...
    val f39: proto.fbe.FieldModelOrderSide = proto.fbe.FieldModelOrderSide(buffer, f38.fbeOffset + f38.fbeSize)
    val f40: proto.fbe.FieldModelOrderType = proto.fbe.FieldModelOrderType(buffer, f39.fbeOffset + f39.fbeSize)
    val f41: proto.fbe.FieldModelOrder = proto.fbe.FieldModelOrder(buffer, f40.fbeOffset + f40.fbeSize)
    val f42: proto.fbe.FieldModelBalance = proto.fbe.FieldModelBalance(buffer, f41.fbeOffset + f41.fbeSize)
    val f43: proto.fbe.FieldModelState = proto.fbe.FieldModelState(buffer, f42.fbeOffset + f42.fbeSize)
    val f44: proto.fbe.FieldModelAccount = proto.fbe.FieldModelAccount(buffer, f43.fbeOffset + f43.fbeSize)
