...
// Fast Binary Encoding optional UInt64 final model class
class FinalModelOptionalUInt64(buffer: Buffer, offset: Long) : FinalModel(buffer, offset)
{
    // Get the allocation size
    fun fbeAllocationSize(optional: ULong?): Long = (1 + (if (optional != null) value.fbeAllocationSize(optional) else 0)).toLong()
    ...
    val value = FinalModelUInt64(buffer, 0)
