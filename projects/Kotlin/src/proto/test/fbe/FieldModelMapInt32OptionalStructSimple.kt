...
class FieldModelMapInt32OptionalStructSimple(buffer: Buffer, offset: Long) : FieldModel(buffer, offset)
{
    ...
    // Map index operator
    fun getItem(index: Long): Pair<FieldModelInt32, FieldModelOptionalStructSimple>
    {
    ...
    fun resize(size: Long): Pair<FieldModelInt32, FieldModelOptionalStructSimple>
    {
