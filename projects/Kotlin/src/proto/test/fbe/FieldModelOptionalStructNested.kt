...
// Fast Binary Encoding optional StructNested field model class
class FieldModelOptionalStructNested(buffer: Buffer, offset: Long) : FieldModel(buffer, offset)
{
    // Field size
