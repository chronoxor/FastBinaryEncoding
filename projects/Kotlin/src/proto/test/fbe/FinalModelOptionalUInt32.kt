...
// Fast Binary Encoding optional UInt32 final model class
class FinalModelOptionalUInt32(buffer: Buffer, offset: Long) : FinalModel(buffer, offset)
{
    // Get the allocation size
    fun fbeAllocationSize(optional: UInt?): Long = (1 + (if (optional != null) value.fbeAllocationSize(optional) else 0)).toLong()
    ...
    val value = FinalModelUInt32(buffer, 0)
