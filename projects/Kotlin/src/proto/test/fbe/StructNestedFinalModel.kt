...
class StructNestedFinalModel : Model
{
    private val _model: FinalModelStructNested

    constructor() { _model = FinalModelStructNested(buffer, 8) }
    constructor(buffer: Buffer) : super(buffer) { _model = FinalModelStructNested(buffer, 8) }
    ...
    companion object
    {
        const val fbeTypeConst: Long = FinalModelStructNested.fbeTypeConst
    }
    ...
    fun serialize(value: StructNested): Long
    {
    ...
    fun deserialize(): StructNested { val value = StructNested(); deserialize(value); return value }
    @Suppress("UNUSED_VALUE")
    fun deserialize(value: StructNested): Long
    {
        var valueRef = value
