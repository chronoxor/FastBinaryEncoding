...
// Fast Binary Encoding optional Byte final model class
class FinalModelOptionalByte(buffer: Buffer, offset: Long) : FinalModel(buffer, offset)
{
    // Get the allocation size
    fun FBEAllocationSize(optional: Byte?): Long = (1 + (if (optional != null) value.FBEAllocationSize(optional) else 0)).toLong()
    ...
    val value = FinalModelByte(buffer, 0)
