...
// Fast Binary Encoding optional UInt16 field model class
class FieldModelOptionalUInt16(buffer: Buffer, offset: Long) : FieldModel(buffer, offset)
{
    // Field size
    ...
    val value = FieldModelUInt16(buffer, 0)
