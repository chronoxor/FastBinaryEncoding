...
class FieldModelMapStringOptionalEnumSimple(buffer: Buffer, offset: Long) : FieldModel(buffer, offset)
{
    ...
    // Map index operator
    fun getItem(index: Long): Pair<FieldModelString, FieldModelOptionalEnumSimple>
    {
