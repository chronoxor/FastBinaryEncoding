...
// Fast Binary Encoding optional Char field model class
class FieldModelOptionalChar(buffer: Buffer, offset: Long) : FieldModel(buffer, offset)
{
    // Field size
    ...
    val value = FieldModelChar(buffer, 0)
