...
class FieldModelMapInt32FlagsSimple(buffer: Buffer, offset: Long) : FieldModel(buffer, offset)
{
    ...
    // Map index operator
    fun getItem(index: Long): Pair<FieldModelInt32, FieldModelFlagsSimple> {
    ...
    fun resize(size: Long): Pair<FieldModelInt32, FieldModelFlagsSimple> {
    ...
    operator fun get(values: HashMap<Int, FlagsSimple>) {
        values.clear()
