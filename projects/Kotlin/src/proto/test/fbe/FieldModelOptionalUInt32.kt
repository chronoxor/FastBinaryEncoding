...
// Fast Binary Encoding optional UInt32 field model class
class FieldModelOptionalUInt32(buffer: Buffer, offset: Long) : FieldModel(buffer, offset)
{
    // Field size
    ...
    val value = FieldModelUInt32(buffer, 0)
