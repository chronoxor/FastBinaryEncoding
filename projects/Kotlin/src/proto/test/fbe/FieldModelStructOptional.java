...
public final class FieldModelStructOptional extends FieldModel
{
    ...
    public final FieldModelOptionalUInt8 f115;
    public final FieldModelOptionalUInt8 f116;
    public final FieldModelOptionalUInt8 f117;
    ...
    public final FieldModelOptionalUInt16 f121;
    public final FieldModelOptionalUInt16 f122;
    public final FieldModelOptionalUInt16 f123;
    ...
    public final FieldModelOptionalUInt32 f127;
    public final FieldModelOptionalUInt32 f128;
    public final FieldModelOptionalUInt32 f129;
    ...
    public final FieldModelOptionalUInt64 f133;
    public final FieldModelOptionalUInt64 f134;
    public final FieldModelOptionalUInt64 f135;
    ...
    public FieldModelStructOptional(Buffer buffer, long offset)
    {
        ...
        f115 = new FieldModelOptionalUInt8(buffer, f114.fbeOffset() + f114.fbeSize());
        f116 = new FieldModelOptionalUInt8(buffer, f115.fbeOffset() + f115.fbeSize());
        f117 = new FieldModelOptionalUInt8(buffer, f116.fbeOffset() + f116.fbeSize());
        ...
        f121 = new FieldModelOptionalUInt16(buffer, f120.fbeOffset() + f120.fbeSize());
        f122 = new FieldModelOptionalUInt16(buffer, f121.fbeOffset() + f121.fbeSize());
        f123 = new FieldModelOptionalUInt16(buffer, f122.fbeOffset() + f122.fbeSize());
        ...
        f127 = new FieldModelOptionalUInt32(buffer, f126.fbeOffset() + f126.fbeSize());
        f128 = new FieldModelOptionalUInt32(buffer, f127.fbeOffset() + f127.fbeSize());
        f129 = new FieldModelOptionalUInt32(buffer, f128.fbeOffset() + f128.fbeSize());
        ...
        f133 = new FieldModelOptionalUInt64(buffer, f132.fbeOffset() + f132.fbeSize());
        f134 = new FieldModelOptionalUInt64(buffer, f133.fbeOffset() + f133.fbeSize());
        f135 = new FieldModelOptionalUInt64(buffer, f134.fbeOffset() + f134.fbeSize());
