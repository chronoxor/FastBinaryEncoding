...
public enum FlagsSimpleEnum
{
    ...
    , FLAG_VALUE_2(0x2 + 0)
    , FLAG_VALUE_3(0x4 + 0)
    , FLAG_VALUE_4(FLAG_VALUE_3.raw)
    , FLAG_VALUE_5(FLAG_VALUE_1.raw|FLAG_VALUE_3.raw)
    ;

    private Int value;

    FlagsSimpleEnum(Int value) { this.value = value; }
    ...
    private static final Map<Int, FlagsSimpleEnum> mapping = new HashMap<>();
    static
    {
