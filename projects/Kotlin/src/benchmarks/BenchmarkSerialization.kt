...
class BenchmarkSerialization
{
    ...
    private val _writer: com.chronoxor.proto.fbe.AccountModel
    private val _reader: com.chronoxor.proto.fbe.AccountModel
    ...
    init
    {
        ...
        _writer = com.chronoxor.proto.fbe.AccountModel()
        _writer.serialize(_account)
        assert(_writer.verify())

        // Deserialize the account from the FBE stream
        _reader = com.chronoxor.proto.fbe.AccountModel()
