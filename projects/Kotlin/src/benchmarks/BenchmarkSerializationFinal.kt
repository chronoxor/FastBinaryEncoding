...
class BenchmarkSerializationFinal
{
    ...
    private var _writer: proto.fbe.AccountFinalModel
    private var _reader: proto.fbe.AccountFinalModel
    ...
    init
    {
        ...
        _writer = proto.fbe.AccountFinalModel()
        _writer.serialize(_account)
        assert(_writer.verify())

        // Deserialize the account from the FBE stream
        _reader = proto.fbe.AccountFinalModel()
