...
class TestDecimal < Test::Unit::TestCase
  ...
  def test_decimal
    ...
    BigDecimal.limit(29)
    assert_equal(verify_decimal(0x00000000, 0x00000000, 0x00000000, false, 0x00000000), BigDecimal.new("0"))
    assert_equal(verify_decimal(0x00000001, 0x00000000, 0x00000000, false, 0x00000000), BigDecimal.new("1"))
    assert_equal(verify_decimal(0x107A4000, 0x00005AF3, 0x00000000, false, 0x00000000), BigDecimal.new("100000000000000"))
    assert_equal(verify_decimal(0x10000000, 0x3E250261, 0x204FCE5E, false, 0x000E0000 >> 16), BigDecimal.new("100000000000000.00000000000000"))
    assert_equal(verify_decimal(0x10000000, 0x3E250261, 0x204FCE5E, false, 0x00000000), BigDecimal.new("10000000000000000000000000000"))
    assert_equal(verify_decimal(0x10000000, 0x3E250261, 0x204FCE5E, false, 0x001C0000 >> 16), BigDecimal.new("1.0000000000000000000000000000"))
    assert_equal(verify_decimal(0x075BCD15, 0x00000000, 0x00000000, false, 0x00000000), BigDecimal.new("123456789"))
    assert_equal(verify_decimal(0x075BCD15, 0x00000000, 0x00000000, false, 0x00090000 >> 16), BigDecimal.new("0.123456789"))
    assert_equal(verify_decimal(0x075BCD15, 0x00000000, 0x00000000, false, 0x00120000 >> 16), BigDecimal.new("0.000000000123456789"))
