...
func NewMySender() *MySender {
	...
	sender.OnSendHandler(sender)
	sender.OnSendLogHandler(sender)
	return sender
}
...
func NewMyReceiver() *MyReceiver {
	...
	receiver.OnReceiveOrderHandler(receiver)
	receiver.OnReceiveBalanceHandler(receiver)
	receiver.OnReceiveAccountHandler(receiver)
	receiver.OnReceiveLogHandler(receiver)
	return receiver
}
