...
func NewOrderFromFieldValues(Uid int32, Symbol string, Side OrderSide, Type OrderType, Price float64, Volume float64, Tp float64, Sl float64) *Order {
    return &Order{Uid, Symbol, Side, Type, Price, Volume, Tp, Sl}
}
