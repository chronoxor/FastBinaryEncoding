...
// Get the field size
func (fm *FinalModelOptionalDouble) FBESize() int { return 0 }

// Get the field extra size
func (fm *FinalModelOptionalDouble) FBEExtra() int { return 0 }
