...
// Get the field size
func (fm *FinalModelOptionalStructNested) FBESize() int { return 0 }

// Get the field extra size
func (fm *FinalModelOptionalStructNested) FBEExtra() int { return 0 }
...
func (fm *FinalModelOptionalStructNested) GetValue(fbeValue *StructNested) (int, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + 1) > fm.buffer.Size() {
