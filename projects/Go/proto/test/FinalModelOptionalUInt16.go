...
// Get the field size
func (fm *FinalModelOptionalUInt16) FBESize() int { return 0 }

// Get the field extra size
func (fm *FinalModelOptionalUInt16) FBEExtra() int { return 0 }
