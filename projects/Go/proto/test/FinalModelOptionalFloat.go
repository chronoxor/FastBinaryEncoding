...
// Get the field size
func (fm *FinalModelOptionalFloat) FBESize() int { return 0 }

// Get the field extra size
func (fm *FinalModelOptionalFloat) FBEExtra() int { return 0 }
...
func (fm *FinalModelOptionalFloat) GetValue(fbeValue *float32) (int, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + 1) > fm.buffer.Size() {
