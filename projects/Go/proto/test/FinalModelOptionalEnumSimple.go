...
// Get the field size
func (fm *FinalModelOptionalEnumSimple) FBESize() int { return 0 }

// Get the field extra size
func (fm *FinalModelOptionalEnumSimple) FBEExtra() int { return 0 }
