...
// Get the field size
func (fm *FinalModelOptionalWChar) FBESize() int { return 0 }

// Get the field extra size
func (fm *FinalModelOptionalWChar) FBEExtra() int { return 0 }
...
func (fm *FinalModelOptionalWChar) GetValue(fbeValue *rune) (int, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + 1) > fm.buffer.Size() {
