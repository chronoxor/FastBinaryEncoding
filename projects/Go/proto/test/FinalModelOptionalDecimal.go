...
// Get the field size
func (fm *FinalModelOptionalDecimal) FBESize() int { return 0 }

// Get the field extra size
func (fm *FinalModelOptionalDecimal) FBEExtra() int { return 0 }
...
func (fm *FinalModelOptionalDecimal) GetValue(fbeValue *fbe.Decimal) (int, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + 1) > fm.buffer.Size() {
