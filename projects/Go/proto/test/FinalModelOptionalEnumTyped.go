...
// Get the field size
func (fm *FinalModelOptionalEnumTyped) FBESize() int { return 0 }

// Get the field extra size
func (fm *FinalModelOptionalEnumTyped) FBEExtra() int { return 0 }
...
func (fm *FinalModelOptionalEnumTyped) GetValue(fbeValue *EnumTyped) (int, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + 1) > fm.buffer.Size() {
