...
// Get the field size
func (fm *FinalModelOptionalprotoAccount) FBESize() int { return 0 }

// Get the field extra size
func (fm *FinalModelOptionalprotoAccount) FBEExtra() int { return 0 }
...
func (fm *FinalModelOptionalprotoAccount) GetValue(fbeValue *proto.Account) (int, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + 1) > fm.buffer.Size() {
