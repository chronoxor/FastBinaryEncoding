...
// Get the field size
func (fm *FinalModelOptionalUUID) FBESize() int { return 0 }

// Get the field extra size
func (fm *FinalModelOptionalUUID) FBEExtra() int { return 0 }
...
func (fm *FinalModelOptionalUUID) GetValue(fbeValue *fbe.UUID) (int, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + 1) > fm.buffer.Size() {
