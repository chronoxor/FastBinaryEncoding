...
// Get the field size
func (fm *FinalModelOptionalUInt64) FBESize() int { return 0 }

// Get the field extra size
func (fm *FinalModelOptionalUInt64) FBEExtra() int { return 0 }
