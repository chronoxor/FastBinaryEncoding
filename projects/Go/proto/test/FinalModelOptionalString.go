...
// Get the field size
func (fm *FinalModelOptionalString) FBESize() int { return 0 }

// Get the field extra size
func (fm *FinalModelOptionalString) FBEExtra() int { return 0 }
