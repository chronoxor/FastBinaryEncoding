...
// Create a new StructOptional struct from the given parent value
func NewStructOptionalFromParent(Parent *StructSimple) *StructOptional {
    return &StructOptional{
        StructSimple: NewStructSimpleFromCopy(Parent),
        F100: nil,
        F101: fbe.OptionalBool(true),
        F102: nil,
        F103: nil,
...
// Create a new StructOptional struct from the given copy value
func NewStructOptionalFromCopy(Other *StructOptional) *StructOptional {
    return &StructOptional{
        StructSimple: NewStructSimpleFromCopy(Other.StructSimple),
        F100: nil,
        F101: fbe.OptionalBool(true),
        F102: nil,
        F103: nil,
