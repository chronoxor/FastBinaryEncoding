...
func (fm *FinalModelMapStructSimpleStructNested) FBEAllocationSize(values map[StructSimpleKey]StructNested) int {
    size := 4
...
// Get the map
func (fm *FinalModelMapStructSimpleStructNested) Get() (map[StructSimpleKey]StructNested, int, error) {
...
// Set the map
func (fm *FinalModelMapStructSimpleStructNested) Set(values map[StructSimpleKey]StructNested) (int, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + 4) > fm.buffer.Size() {
