...
// Get the field size
func (fm *FinalModelOptionalBool) FBESize() int { return 0 }

// Get the field extra size
func (fm *FinalModelOptionalBool) FBEExtra() int { return 0 }
...
func (fm *FinalModelOptionalBool) GetValue(fbeValue *bool) (int, error) {
    if (fm.buffer.Offset() + fm.FBEOffset() + 1) > fm.buffer.Size() {
