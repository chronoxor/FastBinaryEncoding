...
func (fm FinalModelUInt16) FBEAllocationSize() int { return fm.FBESize() }

// Get the final size
func (fm FinalModelUInt16) FBESize() int { return 2 }
// Get the final extra size
func (fm FinalModelUInt16) FBEExtra() int { return 0 }
...
// Get the value
func (fm FinalModelUInt16) Get() (uint16, int) {
    if fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize() > fm.buffer.Size() {
        return 0, 0
    }

    return ReadUInt16(fm.buffer.Data(), fm.buffer.Offset() + fm.FBEOffset()), fm.FBESize()
}

// Set the value
func (fm *FinalModelUInt16) Set(value uint16) int {
    if fm.buffer.Offset() + fm.FBEOffset() + fm.FBESize() > fm.buffer.Size() {
        return 0
    }
