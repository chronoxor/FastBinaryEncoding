...
TEST_CASE("Serialization: domain", "[FBE]")
{
    ...
    proto::Account account1 = { 1, "Test", proto::State::good, { "USD", 1000.0 }, std_make_optional<proto::Balance>({ "EUR", 100.0 }), {} };
...
TEST_CASE("Serialization: struct simple", "[FBE]")
{
    ...
    FBE::test::StructSimpleModel<FBE::WriteBuffer> writer;
    ...
    FBE::test::StructSimpleModel<FBE::ReadBuffer> reader;
...
TEST_CASE("Serialization: struct optional", "[FBE]")
{
    ...
    // Serialize the struct to the FBE stream
    FBE::test::StructOptionalModel<FBE::WriteBuffer> writer;
    ...
    FBE::test::StructOptionalModel<FBE::ReadBuffer> reader;
    ...
    REQUIRE(!(bool)struct2.f100);
    REQUIRE((bool)struct2.f101);
    REQUIRE(struct2.f101.value() == true);
    REQUIRE(!(bool)struct2.f102);
    REQUIRE(!(bool)struct2.f103);
    REQUIRE((bool)struct2.f104);
    REQUIRE(struct2.f104.value() == 0xFF);
    REQUIRE(!(bool)struct2.f105);
    REQUIRE(!(bool)struct2.f106);
    REQUIRE((bool)struct2.f107);
    REQUIRE(struct2.f107.value() == '!');
    REQUIRE(!(bool)struct2.f108);
    REQUIRE(!(bool)struct2.f109);
    REQUIRE((bool)struct2.f110);
    REQUIRE(struct2.f110.value() == 0x0444);
    REQUIRE(!(bool)struct2.f111);
    REQUIRE(!(bool)struct2.f112);
    REQUIRE((bool)struct2.f113);
    REQUIRE(struct2.f113.value() == 127);
    REQUIRE(!(bool)struct2.f114);
    REQUIRE(!(bool)struct2.f115);
    REQUIRE((bool)struct2.f116);
    REQUIRE(struct2.f116.value() == 0xFF);
    REQUIRE(!(bool)struct2.f117);
    REQUIRE(!(bool)struct2.f118);
    REQUIRE((bool)struct2.f119);
    REQUIRE(struct2.f119.value() == 32767);
    REQUIRE(!(bool)struct2.f120);
    REQUIRE(!(bool)struct2.f121);
    REQUIRE((bool)struct2.f122);
    REQUIRE(struct2.f122.value() == 0xFFFF);
    REQUIRE(!(bool)struct2.f123);
    REQUIRE(!(bool)struct2.f124);
    REQUIRE((bool)struct2.f125);
    REQUIRE(struct2.f125.value() == 2147483647);
    REQUIRE(!(bool)struct2.f126);
    REQUIRE(!(bool)struct2.f127);
    REQUIRE((bool)struct2.f128);
    REQUIRE(struct2.f128.value() == 0xFFFFFFFF);
    REQUIRE(!(bool)struct2.f129);
    REQUIRE(!(bool)struct2.f130);
    REQUIRE((bool)struct2.f131);
    REQUIRE(struct2.f131.value() == 9223372036854775807ll);
    REQUIRE(!(bool)struct2.f132);
    REQUIRE(!(bool)struct2.f133);
    REQUIRE((bool)struct2.f131);
    REQUIRE(struct2.f134.value() == 0xFFFFFFFFFFFFFFFFull);
    REQUIRE(!(bool)struct2.f135);
    REQUIRE(!(bool)struct2.f136);
    REQUIRE((bool)struct2.f137);
    REQUIRE(std::abs(struct2.f137.value() - 123.456f) < 0.0001);
    REQUIRE(!(bool)struct2.f138);
    REQUIRE(!(bool)struct2.f139);
    REQUIRE((bool)struct2.f140);
    REQUIRE(std::abs(struct2.f140.value() - -123.567e+123) < 1e+123);
    REQUIRE(!(bool)struct2.f141);
    REQUIRE(!(bool)struct2.f142);
    REQUIRE((bool)struct2.f143);
    REQUIRE(struct2.f143.value() == 123456.123456);
    REQUIRE(!(bool)struct2.f144);
    REQUIRE(!(bool)struct2.f145);
    REQUIRE((bool)struct2.f146);
    REQUIRE(struct2.f146.value() == "Initial string!");
    REQUIRE(!(bool)struct2.f147);
    REQUIRE(!(bool)struct2.f148);
    REQUIRE((bool)struct2.f149);
    REQUIRE(struct2.f149.value() > 1514764800000000000);
    REQUIRE(!(bool)struct2.f150);
    REQUIRE(!(bool)struct2.f151);
    REQUIRE((bool)struct2.f152);
    REQUIRE(struct2.f152.value() == FBE::uuid_t("123e4567-e89b-12d3-a456-426655440000"));
    REQUIRE(!(bool)struct2.f153);
    REQUIRE(!(bool)struct2.f154);
    REQUIRE(!(bool)struct2.f155);
    REQUIRE(!(bool)struct2.f156);
    REQUIRE(!(bool)struct2.f157);
    REQUIRE(!(bool)struct2.f158);
    REQUIRE(!(bool)struct2.f159);
    REQUIRE(!(bool)struct2.f160);
    REQUIRE(!(bool)struct2.f161);
    REQUIRE(!(bool)struct2.f162);
    REQUIRE(!(bool)struct2.f163);
    REQUIRE(!(bool)struct2.f164);
    REQUIRE(!(bool)struct2.f165);
...
TEST_CASE("Serialization: struct nested", "[FBE]")
{
    ...
    // Serialize the struct to the FBE stream
    FBE::test::StructNestedModel<FBE::WriteBuffer> writer;
    ...
    FBE::test::StructNestedModel<FBE::ReadBuffer> reader;
...
TEST_CASE("Serialization: struct bytes", "[FBE]")
{
    ...
    // Serialize the struct to the FBE stream
    FBE::test::StructBytesModel<FBE::WriteBuffer> writer;
    ...
    FBE::test::StructBytesModel<FBE::ReadBuffer> reader;
...
TEST_CASE("Serialization: struct array", "[FBE]")
{
    ...
    // Serialize the struct to the FBE stream
    FBE::test::StructArrayModel<FBE::WriteBuffer> writer;
    ...
    FBE::test::StructArrayModel<FBE::ReadBuffer> reader;
...
TEST_CASE("Serialization: struct vector", "[FBE]")
{
    ...
    // Serialize the struct to the FBE stream
    FBE::test::StructVectorModel<FBE::WriteBuffer> writer;
    ...
    FBE::test::StructVectorModel<FBE::ReadBuffer> reader;
...
TEST_CASE("Serialization: struct list", "[FBE]")
{
    ...
    // Serialize the struct to the FBE stream
    FBE::test::StructListModel<FBE::WriteBuffer> writer;
    ...
    FBE::test::StructListModel<FBE::ReadBuffer> reader;
    ...
    REQUIRE(struct2.f10.size() == 2);
    REQUIRE((bool)struct2.f10.front());
...
TEST_CASE("Serialization: struct set", "[FBE]")
{
    ...
    // Serialize the struct to the FBE stream
    FBE::test::StructSetModel<FBE::WriteBuffer> writer;
    ...
    FBE::test::StructSetModel<FBE::ReadBuffer> reader;
...
TEST_CASE("Serialization: struct map", "[FBE]")
{
    ...
    // Serialize the struct to the FBE stream
    FBE::test::StructMapModel<FBE::WriteBuffer> writer;
    ...
    FBE::test::StructMapModel<FBE::ReadBuffer> reader;
...
TEST_CASE("Serialization: struct hash", "[FBE]")
{
    ...
    // Serialize the struct to the FBE stream
    FBE::test::StructHashModel<FBE::WriteBuffer> writer;
    ...
    FBE::test::StructHashModel<FBE::ReadBuffer> reader;
...
TEST_CASE("Serialization: struct hash extended", "[FBE]")
{
    ...
    struct1.f2.emplace(s2, std_nullopt);

    // Serialize the struct to the FBE stream
    FBE::test::StructHashExModel<FBE::WriteBuffer> writer;
    ...
    FBE::test::StructHashExModel<FBE::ReadBuffer> reader;
    ...
    REQUIRE(struct2.f2.find(s2)->second == std_nullopt);
}
